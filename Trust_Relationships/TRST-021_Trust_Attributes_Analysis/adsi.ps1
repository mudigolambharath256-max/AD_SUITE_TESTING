...
@('name', 'distinguishedName', 'cn', 'flatName', 'trustAttributes', 'trustDirection', 'trustType', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TRST-021_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Trust Attributes Analysis
# Category: Trust Relationships
# Severity: info
# ID: TRST-021
# Requirements: None
