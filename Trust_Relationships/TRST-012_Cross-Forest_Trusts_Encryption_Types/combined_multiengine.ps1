...
Write-Host "=== Multi-Engine Execution: Cross-Forest Trusts Encryption Types ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'TRST-012'
                adSuiteCheckName  = 'Cross-Forest_Trusts_Encryption_Types'
    ...
    $bhFile = Join-Path $bhDir "TRST-012_$bhTs.json"
    @{
