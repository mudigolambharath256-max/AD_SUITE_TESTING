...
@('name', 'distinguishedName', 'cn', 'flatName', 'trustDirection', 'trustAttributes', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TRST-007_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Trusts Without SID Filtering
# Category: Trust Relationships
# Severity: critical
# ID: TRST-007
# Requirements: None
