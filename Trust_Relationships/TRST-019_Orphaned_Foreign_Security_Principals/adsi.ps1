...
@('name', 'distinguishedName', 'cn', 'objectSid', 'memberOf', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TRST-019_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Orphaned Foreign Security Principals
# Category: Trust Relationships
# Severity: medium
# ID: TRST-019
# Requirements: None
