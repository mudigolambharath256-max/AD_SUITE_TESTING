...
Write-Host "=== Multi-Engine Execution: Shortcut Trusts ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'TRST-017'
                adSuiteCheckName  = 'Shortcut_Trusts'
    ...
    $bhFile = Join-Path $bhDir "TRST-017_$bhTs.json"
    @{
