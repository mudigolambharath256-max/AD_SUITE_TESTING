...
try {
    ...
    Write-Host "DOM-046: found $($found.Count) objects"
    ...
    Write-Warning "DOM-046: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-046: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-046: Query failed : $_"
}
