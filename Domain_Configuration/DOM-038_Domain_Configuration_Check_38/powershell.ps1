...
try {
    ...
    Write-Host "DOM-038: found $($found.Count) objects"
    ...
    Write-Warning "DOM-038: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-038: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-038: Query failed — $_"
}
