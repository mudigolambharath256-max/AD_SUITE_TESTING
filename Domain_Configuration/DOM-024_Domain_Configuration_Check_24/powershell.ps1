...
try {
    ...
    Write-Host "DOM-024: found $($found.Count) objects"
    ...
    Write-Warning "DOM-024: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-024: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-024: Query failed — $_"
}
