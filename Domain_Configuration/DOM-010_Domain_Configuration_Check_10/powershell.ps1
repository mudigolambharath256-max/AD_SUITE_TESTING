...
try {
    ...
    Write-Host "DOM-010: found $($found.Count) objects"
    ...
    Write-Warning "DOM-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-010: Query failed — $_"
}
