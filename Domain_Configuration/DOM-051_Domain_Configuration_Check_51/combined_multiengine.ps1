...
# Check: Domain Configuration Check 51
...
Write-Host "=== Domain Configuration Check 51 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "DOM-051 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "DOM-051 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "DOM-051 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== DOM-051: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "DOM-051_results.csv"
$uniqueResults |
