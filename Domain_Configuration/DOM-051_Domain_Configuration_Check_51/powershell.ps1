...
try {
    ...
    Write-Host "DOM-051: found $($found.Count) objects"
    ...
    Write-Warning "DOM-051: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-051: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-051: Query failed : $_"
}
