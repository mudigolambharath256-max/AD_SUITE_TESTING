...
try {
    ...
    Write-Host "DOM-002: found $($found.Count) objects"
    ...
    Write-Warning "DOM-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-002: Query failed — $_"
}
