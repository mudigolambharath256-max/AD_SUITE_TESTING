...
try {
    ...
    Write-Host "DOM-055: found $($found.Count) objects"
    ...
    Write-Warning "DOM-055: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-055: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-055: Query failed — $_"
}
