...
try {
    ...
    Write-Host "DOM-011: found $($found.Count) objects"
    ...
    Write-Warning "DOM-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-011: Query failed — $_"
}
