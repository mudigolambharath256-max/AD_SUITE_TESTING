...
try {
    ...
    Write-Host "DOM-030: found $($found.Count) objects"
    ...
    Write-Warning "DOM-030: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-030: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-030: Query failed : $_"
}
