...
try {
    ...
    Write-Host "DOM-043: found $($found.Count) objects"
    ...
    Write-Warning "DOM-043: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-043: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-043: Query failed — $_"
}
