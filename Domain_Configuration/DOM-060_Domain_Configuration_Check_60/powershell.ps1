...
try {
    ...
    Write-Host "DOM-060: found $($found.Count) objects"
    ...
    Write-Warning "DOM-060: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-060: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-060: Query failed : $_"
}
