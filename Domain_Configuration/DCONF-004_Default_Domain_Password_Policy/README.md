...
## Overview
This security check performs analysis for: **Default Domain Password Policy**
...
## Description
This check queries Active Directory to identify objects related to Default Domain Password Policy. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-004.exe csharp.cs
DCONF-004.exe
```
...
- **CheckID**: The check identifier (DCONF-004)
- **CheckName**: The check name (Default Domain Password Policy)
- **Name**: Object name
