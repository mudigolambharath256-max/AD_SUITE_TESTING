...
## Overview
This security check performs analysis for: **ms-DS-MachineAccountQuota Setting**
...
## Description
This check queries Active Directory to identify objects related to ms-DS-MachineAccountQuota Setting. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-003.exe csharp.cs
DCONF-003.exe
```
...
- **CheckID**: The check identifier (DCONF-003)
- **CheckName**: The check name (ms-DS-MachineAccountQuota Setting)
- **Name**: Object name
