...
try {
    ...
    Write-Host "DOM-059: found $($found.Count) objects"
    ...
    Write-Warning "DOM-059: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-059: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-059: Query failed : $_"
}
