...
try {
    ...
    Write-Host "DOM-039: found $($found.Count) objects"
    ...
    Write-Warning "DOM-039: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-039: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-039: Query failed : $_"
}
