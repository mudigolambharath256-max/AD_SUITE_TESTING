...
try {
    ...
    Write-Host "DOM-009: found $($found.Count) objects"
    ...
    Write-Warning "DOM-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-009: Query failed — $_"
}
