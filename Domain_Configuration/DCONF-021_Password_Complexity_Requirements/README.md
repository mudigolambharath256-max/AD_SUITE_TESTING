# DCONF-021: Password Complexity Requirements

## Overview
This security check performs analysis for: **Password Complexity Requirements**
...
## Description
This check queries Active Directory to identify objects related to Password Complexity Requirements. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-021.exe csharp.cs
DCONF-021.exe
```
...
- **CheckID**: The check identifier (DCONF-021)
- **CheckName**: The check name (Password Complexity Requirements)
- **Name**: Object name
