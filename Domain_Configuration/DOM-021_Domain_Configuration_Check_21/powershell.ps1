...
try {
    ...
    Write-Host "DOM-021: found $($found.Count) objects"
    ...
    Write-Warning "DOM-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-021: Query failed : $_"
}
