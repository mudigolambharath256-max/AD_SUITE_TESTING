...
# Check: Domain Configuration Check 47
...
Write-Host "=== Domain Configuration Check 47 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "DOM-047 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "DOM-047 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "DOM-047 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== DOM-047: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "DOM-047_results.csv"
$uniqueResults |
