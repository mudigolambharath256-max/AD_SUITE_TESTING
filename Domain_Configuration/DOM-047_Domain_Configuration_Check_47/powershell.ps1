...
try {
    ...
    Write-Host "DOM-047: found $($found.Count) objects"
    ...
    Write-Warning "DOM-047: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-047: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-047: Query failed : $_"
}
