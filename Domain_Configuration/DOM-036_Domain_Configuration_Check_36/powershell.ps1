...
try {
    ...
    Write-Host "DOM-036: found $($found.Count) objects"
    ...
    Write-Warning "DOM-036: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-036: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-036: Query failed : $_"
}
