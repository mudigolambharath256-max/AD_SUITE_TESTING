# DCONF-013: LM Hash Storage

## Overview
This security check performs analysis for: **LM Hash Storage**
...
## Description
This check queries Active Directory to identify objects related to LM Hash Storage. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-013.exe csharp.cs
DCONF-013.exe
```
...
- **CheckID**: The check identifier (DCONF-013)
- **CheckName**: The check name (LM Hash Storage)
- **Name**: Object name
