...
try {
    ...
    Write-Host "DOM-035: found $($found.Count) objects"
    ...
    Write-Warning "DOM-035: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-035: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-035: Query failed : $_"
}
