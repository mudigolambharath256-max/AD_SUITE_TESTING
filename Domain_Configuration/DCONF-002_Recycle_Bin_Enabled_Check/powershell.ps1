...
$ldapFilter = '(objectClass=msDS-EnabledFeature)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Recycle Bin Enabled Check" -ForegroundColor Yellow
Write-Host "Check ID: DCONF-002" -ForegroundColor Gray
