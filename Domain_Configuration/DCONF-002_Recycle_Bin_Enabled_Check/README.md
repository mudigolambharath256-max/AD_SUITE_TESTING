# DCONF-002: Recycle Bin Enabled Check

## Overview
This security check performs analysis for: **Recycle Bin Enabled Check**
...
## Description
This check queries Active Directory to identify objects related to Recycle Bin Enabled Check. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-002.exe csharp.cs
DCONF-002.exe
```
...
- **CheckID**: The check identifier (DCONF-002)
- **CheckName**: The check name (Recycle Bin Enabled Check)
- **Name**: Object name
