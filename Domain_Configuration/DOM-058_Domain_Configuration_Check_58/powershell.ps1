...
try {
    ...
    Write-Host "DOM-058: found $($found.Count) objects"
    ...
    Write-Warning "DOM-058: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-058: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-058: Query failed : $_"
}
