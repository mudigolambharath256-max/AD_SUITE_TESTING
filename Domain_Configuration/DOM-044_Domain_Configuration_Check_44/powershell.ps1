...
try {
    ...
    Write-Host "DOM-044: found $($found.Count) objects"
    ...
    Write-Warning "DOM-044: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-044: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-044: Query failed — $_"
}
