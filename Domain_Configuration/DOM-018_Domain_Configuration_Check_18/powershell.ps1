...
try {
    ...
    Write-Host "DOM-018: found $($found.Count) objects"
    ...
    Write-Warning "DOM-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-018: Query failed : $_"
}
