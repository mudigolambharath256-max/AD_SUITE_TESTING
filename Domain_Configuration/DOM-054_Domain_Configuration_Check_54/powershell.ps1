...
try {
    ...
    Write-Host "DOM-054: found $($found.Count) objects"
    ...
    Write-Warning "DOM-054: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-054: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-054: Query failed : $_"
}
