...
try {
    ...
    Write-Host "DOM-037: found $($found.Count) objects"
    ...
    Write-Warning "DOM-037: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-037: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-037: Query failed — $_"
}
