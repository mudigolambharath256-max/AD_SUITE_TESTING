# DCONF-010: LDAP Channel Binding

## Overview
This security check performs analysis for: **LDAP Channel Binding**
...
## Description
This check queries Active Directory to identify objects related to LDAP Channel Binding. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-010.exe csharp.cs
DCONF-010.exe
```
...
- **CheckID**: The check identifier (DCONF-010)
- **CheckName**: The check name (LDAP Channel Binding)
- **Name**: Object name
