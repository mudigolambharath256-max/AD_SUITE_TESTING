...
try {
    ...
    Write-Host "DOM-026: found $($found.Count) objects"
    ...
    Write-Warning "DOM-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-026: Query failed : $_"
}
