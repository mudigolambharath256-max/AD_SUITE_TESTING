...
try {
    ...
    Write-Host "DOM-019: found $($found.Count) objects"
    ...
    Write-Warning "DOM-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-019: Query failed : $_"
}
