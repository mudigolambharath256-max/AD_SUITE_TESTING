# DCONF-017: Domain Controller Lockout Threshold

## Overview
This security check performs analysis for: **Domain Controller Lockout Threshold**
...
## Description
This check queries Active Directory to identify objects related to Domain Controller Lockout Threshold. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-017.exe csharp.cs
DCONF-017.exe
```
...
- **CheckID**: The check identifier (DCONF-017)
- **CheckName**: The check name (Domain Controller Lockout Threshold)
- **Name**: Object name
...
## Related Checks
This check is part of the **Domain_Configuration** category. Related checks:
