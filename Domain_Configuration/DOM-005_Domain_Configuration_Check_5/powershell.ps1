...
try {
    ...
    Write-Host "DOM-005: found $($found.Count) objects"
    ...
    Write-Warning "DOM-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-005: Query failed — $_"
}
