...
try {
    ...
    Write-Host "DOM-053: found $($found.Count) objects"
    ...
    Write-Warning "DOM-053: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-053: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-053: Query failed : $_"
}
