...
try {
    ...
    Write-Host "DOM-023: found $($found.Count) objects"
    ...
    Write-Warning "DOM-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-023: Query failed : $_"
}
