...
## Overview
This security check performs analysis for: **Forest Trust Information**
...
## Description
This check queries Active Directory to identify objects related to Forest Trust Information. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-028.exe csharp.cs
DCONF-028.exe
```
...
- **CheckID**: The check identifier (DCONF-028)
- **CheckName**: The check name (Forest Trust Information)
- **Name**: Object name
