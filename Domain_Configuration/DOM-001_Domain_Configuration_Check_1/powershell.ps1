...
try {
    ...
    Write-Host "DOM-001: found $($found.Count) objects"
    ...
    Write-Warning "DOM-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-001: Query failed — $_"
}
