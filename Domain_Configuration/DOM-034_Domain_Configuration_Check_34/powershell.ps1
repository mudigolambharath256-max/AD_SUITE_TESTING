...
try {
    ...
    Write-Host "DOM-034: found $($found.Count) objects"
    ...
    Write-Warning "DOM-034: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-034: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-034: Query failed : $_"
}
