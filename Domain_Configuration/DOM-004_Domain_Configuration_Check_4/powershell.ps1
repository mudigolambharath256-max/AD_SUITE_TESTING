...
try {
    ...
    Write-Host "DOM-004: found $($found.Count) objects"
    ...
    Write-Warning "DOM-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-004: Query failed : $_"
}
