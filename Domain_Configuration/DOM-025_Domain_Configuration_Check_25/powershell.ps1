...
try {
    ...
    Write-Host "DOM-025: found $($found.Count) objects"
    ...
    Write-Warning "DOM-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-025: Query failed : $_"
}
