...
try {
    ...
    Write-Host "DOM-052: found $($found.Count) objects"
    ...
    Write-Warning "DOM-052: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-052: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-052: Query failed — $_"
}
