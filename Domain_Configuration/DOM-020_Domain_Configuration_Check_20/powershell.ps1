...
try {
    ...
    Write-Host "DOM-020: found $($found.Count) objects"
    ...
    Write-Warning "DOM-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-020: Query failed — $_"
}
