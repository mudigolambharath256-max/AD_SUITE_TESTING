# DCONF-014: NTLM Authentication Settings

## Overview
This security check performs analysis for: **NTLM Authentication Settings**
...
## Description
This check queries Active Directory to identify objects related to NTLM Authentication Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-014.exe csharp.cs
DCONF-014.exe
```
...
- **CheckID**: The check identifier (DCONF-014)
- **CheckName**: The check name (NTLM Authentication Settings)
- **Name**: Object name
