...
try {
    ...
    Write-Host "DOM-050: found $($found.Count) objects"
    ...
    Write-Warning "DOM-050: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-050: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-050: Query failed — $_"
}
