...
## Overview
This security check performs analysis for: **Reset Account Lockout Counter**
...
## Description
This check queries Active Directory to identify objects related to Reset Account Lockout Counter. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-019.exe csharp.cs
DCONF-019.exe
```
...
- **CheckID**: The check identifier (DCONF-019)
- **CheckName**: The check name (Reset Account Lockout Counter)
- **Name**: Object name
