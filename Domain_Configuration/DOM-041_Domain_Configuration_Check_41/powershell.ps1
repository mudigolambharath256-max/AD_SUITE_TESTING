...
try {
    ...
    Write-Host "DOM-041: found $($found.Count) objects"
    ...
    Write-Warning "DOM-041: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-041: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-041: Query failed : $_"
}
