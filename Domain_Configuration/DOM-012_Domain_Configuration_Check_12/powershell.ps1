...
try {
    ...
    Write-Host "DOM-012: found $($found.Count) objects"
    ...
    Write-Warning "DOM-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-012: Query failed : $_"
}
