...
try {
    ...
    Write-Host "DOM-014: found $($found.Count) objects"
    ...
    Write-Warning "DOM-014: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-014: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-014: Query failed : $_"
}
