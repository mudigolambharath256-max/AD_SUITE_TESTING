...
try {
    ...
    Write-Host "DOM-013: found $($found.Count) objects"
    ...
    Write-Warning "DOM-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-013: Query failed — $_"
}
