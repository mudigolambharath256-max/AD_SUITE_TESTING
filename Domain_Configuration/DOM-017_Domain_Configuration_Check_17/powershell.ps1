...
try {
    ...
    Write-Host "DOM-017: found $($found.Count) objects"
    ...
    Write-Warning "DOM-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-017: Query failed — $_"
}
