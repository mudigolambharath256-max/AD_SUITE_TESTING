# DCONF-015: Kerberos Ticket Lifetime

## Overview
This security check performs analysis for: **Kerberos Ticket Lifetime**
...
## Description
This check queries Active Directory to identify objects related to Kerberos Ticket Lifetime. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-015.exe csharp.cs
DCONF-015.exe
```
...
- **CheckID**: The check identifier (DCONF-015)
- **CheckName**: The check name (Kerberos Ticket Lifetime)
- **Name**: Object name
