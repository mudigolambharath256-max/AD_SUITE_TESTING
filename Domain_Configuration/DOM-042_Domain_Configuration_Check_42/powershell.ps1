...
try {
    ...
    Write-Host "DOM-042: found $($found.Count) objects"
    ...
    Write-Warning "DOM-042: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-042: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-042: Query failed : $_"
}
