...
try {
    ...
    Write-Host "DOM-031: found $($found.Count) objects"
    ...
    Write-Warning "DOM-031: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-031: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-031: Query failed — $_"
}
