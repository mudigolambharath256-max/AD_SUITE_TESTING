...
## Overview
This security check performs analysis for: **Kerberos Encryption Types Domain**
...
## Description
This check queries Active Directory to identify objects related to Kerberos Encryption Types Domain. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-001.exe csharp.cs
DCONF-001.exe
```
...
- **CheckID**: The check identifier (DCONF-001)
- **CheckName**: The check name (Kerberos Encryption Types Domain)
- **Name**: Object name
