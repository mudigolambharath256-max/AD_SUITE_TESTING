...
try {
    ...
    Write-Host "DOM-008: found $($found.Count) objects"
    ...
    Write-Warning "DOM-008: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-008: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-008: Query failed : $_"
}
