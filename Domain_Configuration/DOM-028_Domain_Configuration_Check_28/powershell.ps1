...
try {
    ...
    Write-Host "DOM-028: found $($found.Count) objects"
    ...
    Write-Warning "DOM-028: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-028: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-028: Query failed — $_"
}
