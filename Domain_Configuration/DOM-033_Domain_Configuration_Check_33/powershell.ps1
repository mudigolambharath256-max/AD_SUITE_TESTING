...
try {
    ...
    Write-Host "DOM-033: found $($found.Count) objects"
    ...
    Write-Warning "DOM-033: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-033: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-033: Query failed — $_"
}
