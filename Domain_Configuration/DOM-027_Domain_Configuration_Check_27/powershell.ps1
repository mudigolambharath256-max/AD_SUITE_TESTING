...
try {
    ...
    Write-Host "DOM-027: found $($found.Count) objects"
    ...
    Write-Warning "DOM-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-027: Query failed : $_"
}
