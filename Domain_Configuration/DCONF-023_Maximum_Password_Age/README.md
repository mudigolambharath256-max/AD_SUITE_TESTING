# DCONF-023: Maximum Password Age

## Overview
This security check performs analysis for: **Maximum Password Age**
...
## Description
This check queries Active Directory to identify objects related to Maximum Password Age. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-023.exe csharp.cs
DCONF-023.exe
```
...
- **CheckID**: The check identifier (DCONF-023)
- **CheckName**: The check name (Maximum Password Age)
- **Name**: Object name
