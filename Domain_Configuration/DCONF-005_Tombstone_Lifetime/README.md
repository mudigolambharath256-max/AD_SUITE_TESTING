# DCONF-005: Tombstone Lifetime

## Overview
This security check performs analysis for: **Tombstone Lifetime**
...
## Description
This check queries Active Directory to identify objects related to Tombstone Lifetime. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-005.exe csharp.cs
DCONF-005.exe
```
...
- **CheckID**: The check identifier (DCONF-005)
- **CheckName**: The check name (Tombstone Lifetime)
- **Name**: Object name
