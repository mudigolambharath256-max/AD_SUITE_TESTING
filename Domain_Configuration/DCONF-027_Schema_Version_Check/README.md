# DCONF-027: Schema Version Check

## Overview
This security check performs analysis for: **Schema Version Check**
...
## Description
This check queries Active Directory to identify objects related to Schema Version Check. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-027.exe csharp.cs
DCONF-027.exe
```
...
- **CheckID**: The check identifier (DCONF-027)
- **CheckName**: The check name (Schema Version Check)
- **Name**: Object name
