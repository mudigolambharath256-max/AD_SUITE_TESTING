...
try {
    ...
    Write-Host "DOM-045: found $($found.Count) objects"
    ...
    Write-Warning "DOM-045: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-045: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-045: Query failed — $_"
}
