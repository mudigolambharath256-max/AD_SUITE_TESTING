# DCONF-022: Password History Count

## Overview
This security check performs analysis for: **Password History Count**
...
## Description
This check queries Active Directory to identify objects related to Password History Count. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-022.exe csharp.cs
DCONF-022.exe
```
...
- **CheckID**: The check identifier (DCONF-022)
- **CheckName**: The check name (Password History Count)
- **Name**: Object name
