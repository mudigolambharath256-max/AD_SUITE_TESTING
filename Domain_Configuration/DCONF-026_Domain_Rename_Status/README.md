...
## Overview
This security check performs analysis for: **Domain Rename Status**
...
## Description
This check queries Active Directory to identify objects related to Domain Rename Status. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-026.exe csharp.cs
DCONF-026.exe
```
...
- **CheckID**: The check identifier (DCONF-026)
- **CheckName**: The check name (Domain Rename Status)
- **Name**: Object name
