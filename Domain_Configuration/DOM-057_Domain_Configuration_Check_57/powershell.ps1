...
try {
    ...
    Write-Host "DOM-057: found $($found.Count) objects"
    ...
    Write-Warning "DOM-057: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-057: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-057: Query failed — $_"
}
