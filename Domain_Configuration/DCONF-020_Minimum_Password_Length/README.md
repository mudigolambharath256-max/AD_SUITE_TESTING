# DCONF-020: Minimum Password Length

## Overview
This security check performs analysis for: **Minimum Password Length**
...
## Description
This check queries Active Directory to identify objects related to Minimum Password Length. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-020.exe csharp.cs
DCONF-020.exe
```
...
- **CheckID**: The check identifier (DCONF-020)
- **CheckName**: The check name (Minimum Password Length)
- **Name**: Object name
