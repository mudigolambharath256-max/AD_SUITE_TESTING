# DCONF-009: LDAP Signing Requirements

## Overview
This security check performs analysis for: **LDAP Signing Requirements**
...
## Description
This check queries Active Directory to identify objects related to LDAP Signing Requirements. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-009.exe csharp.cs
DCONF-009.exe
```
...
- **CheckID**: The check identifier (DCONF-009)
- **CheckName**: The check name (LDAP Signing Requirements)
- **Name**: Object name
