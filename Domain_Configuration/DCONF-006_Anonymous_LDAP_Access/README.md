# DCONF-006: Anonymous LDAP Access

## Overview
This security check performs analysis for: **Anonymous LDAP Access**
...
## Description
This check queries Active Directory to identify objects related to Anonymous LDAP Access. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-006.exe csharp.cs
DCONF-006.exe
```
...
- **CheckID**: The check identifier (DCONF-006)
- **CheckName**: The check name (Anonymous LDAP Access)
- **Name**: Object name
