...
try {
    ...
    Write-Host "DOM-007: found $($found.Count) objects"
    ...
    Write-Warning "DOM-007: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-007: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-007: Query failed : $_"
}
