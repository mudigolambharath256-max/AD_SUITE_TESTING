...
try {
    ...
    Write-Host "DOM-040: found $($found.Count) objects"
    ...
    Write-Warning "DOM-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-040: Query failed : $_"
}
