...
try {
    ...
    Write-Host "DOM-048: found $($found.Count) objects"
    ...
    Write-Warning "DOM-048: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-048: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-048: Query failed — $_"
}
