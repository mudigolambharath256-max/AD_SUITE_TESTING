# DCONF-011: SMB Signing Configuration

## Overview
This security check performs analysis for: **SMB Signing Configuration**
...
## Description
This check queries Active Directory to identify objects related to SMB Signing Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-011.exe csharp.cs
DCONF-011.exe
```
...
- **CheckID**: The check identifier (DCONF-011)
- **CheckName**: The check name (SMB Signing Configuration)
- **Name**: Object name
