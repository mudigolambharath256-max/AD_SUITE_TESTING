...
try {
    ...
    Write-Host "DOM-015: found $($found.Count) objects"
    ...
    Write-Warning "DOM-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-015: Query failed — $_"
}
