...
# Check: Domain Configuration Check 32
...
Write-Host "=== Domain Configuration Check 32 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "DOM-032 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "DOM-032 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "DOM-032 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== DOM-032: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "DOM-032_results.csv"
$uniqueResults |
