...
try {
    ...
    Write-Host "DOM-032: found $($found.Count) objects"
    ...
    Write-Warning "DOM-032: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-032: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-032: Query failed : $_"
}
