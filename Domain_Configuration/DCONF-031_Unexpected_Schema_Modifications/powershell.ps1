# ============================================================================
# DCONF-031: Unexpected Schema Modifications
# ============================================================================
...
Write-Host "Executing: Unexpected Schema Modifications" -ForegroundColor Cyan
Write-Host "Check ID: DCONF-031" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=dMD)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'DCONF-031'}}, `
    @{N='CheckName'; E={'Unexpected Schema Modifications'}}, `
    @{N='RiskScore'; E={8}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1484.001'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'DCONF-031'
                adSuiteCheckName  = 'Unexpected_Schema_Modifications'
    ...
    $bhFile = Join-Path $bhDir "DCONF-031_$bhTs.json"
    @{
