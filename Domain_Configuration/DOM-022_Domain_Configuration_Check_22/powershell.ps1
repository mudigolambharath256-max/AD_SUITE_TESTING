...
try {
    ...
    Write-Host "DOM-022: found $($found.Count) objects"
    ...
    Write-Warning "DOM-022: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-022: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-022: Query failed : $_"
}
