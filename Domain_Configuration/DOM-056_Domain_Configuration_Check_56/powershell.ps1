...
try {
    ...
    Write-Host "DOM-056: found $($found.Count) objects"
    ...
    Write-Warning "DOM-056: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-056: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-056: Query failed : $_"
}
