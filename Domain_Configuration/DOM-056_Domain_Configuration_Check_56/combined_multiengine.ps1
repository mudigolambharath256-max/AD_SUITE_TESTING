...
# Check: Domain Configuration Check 56
...
Write-Host "=== Domain Configuration Check 56 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "DOM-056 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "DOM-056 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "DOM-056 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== DOM-056: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "DOM-056_results.csv"
$uniqueResults |
