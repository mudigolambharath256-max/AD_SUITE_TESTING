# DCONF-012: Null Session Access

## Overview
This security check performs analysis for: **Null Session Access**
...
## Description
This check queries Active Directory to identify objects related to Null Session Access. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-012.exe csharp.cs
DCONF-012.exe
```
...
- **CheckID**: The check identifier (DCONF-012)
- **CheckName**: The check name (Null Session Access)
- **Name**: Object name
