...
try {
    ...
    Write-Host "DOM-006: found $($found.Count) objects"
    ...
    Write-Warning "DOM-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-006: Query failed : $_"
}
