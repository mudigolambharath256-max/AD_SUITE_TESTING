# DCONF-030: FSMO Role Holders

## Overview
This security check performs analysis for: **FSMO Role Holders**
...
## Description
This check queries Active Directory to identify objects related to FSMO Role Holders. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-030.exe csharp.cs
DCONF-030.exe
```
...
- **CheckID**: The check identifier (DCONF-030)
- **CheckName**: The check name (FSMO Role Holders)
- **Name**: Object name
