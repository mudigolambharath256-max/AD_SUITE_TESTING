...
$ldapFilter = '(options:1.2.840.113556.1.4.803:=1)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Global Catalog Servers" -ForegroundColor Yellow
Write-Host "Check ID: DCONF-029" -ForegroundColor Gray
