# DCONF-029: Global Catalog Servers

## Overview
This security check performs analysis for: **Global Catalog Servers**
...
## Description
This check queries Active Directory to identify objects related to Global Catalog Servers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-029.exe csharp.cs
DCONF-029.exe
```
...
- **CheckID**: The check identifier (DCONF-029)
- **CheckName**: The check name (Global Catalog Servers)
- **Name**: Object name
