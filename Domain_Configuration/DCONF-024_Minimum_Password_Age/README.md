# DCONF-024: Minimum Password Age

## Overview
This security check performs analysis for: **Minimum Password Age**
...
## Description
This check queries Active Directory to identify objects related to Minimum Password Age. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-024.exe csharp.cs
DCONF-024.exe
```
...
- **CheckID**: The check identifier (DCONF-024)
- **CheckName**: The check name (Minimum Password Age)
- **Name**: Object name
