...
try {
    ...
    Write-Host "DOM-049: found $($found.Count) objects"
    ...
    Write-Warning "DOM-049: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "DOM-049: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "DOM-049: Query failed — $_"
}
