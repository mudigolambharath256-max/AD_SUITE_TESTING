...
## Overview
This security check performs analysis for: **Account Lockout Duration**
...
## Description
This check queries Active Directory to identify objects related to Account Lockout Duration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-018.exe csharp.cs
DCONF-018.exe
```
...
- **CheckID**: The check identifier (DCONF-018)
- **CheckName**: The check name (Account Lockout Duration)
- **Name**: Object name
