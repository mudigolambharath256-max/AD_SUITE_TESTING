# DCONF-025: Reversible Encryption Policy

## Overview
This security check performs analysis for: **Reversible Encryption Policy**
...
## Description
This check queries Active Directory to identify objects related to Reversible Encryption Policy. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:DCONF-025.exe csharp.cs
DCONF-025.exe
```
...
- **CheckID**: The check identifier (DCONF-025)
- **CheckName**: The check name (Reversible Encryption Policy)
- **Name**: Object name
