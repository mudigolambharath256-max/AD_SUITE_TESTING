...
try {
    ...
    Write-Host "GPO-019: found $($found.Count) objects"
    ...
    Write-Warning "GPO-019: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-019: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-019: Query failed — $_"
}
