...
try {
    ...
    Write-Host "GPO-010: found $($found.Count) objects"
    ...
    Write-Warning "GPO-010: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-010: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-010: Query failed : $_"
}
