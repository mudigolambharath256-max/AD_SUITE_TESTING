...
try {
    ...
    Write-Host "GPO-012: found $($found.Count) objects"
    ...
    Write-Warning "GPO-012: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-012: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-012: Query failed — $_"
}
