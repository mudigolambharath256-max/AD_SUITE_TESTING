...
try {
    ...
    Write-Host "GPO-020: found $($found.Count) objects"
    ...
    Write-Warning "GPO-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-020: Query failed — $_"
}
