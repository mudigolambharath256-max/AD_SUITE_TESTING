...
@('name', 'distinguishedName', 'displayName', 'gPCWQLFilter', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-005_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPOs with WMI Filters
# Category: Group Policy
# Severity: low
# ID: GPO-005
# Requirements: None
