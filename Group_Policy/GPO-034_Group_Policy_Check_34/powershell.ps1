...
try {
    ...
    Write-Host "GPO-034: found $($found.Count) objects"
    ...
    Write-Warning "GPO-034: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-034: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-034: Query failed : $_"
}
