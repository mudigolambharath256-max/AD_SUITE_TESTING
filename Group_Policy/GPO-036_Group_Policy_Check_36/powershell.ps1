...
try {
    ...
    Write-Host "GPO-036: found $($found.Count) objects"
    ...
    Write-Warning "GPO-036: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-036: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-036: Query failed — $_"
}
