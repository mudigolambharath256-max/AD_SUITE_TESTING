...
try {
    ...
    Write-Host "GPO-027: found $($found.Count) objects"
    ...
    Write-Warning "GPO-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-027: Query failed : $_"
}
