...
Write-Host "=== GPO-031: GPO Modification History ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-031'
                adSuiteCheckName  = 'GPO_Modification_History'
    ...
    $bhFile = Join-Path $bhDir "GPO-031_$bhTs.json"
    @{
