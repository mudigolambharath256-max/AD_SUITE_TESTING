...
Write-Host "Executing: GPO Modification History" -ForegroundColor Cyan
Write-Host "Check ID: GPO-031" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'GPO-031'}}, `
    @{N='CheckName'; E={'GPO Modification History'}}, `
    @{N='RiskScore'; E={8}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1484.001'}}, `
