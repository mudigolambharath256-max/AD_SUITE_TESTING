...
try {
    ...
    Write-Host "GPO-013: found $($found.Count) objects"
    ...
    Write-Warning "GPO-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-013: Query failed — $_"
}
