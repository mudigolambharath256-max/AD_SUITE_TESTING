# ============================================================================
# GPO-046: GPO Software Installation Issues - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-046] GPO Software Installation Issues" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-046'
                adSuiteCheckName  = 'GPO_Software_Installation_Issues'
    ...
    $bhFile = Join-Path $bhDir "GPO-046_$bhTs.json"
    @{
