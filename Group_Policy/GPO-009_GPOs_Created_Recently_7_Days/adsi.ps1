...
@('name', 'distinguishedName', 'displayName', 'whenCreated', 'gPCFileSysPath', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-009_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPOs Created Recently (7 Days)
# Category: Group Policy
# Severity: info
# ID: GPO-009
# Requirements: None
