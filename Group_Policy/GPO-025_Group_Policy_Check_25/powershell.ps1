...
try {
    ...
    Write-Host "GPO-025: found $($found.Count) objects"
    ...
    Write-Warning "GPO-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-025: Query failed : $_"
}
