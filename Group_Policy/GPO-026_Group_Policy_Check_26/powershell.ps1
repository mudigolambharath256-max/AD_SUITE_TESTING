...
try {
    ...
    Write-Host "GPO-026: found $($found.Count) objects"
    ...
    Write-Warning "GPO-026: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-026: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-026: Query failed — $_"
}
