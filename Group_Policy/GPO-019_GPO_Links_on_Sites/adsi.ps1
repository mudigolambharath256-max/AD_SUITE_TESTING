...
@('name', 'distinguishedName', 'cn', 'gPLink', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-019_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPO Links on Sites
# Category: Group Policy
# Severity: info
# ID: GPO-019
# Requirements: None
