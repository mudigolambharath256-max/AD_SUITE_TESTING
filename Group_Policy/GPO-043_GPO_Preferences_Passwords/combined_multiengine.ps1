# ============================================================================
# GPO-043: GPO Preferences Passwords - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-043] GPO Preferences Passwords" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-043'
                adSuiteCheckName  = 'GPO_Preferences_Passwords'
    ...
    $bhFile = Join-Path $bhDir "GPO-043_$bhTs.json"
    @{
