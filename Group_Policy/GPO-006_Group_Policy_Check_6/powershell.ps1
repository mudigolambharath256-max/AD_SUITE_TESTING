...
try {
    ...
    Write-Host "GPO-006: found $($found.Count) objects"
    ...
    Write-Warning "GPO-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-006: Query failed — $_"
}
