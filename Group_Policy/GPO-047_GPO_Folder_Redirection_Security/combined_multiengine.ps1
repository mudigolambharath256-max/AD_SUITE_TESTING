# ============================================================================
# GPO-047: GPO Folder Redirection Security - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-047] GPO Folder Redirection Security" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-047'
                adSuiteCheckName  = 'GPO_Folder_Redirection_Security'
    ...
    $bhFile = Join-Path $bhDir "GPO-047_$bhTs.json"
    @{
