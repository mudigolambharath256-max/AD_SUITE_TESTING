...
try {
    ...
    Write-Host "GPO-038: found $($found.Count) objects"
    ...
    Write-Warning "GPO-038: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-038: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-038: Query failed : $_"
}
