# ============================================================================
# GPO-041: GPO Replication Issues - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-041] GPO Replication Issues" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-041'
                adSuiteCheckName  = 'GPO_Replication_Issues'
    ...
    $bhFile = Join-Path $bhDir "GPO-041_$bhTs.json"
    @{
