...
try {
    ...
    Write-Host "GPO-003: found $($found.Count) objects"
    ...
    Write-Warning "GPO-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-003: Query failed : $_"
}
