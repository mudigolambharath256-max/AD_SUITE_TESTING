...
@('name', 'distinguishedName', 'displayName', 'flags', 'whenChanged', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-003_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPOs with Both Settings Disabled
# Category: Group Policy
# Severity: medium
# ID: GPO-003
# Requirements: None
