...
try {
    ...
    Write-Host "GPO-040: found $($found.Count) objects"
    ...
    Write-Warning "GPO-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-040: Query failed : $_"
}
