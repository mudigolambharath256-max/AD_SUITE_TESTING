# ============================================================================
# GPO-035: GPO Security Filtering Issues - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-035] GPO Security Filtering Issues" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-035'
                adSuiteCheckName  = 'GPO_Security_Filtering_Issues'
    ...
    $bhFile = Join-Path $bhDir "GPO-035_$bhTs.json"
    @{
