...
try {
    ...
    Write-Host "GPO-002: found $($found.Count) objects"
    ...
    Write-Warning "GPO-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-002: Query failed — $_"
}
