# ============================================================================
# GPO-039: Slow Link Detection Settings - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-039] Slow Link Detection Settings" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-039'
                adSuiteCheckName  = 'Slow_Link_Detection_Settings'
    ...
    $bhFile = Join-Path $bhDir "GPO-039_$bhTs.json"
    @{
