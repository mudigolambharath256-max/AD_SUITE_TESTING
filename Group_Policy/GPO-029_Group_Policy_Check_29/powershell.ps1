...
try {
    ...
    Write-Host "GPO-029: found $($found.Count) objects"
    ...
    Write-Warning "GPO-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-029: Query failed — $_"
}
