...
try {
    ...
    Write-Host "GPO-023: found $($found.Count) objects"
    ...
    Write-Warning "GPO-023: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-023: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-023: Query failed — $_"
}
