...
try {
    ...
    Write-Host "GPO-011: found $($found.Count) objects"
    ...
    Write-Warning "GPO-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-011: Query failed — $_"
}
