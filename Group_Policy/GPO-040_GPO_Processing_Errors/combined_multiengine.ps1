# ============================================================================
# GPO-040: GPO Processing Errors - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-040] GPO Processing Errors" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-040'
                adSuiteCheckName  = 'GPO_Processing_Errors'
    ...
    $bhFile = Join-Path $bhDir "GPO-040_$bhTs.json"
    @{
