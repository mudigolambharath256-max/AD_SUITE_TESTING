...
Write-Host "Severity: MEDIUM | Risk: 5/10 | MITRE: T1484.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=groupPolicyContainer)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'GPO-038'}}, `
    @{N='CheckName'; E={'Loopback Processing Misconfigurations'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1484.001'}}, `
