...
try {
    ...
    Write-Host "GPO-018: found $($found.Count) objects"
    ...
    Write-Warning "GPO-018: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-018: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-018: Query failed — $_"
}
