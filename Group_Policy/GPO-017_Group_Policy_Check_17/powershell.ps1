...
try {
    ...
    Write-Host "GPO-017: found $($found.Count) objects"
    ...
    Write-Warning "GPO-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-017: Query failed — $_"
}
