...
try {
    ...
    Write-Host "GPO-005: found $($found.Count) objects"
    ...
    Write-Warning "GPO-005: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-005: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-005: Query failed : $_"
}
