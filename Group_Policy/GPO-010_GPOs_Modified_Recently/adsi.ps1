...
@('name', 'distinguishedName', 'displayName', 'whenChanged', 'versionNumber', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-010_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPOs Modified Recently
# Category: Group Policy
# Severity: info
# ID: GPO-010
# Requirements: None
