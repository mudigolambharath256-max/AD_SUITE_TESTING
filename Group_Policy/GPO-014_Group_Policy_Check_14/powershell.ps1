...
try {
    ...
    Write-Host "GPO-014: found $($found.Count) objects"
    ...
    Write-Warning "GPO-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-014: Query failed — $_"
}
