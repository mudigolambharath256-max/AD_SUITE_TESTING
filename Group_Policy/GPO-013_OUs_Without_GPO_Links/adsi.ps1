...
@('name', 'distinguishedName', 'ou', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-013_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: OUs Without GPO Links
# Category: Group Policy
# Severity: low
# ID: GPO-013
# Requirements: None
