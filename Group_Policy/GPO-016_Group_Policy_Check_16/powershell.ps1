...
try {
    ...
    Write-Host "GPO-016: found $($found.Count) objects"
    ...
    Write-Warning "GPO-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-016: Query failed — $_"
}
