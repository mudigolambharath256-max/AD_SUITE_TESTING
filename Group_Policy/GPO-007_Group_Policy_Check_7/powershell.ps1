...
try {
    ...
    Write-Host "GPO-007: found $($found.Count) objects"
    ...
    Write-Warning "GPO-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-007: Query failed — $_"
}
