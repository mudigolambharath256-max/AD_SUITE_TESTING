# ============================================================================
# GPO-044: GPO Scheduled Tasks Security - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-044] GPO Scheduled Tasks Security" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-044'
                adSuiteCheckName  = 'GPO_Scheduled_Tasks_Security'
    ...
    $bhFile = Join-Path $bhDir "GPO-044_$bhTs.json"
    @{
