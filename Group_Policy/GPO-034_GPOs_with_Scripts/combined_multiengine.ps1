...
Write-Host "=== GPO-034: GPOs with Scripts ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-034'
                adSuiteCheckName  = 'GPOs_with_Scripts'
    ...
    $bhFile = Join-Path $bhDir "GPO-034_$bhTs.json"
    @{
