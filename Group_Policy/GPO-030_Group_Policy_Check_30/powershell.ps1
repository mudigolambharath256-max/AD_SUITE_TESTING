...
try {
    ...
    Write-Host "GPO-030: found $($found.Count) objects"
    ...
    Write-Warning "GPO-030: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-030: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-030: Query failed : $_"
}
