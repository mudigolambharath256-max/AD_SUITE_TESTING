...
try {
    ...
    Write-Host "GPO-008: found $($found.Count) objects"
    ...
    Write-Warning "GPO-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-008: Query failed — $_"
}
