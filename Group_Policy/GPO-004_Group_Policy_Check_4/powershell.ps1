...
try {
    ...
    Write-Host "GPO-004: found $($found.Count) objects"
    ...
    Write-Warning "GPO-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-004: Query failed — $_"
}
