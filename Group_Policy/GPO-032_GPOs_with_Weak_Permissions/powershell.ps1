...
Write-Host "Executing: GPOs with Weak Permissions" -ForegroundColor Cyan
Write-Host "Check ID: GPO-032" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'GPO-032'}}, `
    @{N='CheckName'; E={'GPOs with Weak Permissions'}}, `
    @{N='RiskScore'; E={8}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1484.001'}}, `
