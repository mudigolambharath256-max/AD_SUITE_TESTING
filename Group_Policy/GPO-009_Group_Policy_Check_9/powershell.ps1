...
try {
    ...
    Write-Host "GPO-009: found $($found.Count) objects"
    ...
    Write-Warning "GPO-009: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-009: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-009: Query failed : $_"
}
