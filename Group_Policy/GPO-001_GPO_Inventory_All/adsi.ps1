...
@('name', 'distinguishedName', 'displayName', 'gPCFileSysPath', 'versionNumber', 'flags', 'whenCreated', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-001_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPO Inventory (All)
# Category: Group Policy
# Severity: info
# ID: GPO-001
# Requirements: None
