...
Write-Host "Severity: LOW | Risk: 4/10 | MITRE: T1484.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=msWMI-Som)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'GPO-036'}}, `
    @{N='CheckName'; E={'WMI Filter Validation'}}, `
    @{N='RiskScore'; E={4}}, `
    @{N='Severity'; E={'LOW'}}, `
    @{N='MITRE'; E={'T1484.001'}}, `
