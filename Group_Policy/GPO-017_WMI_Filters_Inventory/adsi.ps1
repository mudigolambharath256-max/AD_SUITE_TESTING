...
@('name', 'distinguishedName', 'msWMI-Name', 'msWMI-Author', 'msWMI-Parm2', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-017_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: WMI Filters Inventory
# Category: Group Policy
# Severity: info
# ID: GPO-017
# Requirements: None
