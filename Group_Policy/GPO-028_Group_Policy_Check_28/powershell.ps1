...
try {
    ...
    Write-Host "GPO-028: found $($found.Count) objects"
    ...
    Write-Warning "GPO-028: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-028: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-028: Query failed — $_"
}
