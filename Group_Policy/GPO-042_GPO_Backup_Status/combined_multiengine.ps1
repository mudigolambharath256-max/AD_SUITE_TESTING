# ============================================================================
# GPO-042: GPO Backup Status - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-042] GPO Backup Status" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-042'
                adSuiteCheckName  = 'GPO_Backup_Status'
    ...
    $bhFile = Join-Path $bhDir "GPO-042_$bhTs.json"
    @{
