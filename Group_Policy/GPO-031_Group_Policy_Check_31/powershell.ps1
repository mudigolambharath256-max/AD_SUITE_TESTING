...
try {
    ...
    Write-Host "GPO-031: found $($found.Count) objects"
    ...
    Write-Warning "GPO-031: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-031: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-031: Query failed — $_"
}
