...
@('name', 'distinguishedName', 'ou', 'gPOptions', 'gPLink', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-014_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: OUs Blocking Inheritance
# Category: Group Policy
# Severity: medium
# ID: GPO-014
# Requirements: None
