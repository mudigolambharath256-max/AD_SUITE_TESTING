...
try {
    ...
    Write-Host "GPO-032: found $($found.Count) objects"
    ...
    Write-Warning "GPO-032: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-032: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-032: Query failed : $_"
}
