# ============================================================================
# GPO-048: GPO Startup Shutdown Scripts - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-048] GPO Startup Shutdown Scripts" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-048'
                adSuiteCheckName  = 'GPO_Startup_Shutdown_Scripts'
    ...
    $bhFile = Join-Path $bhDir "GPO-048_$bhTs.json"
    @{
