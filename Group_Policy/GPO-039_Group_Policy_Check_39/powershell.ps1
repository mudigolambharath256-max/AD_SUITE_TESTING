...
try {
    ...
    Write-Host "GPO-039: found $($found.Count) objects"
    ...
    Write-Warning "GPO-039: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-039: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-039: Query failed : $_"
}
