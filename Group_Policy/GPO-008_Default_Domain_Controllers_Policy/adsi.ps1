...
@('name', 'distinguishedName', 'displayName', 'versionNumber', 'gPCFileSysPath', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-008_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Default Domain Controllers Policy
# Category: Group Policy
# Severity: info
# ID: GPO-008
# Requirements: None
