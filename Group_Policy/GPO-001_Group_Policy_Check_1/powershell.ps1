...
try {
    ...
    Write-Host "GPO-001: found $($found.Count) objects"
    ...
    Write-Warning "GPO-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-001: Query failed — $_"
}
