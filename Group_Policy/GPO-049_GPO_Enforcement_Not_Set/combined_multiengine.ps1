# ============================================================================
# GPO-049: GPO Enforcement Not Set - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-049] GPO Enforcement Not Set" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-049'
                adSuiteCheckName  = 'GPO_Enforcement_Not_Set'
    ...
    $bhFile = Join-Path $bhDir "GPO-049_$bhTs.json"
    @{
