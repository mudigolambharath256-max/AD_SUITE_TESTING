...
@('name', 'distinguishedName', 'gPLink', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-018_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPO Links on Domain Root
# Category: Group Policy
# Severity: info
# ID: GPO-018
# Requirements: None
