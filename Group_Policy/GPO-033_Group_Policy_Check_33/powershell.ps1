...
try {
    ...
    Write-Host "GPO-033: found $($found.Count) objects"
    ...
    Write-Warning "GPO-033: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-033: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-033: Query failed — $_"
}
