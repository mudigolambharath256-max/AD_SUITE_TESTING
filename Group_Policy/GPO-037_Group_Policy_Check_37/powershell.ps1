...
try {
    ...
    Write-Host "GPO-037: found $($found.Count) objects"
    ...
    Write-Warning "GPO-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-037: Query failed : $_"
}
