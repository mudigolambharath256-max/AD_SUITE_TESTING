...
try {
    ...
    Write-Host "GPO-021: found $($found.Count) objects"
    ...
    Write-Warning "GPO-021: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-021: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-021: Query failed — $_"
}
