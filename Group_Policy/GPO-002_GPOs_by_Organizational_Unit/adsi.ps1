...
@('name', 'distinguishedName', 'ou', 'gPLink', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-002_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPOs by Organizational Unit
# Category: Group Policy
# Severity: info
# ID: GPO-002
# Requirements: None
