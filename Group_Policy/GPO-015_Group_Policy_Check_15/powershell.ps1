...
try {
    ...
    Write-Host "GPO-015: found $($found.Count) objects"
    ...
    Write-Warning "GPO-015: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-015: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-015: Query failed : $_"
}
