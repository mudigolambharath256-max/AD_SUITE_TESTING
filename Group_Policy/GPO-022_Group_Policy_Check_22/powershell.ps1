...
try {
    ...
    Write-Host "GPO-022: found $($found.Count) objects"
    ...
    Write-Warning "GPO-022: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "GPO-022: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "GPO-022: Query failed : $_"
}
