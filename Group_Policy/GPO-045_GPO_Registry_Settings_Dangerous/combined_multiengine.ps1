# ============================================================================
# GPO-045: GPO Registry Settings Dangerous - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[GPO-045] GPO Registry Settings Dangerous" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'GPO-045'
                adSuiteCheckName  = 'GPO_Registry_Settings_Dangerous'
    ...
    $bhFile = Join-Path $bhDir "GPO-045_$bhTs.json"
    @{
