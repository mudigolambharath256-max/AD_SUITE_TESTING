...
@('name', 'distinguishedName', 'displayName', 'gPCFileSysPath', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "GPO-006_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: GPO Containing Password (Naming)
# Category: Group Policy
# Severity: high
# ID: GPO-006
# Requirements: None
