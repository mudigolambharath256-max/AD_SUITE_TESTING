...
try {
    ...
    Write-Host "INFRA-022: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-022: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-022: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-022: Query failed — $_"
}
