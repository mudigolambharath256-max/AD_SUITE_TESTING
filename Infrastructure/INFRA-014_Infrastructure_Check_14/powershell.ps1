...
try {
    ...
    Write-Host "INFRA-014: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-014: Query failed — $_"
}
