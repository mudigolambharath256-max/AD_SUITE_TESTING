# INFRA-025: Overlapping Subnets

## Overview
This security check performs analysis for: **Overlapping Subnets**
...
## Description
This check queries Active Directory to identify objects related to Overlapping Subnets. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-025.exe csharp.cs
INFRA-025.exe
```
...
- **CheckID**: The check identifier (INFRA-025)
- **CheckName**: The check name (Overlapping Subnets)
- **Name**: Object name
