...
Write-Host "=== INFRA-025: Overlapping Subnets ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-025'}}, `
            @{N='CheckName'; E={'Overlapping Subnets'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Overlapping_Subnets'
    ...
    $bhFile = Join-Path $bhDir "INFRA-025_$bhTs.json"
    @{
