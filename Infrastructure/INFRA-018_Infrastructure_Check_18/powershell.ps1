...
try {
    ...
    Write-Host "INFRA-018: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-018: Query failed : $_"
}
