# INFRA-008: Site Link Bridges

## Overview
This security check performs analysis for: **Site Link Bridges**
...
## Description
This check queries Active Directory to identify objects related to Site Link Bridges. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-008.exe csharp.cs
INFRA-008.exe
```
...
- **CheckID**: The check identifier (INFRA-008)
- **CheckName**: The check name (Site Link Bridges)
- **Name**: Object name
