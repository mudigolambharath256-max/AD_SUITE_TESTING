...
$ldapFilter = '(objectClass=siteLinkBridge)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Site Link Bridges" -ForegroundColor Yellow
Write-Host "Check ID: INFRA-008" -ForegroundColor Gray
