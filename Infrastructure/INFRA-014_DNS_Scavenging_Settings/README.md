...
## Overview
This security check performs analysis for: **DNS Scavenging Settings**
...
## Description
This check queries Active Directory to identify objects related to DNS Scavenging Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-014.exe csharp.cs
INFRA-014.exe
```
...
- **CheckID**: The check identifier (INFRA-014)
- **CheckName**: The check name (DNS Scavenging Settings)
- **Name**: Object name
