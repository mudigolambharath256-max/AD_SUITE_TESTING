...
try {
    ...
    Write-Host "INFRA-015: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-015: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-015: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-015: Query failed : $_"
}
