...
try {
    ...
    Write-Host "INFRA-029: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-029: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-029: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-029: Query failed : $_"
}
