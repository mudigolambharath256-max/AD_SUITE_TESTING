...
try {
    ...
    Write-Host "INFRA-008: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-008: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-008: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-008: Query failed : $_"
}
