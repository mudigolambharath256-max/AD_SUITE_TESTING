# INFRA-027: Sites Without Subnets

## Overview
This security check performs analysis for: **Sites Without Subnets**
...
## Description
This check queries Active Directory to identify objects related to Sites Without Subnets. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-027.exe csharp.cs
INFRA-027.exe
```
...
- **CheckID**: The check identifier (INFRA-027)
- **CheckName**: The check name (Sites Without Subnets)
- **Name**: Object name
