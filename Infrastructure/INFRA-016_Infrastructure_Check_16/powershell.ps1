...
try {
    ...
    Write-Host "INFRA-016: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-016: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-016: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-016: Query failed : $_"
}
