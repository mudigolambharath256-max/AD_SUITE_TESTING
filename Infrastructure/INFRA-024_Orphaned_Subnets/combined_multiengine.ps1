...
Write-Host "=== INFRA-024: Orphaned Subnets ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-024'}}, `
            @{N='CheckName'; E={'Orphaned Subnets'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Orphaned_Subnets'
    ...
    $bhFile = Join-Path $bhDir "INFRA-024_$bhTs.json"
    @{
