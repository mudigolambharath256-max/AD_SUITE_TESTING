# INFRA-024: Orphaned Subnets

## Overview
This security check performs analysis for: **Orphaned Subnets**
...
## Description
This check queries Active Directory to identify objects related to Orphaned Subnets. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-024.exe csharp.cs
INFRA-024.exe
```
...
- **CheckID**: The check identifier (INFRA-024)
- **CheckName**: The check name (Orphaned Subnets)
- **Name**: Object name
