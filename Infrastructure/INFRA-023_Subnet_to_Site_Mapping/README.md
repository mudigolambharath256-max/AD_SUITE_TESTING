# INFRA-023: Subnet to Site Mapping

## Overview
This security check performs analysis for: **Subnet to Site Mapping**
...
## Description
This check queries Active Directory to identify objects related to Subnet to Site Mapping. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-023.exe csharp.cs
INFRA-023.exe
```
...
- **CheckID**: The check identifier (INFRA-023)
- **CheckName**: The check name (Subnet to Site Mapping)
- **Name**: Object name
