...
try {
    ...
    Write-Host "INFRA-017: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-017: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-017: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-017: Query failed : $_"
}
