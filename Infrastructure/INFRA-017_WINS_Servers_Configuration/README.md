# INFRA-017: WINS Servers Configuration

## Overview
This security check performs analysis for: **WINS Servers Configuration**
...
## Description
This check queries Active Directory to identify objects related to WINS Servers Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-017.exe csharp.cs
INFRA-017.exe
```
...
- **CheckID**: The check identifier (INFRA-017)
- **CheckName**: The check name (WINS Servers Configuration)
- **Name**: Object name
