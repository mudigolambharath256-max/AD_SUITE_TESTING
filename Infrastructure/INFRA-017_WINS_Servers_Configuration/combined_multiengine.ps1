...
Write-Host "=== INFRA-017: WINS Servers Configuration ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-017'}}, `
            @{N='CheckName'; E={'WINS Servers Configuration'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'INFRA-017'
                CheckName         = 'WINS Servers Configuration'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'WINS_Servers_Configuration'
    ...
    $bhFile = Join-Path $bhDir "INFRA-017_$bhTs.json"
    @{
