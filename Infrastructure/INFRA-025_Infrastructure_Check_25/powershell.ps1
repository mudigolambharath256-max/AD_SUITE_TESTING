...
try {
    ...
    Write-Host "INFRA-025: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-025: Query failed : $_"
}
