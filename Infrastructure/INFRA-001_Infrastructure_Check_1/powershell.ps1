...
try {
    ...
    Write-Host "INFRA-001: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-001: Query failed — $_"
}
