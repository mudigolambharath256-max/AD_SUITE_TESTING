...
try {
    ...
    Write-Host "INFRA-026: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-026: Query failed : $_"
}
