...
try {
    ...
    Write-Host "INFRA-019: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-019: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-019: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-019: Query failed — $_"
}
