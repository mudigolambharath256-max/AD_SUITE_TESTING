# INFRA-004: Organizational Units OU Inventory

## Overview
This security check performs analysis for: **Organizational Units OU Inventory**
...
## Description
This check queries Active Directory to identify objects related to Organizational Units OU Inventory. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-004.exe csharp.cs
INFRA-004.exe
```
...
- **CheckID**: The check identifier (INFRA-004)
- **CheckName**: The check name (Organizational Units OU Inventory)
- **Name**: Object name
