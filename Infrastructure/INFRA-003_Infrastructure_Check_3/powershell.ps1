...
try {
    ...
    Write-Host "INFRA-003: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-003: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-003: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-003: Query failed — $_"
}
