# INFRA-021: Preferred Bridgehead Servers

## Overview
This security check performs analysis for: **Preferred Bridgehead Servers**
...
## Description
This check queries Active Directory to identify objects related to Preferred Bridgehead Servers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-021.exe csharp.cs
INFRA-021.exe
```
...
- **CheckID**: The check identifier (INFRA-021)
- **CheckName**: The check name (Preferred Bridgehead Servers)
- **Name**: Object name
