...
## Overview
This security check performs analysis for: **DNS Dynamic Updates**
...
## Description
This check queries Active Directory to identify objects related to DNS Dynamic Updates. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-013.exe csharp.cs
INFRA-013.exe
```
...
- **CheckID**: The check identifier (INFRA-013)
- **CheckName**: The check name (DNS Dynamic Updates)
- **Name**: Object name
