...
try {
    ...
    Write-Host "INFRA-013: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-013: Query failed — $_"
}
