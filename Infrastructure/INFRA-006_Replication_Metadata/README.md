# INFRA-006: Replication Metadata

## Overview
This security check performs analysis for: **Replication Metadata**
...
## Description
This check queries Active Directory to identify objects related to Replication Metadata. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-006.exe csharp.cs
INFRA-006.exe
```
...
- **CheckID**: The check identifier (INFRA-006)
- **CheckName**: The check name (Replication Metadata)
- **Name**: Object name
