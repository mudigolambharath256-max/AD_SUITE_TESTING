...
Write-Host "=== INFRA-006: Replication Metadata ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-006'}}, `
            @{N='CheckName'; E={'Replication Metadata'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'INFRA-006'
                CheckName         = 'Replication Metadata'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Replication_Metadata'
    ...
    $bhFile = Join-Path $bhDir "INFRA-006_$bhTs.json"
    @{
