...
## Overview
This security check performs analysis for: **DNS Aging Configuration**
...
## Description
This check queries Active Directory to identify objects related to DNS Aging Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-015.exe csharp.cs
INFRA-015.exe
```
...
- **CheckID**: The check identifier (INFRA-015)
- **CheckName**: The check name (DNS Aging Configuration)
- **Name**: Object name
