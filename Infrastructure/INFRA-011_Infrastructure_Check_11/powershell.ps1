...
try {
    ...
    Write-Host "INFRA-011: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-011: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-011: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-011: Query failed : $_"
}
