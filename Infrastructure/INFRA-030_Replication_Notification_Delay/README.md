# INFRA-030: Replication Notification Delay

## Overview
This security check performs analysis for: **Replication Notification Delay**
...
## Description
This check queries Active Directory to identify objects related to Replication Notification Delay. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-030.exe csharp.cs
INFRA-030.exe
```
...
- **CheckID**: The check identifier (INFRA-030)
- **CheckName**: The check name (Replication Notification Delay)
- **Name**: Object name
