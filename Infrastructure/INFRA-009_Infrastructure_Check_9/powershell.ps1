...
try {
    ...
    Write-Host "INFRA-009: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-009: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-009: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-009: Query failed : $_"
}
