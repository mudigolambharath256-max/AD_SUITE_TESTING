...
try {
    ...
    Write-Host "INFRA-028: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-028: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-028: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-028: Query failed : $_"
}
