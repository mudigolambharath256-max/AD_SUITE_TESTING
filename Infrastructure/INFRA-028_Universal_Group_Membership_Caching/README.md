# INFRA-028: Universal Group Membership Caching

## Overview
This security check performs analysis for: **Universal Group Membership Caching**
...
## Description
This check queries Active Directory to identify objects related to Universal Group Membership Caching. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-028.exe csharp.cs
INFRA-028.exe
```
...
- **CheckID**: The check identifier (INFRA-028)
- **CheckName**: The check name (Universal Group Membership Caching)
- **Name**: Object name
...
## Related Checks
This check is part of the **Infrastructure** category. Related checks:
