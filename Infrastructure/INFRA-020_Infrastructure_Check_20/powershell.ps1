...
try {
    ...
    Write-Host "INFRA-020: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-020: Query failed — $_"
}
