# INFRA-018: Time Server Configuration

## Overview
This security check performs analysis for: **Time Server Configuration**
...
## Description
This check queries Active Directory to identify objects related to Time Server Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-018.exe csharp.cs
INFRA-018.exe
```
...
- **CheckID**: The check identifier (INFRA-018)
- **CheckName**: The check name (Time Server Configuration)
- **Name**: Object name
