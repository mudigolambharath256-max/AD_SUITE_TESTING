...
try {
    ...
    Write-Host "INFRA-030: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-030: Query failed — $_"
}
