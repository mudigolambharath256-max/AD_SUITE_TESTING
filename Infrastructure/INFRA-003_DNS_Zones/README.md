...
## Overview
This security check performs analysis for: **DNS Zones**
...
## Description
This check queries Active Directory to identify objects related to DNS Zones. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-003.exe csharp.cs
INFRA-003.exe
```
...
- **CheckID**: The check identifier (INFRA-003)
- **CheckName**: The check name (DNS Zones)
- **Name**: Object name
