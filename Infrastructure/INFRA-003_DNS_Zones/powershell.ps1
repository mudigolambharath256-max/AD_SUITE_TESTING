...
Write-Host "Executing security check: DNS Zones" -ForegroundColor Yellow
Write-Host "Check ID: INFRA-003" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'INFRA-003'}}, `
    @{N='CheckName'; E={'DNS Zones'}}, `
...
try {
    ...
    $bhFile = Join-Path $bhDir "INFRA-003_$bhTs.json"
    @{
