...
try {
    ...
    Write-Host "INFRA-002: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-002: Query failed — $_"
}
