...
try {
    ...
    Write-Host "INFRA-006: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-006: Query failed — $_"
}
