...
Write-Host "=== INFRA-010: Inter Site Topology Generator ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-010'}}, `
            @{N='CheckName'; E={'Inter Site Topology Generator'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'INFRA-010'
                CheckName         = 'Inter Site Topology Generator'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Inter_Site_Topology_Generator'
    ...
    $bhFile = Join-Path $bhDir "INFRA-010_$bhTs.json"
    @{
