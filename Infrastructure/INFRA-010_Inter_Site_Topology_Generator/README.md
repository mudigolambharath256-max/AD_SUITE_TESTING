# INFRA-010: Inter Site Topology Generator

## Overview
This security check performs analysis for: **Inter Site Topology Generator**
...
## Description
This check queries Active Directory to identify objects related to Inter Site Topology Generator. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-010.exe csharp.cs
INFRA-010.exe
```
...
- **CheckID**: The check identifier (INFRA-010)
- **CheckName**: The check name (Inter Site Topology Generator)
- **Name**: Object name
