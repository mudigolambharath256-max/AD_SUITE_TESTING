...
try {
    ...
    Write-Host "INFRA-027: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-027: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-027: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-027: Query failed — $_"
}
