# INFRA-007: Site Links Configuration

## Overview
This security check performs analysis for: **Site Links Configuration**
...
## Description
This check queries Active Directory to identify objects related to Site Links Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-007.exe csharp.cs
INFRA-007.exe
```
...
- **CheckID**: The check identifier (INFRA-007)
- **CheckName**: The check name (Site Links Configuration)
- **Name**: Object name
