# INFRA-002: Subnets Configuration

## Overview
This security check performs analysis for: **Subnets Configuration**
...
## Description
This check queries Active Directory to identify objects related to Subnets Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-002.exe csharp.cs
INFRA-002.exe
```
...
- **CheckID**: The check identifier (INFRA-002)
- **CheckName**: The check name (Subnets Configuration)
- **Name**: Object name
