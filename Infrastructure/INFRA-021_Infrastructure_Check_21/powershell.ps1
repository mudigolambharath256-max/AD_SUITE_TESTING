...
try {
    ...
    Write-Host "INFRA-021: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-021: Query failed : $_"
}
