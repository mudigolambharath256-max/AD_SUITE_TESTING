...
try {
    ...
    Write-Host "INFRA-023: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-023: Query failed : $_"
}
