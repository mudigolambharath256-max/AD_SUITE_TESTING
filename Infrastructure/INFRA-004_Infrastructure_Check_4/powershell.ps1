...
try {
    ...
    Write-Host "INFRA-004: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-004: Query failed — $_"
}
