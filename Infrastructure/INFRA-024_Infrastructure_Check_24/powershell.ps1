...
try {
    ...
    Write-Host "INFRA-024: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-024: Query failed : $_"
}
