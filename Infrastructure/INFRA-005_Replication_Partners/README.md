# INFRA-005: Replication Partners

## Overview
This security check performs analysis for: **Replication Partners**
...
## Description
This check queries Active Directory to identify objects related to Replication Partners. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-005.exe csharp.cs
INFRA-005.exe
```
...
- **CheckID**: The check identifier (INFRA-005)
- **CheckName**: The check name (Replication Partners)
- **Name**: Object name
