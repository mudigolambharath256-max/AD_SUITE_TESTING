# INFRA-022: Site Coverage

## Overview
This security check performs analysis for: **Site Coverage**
...
## Description
This check queries Active Directory to identify objects related to Site Coverage. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-022.exe csharp.cs
INFRA-022.exe
```
...
- **CheckID**: The check identifier (INFRA-022)
- **CheckName**: The check name (Site Coverage)
- **Name**: Object name
