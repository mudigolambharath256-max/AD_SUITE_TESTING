...
Write-Host "=== INFRA-022: Site Coverage ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-022'}}, `
            @{N='CheckName'; E={'Site Coverage'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Site_Coverage'
    ...
    $bhFile = Join-Path $bhDir "INFRA-022_$bhTs.json"
    @{
