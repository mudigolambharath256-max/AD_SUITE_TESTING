...
try {
    ...
    Write-Host "INFRA-007: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-007: Query failed — $_"
}
