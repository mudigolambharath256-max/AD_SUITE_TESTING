# INFRA-016: DHCP Servers in AD

## Overview
This security check performs analysis for: **DHCP Servers in AD**
...
## Description
This check queries Active Directory to identify objects related to DHCP Servers in AD. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-016.exe csharp.cs
INFRA-016.exe
```
...
- **CheckID**: The check identifier (INFRA-016)
- **CheckName**: The check name (DHCP Servers in AD)
- **Name**: Object name
