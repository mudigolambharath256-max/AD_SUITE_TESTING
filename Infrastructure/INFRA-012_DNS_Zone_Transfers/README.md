...
## Overview
This security check performs analysis for: **DNS Zone Transfers**
...
## Description
This check queries Active Directory to identify objects related to DNS Zone Transfers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-012.exe csharp.cs
INFRA-012.exe
```
...
- **CheckID**: The check identifier (INFRA-012)
- **CheckName**: The check name (DNS Zone Transfers)
- **Name**: Object name
