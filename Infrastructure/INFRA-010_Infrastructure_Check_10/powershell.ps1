...
try {
    ...
    Write-Host "INFRA-010: found $($found.Count) objects"
    ...
    Write-Warning "INFRA-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "INFRA-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "INFRA-010: Query failed — $_"
}
