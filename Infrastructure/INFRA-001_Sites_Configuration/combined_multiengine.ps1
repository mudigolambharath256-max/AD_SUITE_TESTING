...
Write-Host "=== INFRA-001: Sites Configuration ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-001'}}, `
            @{N='CheckName'; E={'Sites Configuration'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Sites_Configuration'
    ...
    $bhFile = Join-Path $bhDir "INFRA-001_$bhTs.json"
    @{
