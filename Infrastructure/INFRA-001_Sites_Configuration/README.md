# INFRA-001: Sites Configuration

## Overview
This security check performs analysis for: **Sites Configuration**
...
## Description
This check queries Active Directory to identify objects related to Sites Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-001.exe csharp.cs
INFRA-001.exe
```
...
- **CheckID**: The check identifier (INFRA-001)
- **CheckName**: The check name (Sites Configuration)
- **Name**: Object name
