...
Write-Host "Executing: Stale DNS Records" -ForegroundColor Cyan
Write-Host "Check ID: INFRA-033" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'INFRA-033'}}, `
    @{N='CheckName'; E={'Stale DNS Records'}}, `
    @{N='RiskScore'; E={4}}, `
    @{N='Severity'; E={'LOW'}}, `
    @{N='MITRE'; E={'T1584.002'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'INFRA-033'
                adSuiteCheckName  = 'Stale_DNS_Records'
    ...
    $bhFile = Join-Path $bhDir "INFRA-033_$bhTs.json"
    @{
