...
Write-Host "=== INFRA-020: Bridgehead Servers ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'INFRA-020'}}, `
            @{N='CheckName'; E={'Bridgehead Servers'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Bridgehead_Servers'
    ...
    $bhFile = Join-Path $bhDir "INFRA-020_$bhTs.json"
    @{
