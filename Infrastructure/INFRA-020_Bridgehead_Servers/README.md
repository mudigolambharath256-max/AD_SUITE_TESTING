# INFRA-020: Bridgehead Servers

## Overview
This security check performs analysis for: **Bridgehead Servers**
...
## Description
This check queries Active Directory to identify objects related to Bridgehead Servers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-020.exe csharp.cs
INFRA-020.exe
```
...
- **CheckID**: The check identifier (INFRA-020)
- **CheckName**: The check name (Bridgehead Servers)
- **Name**: Object name
