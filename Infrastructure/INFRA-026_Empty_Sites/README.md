# INFRA-026: Empty Sites

## Overview
This security check performs analysis for: **Empty Sites**
...
## Description
This check queries Active Directory to identify objects related to Empty Sites. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-026.exe csharp.cs
INFRA-026.exe
```
...
- **CheckID**: The check identifier (INFRA-026)
- **CheckName**: The check name (Empty Sites)
- **Name**: Object name
