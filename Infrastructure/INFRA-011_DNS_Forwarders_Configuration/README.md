...
## Overview
This security check performs analysis for: **DNS Forwarders Configuration**
...
## Description
This check queries Active Directory to identify objects related to DNS Forwarders Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-011.exe csharp.cs
INFRA-011.exe
```
...
- **CheckID**: The check identifier (INFRA-011)
- **CheckName**: The check name (DNS Forwarders Configuration)
- **Name**: Object name
