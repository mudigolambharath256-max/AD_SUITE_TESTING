# INFRA-019: PDC Emulator Time Source

## Overview
This security check performs analysis for: **PDC Emulator Time Source**
...
## Description
This check queries Active Directory to identify objects related to PDC Emulator Time Source. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-019.exe csharp.cs
INFRA-019.exe
```
...
- **CheckID**: The check identifier (INFRA-019)
- **CheckName**: The check name (PDC Emulator Time Source)
- **Name**: Object name
