# INFRA-009: Connection Objects

## Overview
This security check performs analysis for: **Connection Objects**
...
## Description
This check queries Active Directory to identify objects related to Connection Objects. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-009.exe csharp.cs
INFRA-009.exe
```
...
- **CheckID**: The check identifier (INFRA-009)
- **CheckName**: The check name (Connection Objects)
- **Name**: Object name
