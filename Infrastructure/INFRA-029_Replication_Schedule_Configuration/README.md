# INFRA-029: Replication Schedule Configuration

## Overview
This security check performs analysis for: **Replication Schedule Configuration**
...
## Description
This check queries Active Directory to identify objects related to Replication Schedule Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:INFRA-029.exe csharp.cs
INFRA-029.exe
```
...
- **CheckID**: The check identifier (INFRA-029)
- **CheckName**: The check name (Replication Schedule Configuration)
- **Name**: Object name
