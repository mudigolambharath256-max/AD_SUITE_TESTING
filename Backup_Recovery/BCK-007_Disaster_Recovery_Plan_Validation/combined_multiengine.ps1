# ============================================================================
# BCK-007: Disaster Recovery Plan Validation - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[BCK-007] Disaster Recovery Plan Validation" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'BCK-007'
                adSuiteCheckName  = 'Disaster_Recovery_Plan_Validation'
    ...
    $bhFile = Join-Path $bhDir "BCK-007_$bhTs.json"
    @{
