...
try {
    ...
    Write-Host "BCK-005: found $($found.Count) objects"
    ...
    Write-Warning "BCK-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-005: Query failed — $_"
}
