...
try {
    ...
    Write-Host "BCK-008: found $($found.Count) objects"
    ...
    Write-Warning "BCK-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-008: Query failed — $_"
}
