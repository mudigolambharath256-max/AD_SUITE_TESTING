# ============================================================================
# BCK-006: Backup Retention Policy - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[BCK-006] Backup Retention Policy" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'BCK-006'
                adSuiteCheckName  = 'Backup_Retention_Policy'
    ...
    $bhFile = Join-Path $bhDir "BCK-006_$bhTs.json"
    @{
