...
try {
    ...
    Write-Host "BCK-004: found $($found.Count) objects"
    ...
    Write-Warning "BCK-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-004: Query failed : $_"
}
