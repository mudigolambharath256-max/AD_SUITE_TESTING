# ============================================================================
# BCK-004: Deleted Object Recovery Capability
# ============================================================================
# Version: 3.0.0
...
Write-Host "Severity: MEDIUM | Risk: 5/10 | MITRE: T1490" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=domain)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'BCK-004'}}, `
    @{N='CheckName'; E={'Deleted Object Recovery Capability'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1490'}}, `
