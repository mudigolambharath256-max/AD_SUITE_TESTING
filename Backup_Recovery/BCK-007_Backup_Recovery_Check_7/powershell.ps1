...
try {
    ...
    Write-Host "BCK-007: found $($found.Count) objects"
    ...
    Write-Warning "BCK-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-007: Query failed — $_"
}
