...
try {
    ...
    Write-Host "BCK-002: found $($found.Count) objects"
    ...
    Write-Warning "BCK-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-002: Query failed — $_"
}
