...
try {
    ...
    Write-Host "BCK-001: found $($found.Count) objects"
    ...
    Write-Warning "BCK-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-001: Query failed — $_"
}
