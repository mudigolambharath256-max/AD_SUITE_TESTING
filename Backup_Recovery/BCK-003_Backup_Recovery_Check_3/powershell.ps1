...
try {
    ...
    Write-Host "BCK-003: found $($found.Count) objects"
    ...
    Write-Warning "BCK-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-003: Query failed : $_"
}
