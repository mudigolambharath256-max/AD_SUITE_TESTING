...
try {
    ...
    Write-Host "BCK-006: found $($found.Count) objects"
    ...
    Write-Warning "BCK-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "BCK-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "BCK-006: Query failed : $_"
}
