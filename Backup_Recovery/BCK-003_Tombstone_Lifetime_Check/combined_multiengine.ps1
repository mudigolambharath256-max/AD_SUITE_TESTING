# ============================================================================
# BCK-003: Tombstone Lifetime Check - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[BCK-003] Tombstone Lifetime Check" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'BCK-003'
                adSuiteCheckName  = 'Tombstone_Lifetime_Check'
    ...
    $bhFile = Join-Path $bhDir "BCK-003_$bhTs.json"
    @{
