...
try {
    ...
    Write-Host "PRV-049: found $($found.Count) objects"
    ...
    Write-Warning "PRV-049: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-049: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-049: Query failed — $_"
}
