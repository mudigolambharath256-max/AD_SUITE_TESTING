...
# Check: Privileged Access Check 28
...
Write-Host "=== Privileged Access Check 28 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-028 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-028 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-028 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-028: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-028_results.csv"
$uniqueResults |
