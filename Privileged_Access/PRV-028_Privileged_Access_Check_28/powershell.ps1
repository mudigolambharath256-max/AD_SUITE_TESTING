...
try {
    ...
    Write-Host "PRV-028: found $($found.Count) objects"
    ...
    Write-Warning "PRV-028: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-028: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-028: Query failed : $_"
}
