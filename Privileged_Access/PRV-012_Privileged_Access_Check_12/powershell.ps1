...
try {
    ...
    Write-Host "PRV-012: found $($found.Count) objects"
    ...
    Write-Warning "PRV-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-012: Query failed : $_"
}
