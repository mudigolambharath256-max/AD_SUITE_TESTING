...
# Check: Privileged Access Check 12
...
Write-Host "=== Privileged Access Check 12 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-012 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-012 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-012 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-012: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-012_results.csv"
$uniqueResults |
