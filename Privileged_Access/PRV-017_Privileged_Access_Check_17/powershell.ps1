...
try {
    ...
    Write-Host "PRV-017: found $($found.Count) objects"
    ...
    Write-Warning "PRV-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-017: Query failed — $_"
}
