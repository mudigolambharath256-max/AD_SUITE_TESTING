...
try {
    ...
    Write-Host "PRV-035: found $($found.Count) objects"
    ...
    Write-Warning "PRV-035: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-035: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-035: Query failed — $_"
}
