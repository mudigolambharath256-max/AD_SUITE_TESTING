...
try {
    ...
    Write-Host "PRV-011: found $($found.Count) objects"
    ...
    Write-Warning "PRV-011: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-011: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-011: Query failed : $_"
}
