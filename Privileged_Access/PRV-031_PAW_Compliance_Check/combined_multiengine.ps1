...
Write-Host "=== PRV-031: PAW Compliance Check ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PRV-031'
                adSuiteCheckName  = 'PAW_Compliance_Check'
    ...
    $bhFile = Join-Path $bhDir "PRV-031_$bhTs.json"
    @{
