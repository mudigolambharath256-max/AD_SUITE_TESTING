...
(@('name', 'distinguishedName', 'samAccountName', 'adminCount', 'memberOf', 'pwdLastSet', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PRV-015_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Privileged Users (adminCount=1)
# Category: Privileged Access
# Severity: high
# ID: PRV-015
# Requirements: None
