...
try {
    ...
    Write-Host "PRV-041: found $($found.Count) objects"
    ...
    Write-Warning "PRV-041: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-041: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-041: Query failed — $_"
}
