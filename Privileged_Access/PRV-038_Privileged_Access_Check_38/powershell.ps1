...
try {
    ...
    Write-Host "PRV-038: found $($found.Count) objects"
    ...
    Write-Warning "PRV-038: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-038: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-038: Query failed — $_"
}
