...
try {
    ...
    Write-Host "PRV-047: found $($found.Count) objects"
    ...
    Write-Warning "PRV-047: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-047: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-047: Query failed : $_"
}
