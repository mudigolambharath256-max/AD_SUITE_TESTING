...
Write-Host "Executing: Admin Logons from Non PAW" -ForegroundColor Cyan
Write-Host "Check ID: PRV-032" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PRV-032'}}, `
    @{N='CheckName'; E={'Admin Logons from Non PAW'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1078.002'}}, `
