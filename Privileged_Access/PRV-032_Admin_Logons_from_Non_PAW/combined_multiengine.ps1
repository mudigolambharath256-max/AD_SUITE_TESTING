...
Write-Host "=== PRV-032: Admin Logons from Non PAW ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PRV-032'
                adSuiteCheckName  = 'Admin_Logons_from_Non_PAW'
    ...
    $bhFile = Join-Path $bhDir "PRV-032_$bhTs.json"
    @{
