...
try {
    ...
    Write-Host "PRV-022: found $($found.Count) objects"
    ...
    Write-Warning "PRV-022: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-022: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-022: Query failed : $_"
}
