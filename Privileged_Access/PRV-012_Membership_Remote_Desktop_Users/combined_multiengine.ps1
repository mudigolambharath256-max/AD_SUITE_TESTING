...
Write-Host "=== Multi-Engine Execution: Membership: Remote Desktop Users ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $psResults = @(
        ...
        $ldapFilter = '(&(objectCategory=group)(cn=Remote Desktop Users))'
...
public class Program
{
  ...
  {
    string filter = @"(&(objectCategory=group)(cn=Remote Desktop Users))";
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PRV-012'
                adSuiteCheckName  = 'Membership_Remote_Desktop_Users'
    ...
    $bhFile = Join-Path $bhDir "PRV-012_$bhTs.json"
    @{
