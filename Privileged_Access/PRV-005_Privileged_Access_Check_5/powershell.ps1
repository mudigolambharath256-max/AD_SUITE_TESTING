...
try {
    ...
    Write-Host "PRV-005: found $($found.Count) objects"
    ...
    Write-Warning "PRV-005: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-005: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-005: Query failed : $_"
}
