...
try {
    ...
    Write-Host "PRV-046: found $($found.Count) objects"
    ...
    Write-Warning "PRV-046: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-046: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-046: Query failed — $_"
}
