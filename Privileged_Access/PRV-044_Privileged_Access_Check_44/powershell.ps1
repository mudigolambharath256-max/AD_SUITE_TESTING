...
try {
    ...
    Write-Host "PRV-044: found $($found.Count) objects"
    ...
    Write-Warning "PRV-044: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-044: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-044: Query failed : $_"
}
