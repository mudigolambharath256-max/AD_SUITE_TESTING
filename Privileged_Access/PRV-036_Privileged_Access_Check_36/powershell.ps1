...
try {
    ...
    Write-Host "PRV-036: found $($found.Count) objects"
    ...
    Write-Warning "PRV-036: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-036: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-036: Query failed : $_"
}
