...
try {
    ...
    Write-Host "PRV-026: found $($found.Count) objects"
    ...
    Write-Warning "PRV-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-026: Query failed : $_"
}
