...
# Check: Privileged Access Check 50
...
Write-Host "=== Privileged Access Check 50 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-050 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-050 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-050 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-050: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-050_results.csv"
$uniqueResults |
