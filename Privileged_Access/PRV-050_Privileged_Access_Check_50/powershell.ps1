...
try {
    ...
    Write-Host "PRV-050: found $($found.Count) objects"
    ...
    Write-Warning "PRV-050: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-050: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-050: Query failed : $_"
}
