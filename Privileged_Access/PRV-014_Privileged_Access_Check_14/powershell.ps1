...
try {
    ...
    Write-Host "PRV-014: found $($found.Count) objects"
    ...
    Write-Warning "PRV-014: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-014: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-014: Query failed : $_"
}
