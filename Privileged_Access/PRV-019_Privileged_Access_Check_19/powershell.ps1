...
try {
    ...
    Write-Host "PRV-019: found $($found.Count) objects"
    ...
    Write-Warning "PRV-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-019: Query failed : $_"
}
