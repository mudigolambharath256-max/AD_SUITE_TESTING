...
try {
    ...
    Write-Host "PRV-048: found $($found.Count) objects"
    ...
    Write-Warning "PRV-048: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-048: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-048: Query failed : $_"
}
