...
try {
    ...
    Write-Host "PRV-024: found $($found.Count) objects"
    ...
    Write-Warning "PRV-024: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-024: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-024: Query failed — $_"
}
