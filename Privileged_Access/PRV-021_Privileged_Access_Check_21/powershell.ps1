...
try {
    ...
    Write-Host "PRV-021: found $($found.Count) objects"
    ...
    Write-Warning "PRV-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-021: Query failed : $_"
}
