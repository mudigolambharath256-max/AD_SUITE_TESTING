...
try {
    ...
    Write-Host "PRV-032: found $($found.Count) objects"
    ...
    Write-Warning "PRV-032: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-032: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-032: Query failed — $_"
}
