...
try {
    ...
    Write-Host "PRV-029: found $($found.Count) objects"
    ...
    Write-Warning "PRV-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-029: Query failed — $_"
}
