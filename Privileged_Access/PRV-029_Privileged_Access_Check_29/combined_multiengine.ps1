...
# Check: Privileged Access Check 29
...
Write-Host "=== Privileged Access Check 29 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-029 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-029 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-029 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-029: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-029_results.csv"
$uniqueResults |
