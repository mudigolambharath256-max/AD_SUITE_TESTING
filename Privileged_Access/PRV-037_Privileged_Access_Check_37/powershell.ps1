...
try {
    ...
    Write-Host "PRV-037: found $($found.Count) objects"
    ...
    Write-Warning "PRV-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-037: Query failed : $_"
}
