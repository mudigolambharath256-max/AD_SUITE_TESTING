...
try {
    ...
    Write-Host "PRV-033: found $($found.Count) objects"
    ...
    Write-Warning "PRV-033: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-033: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-033: Query failed : $_"
}
