...
try {
    ...
    Write-Host "PRV-002: found $($found.Count) objects"
    ...
    Write-Warning "PRV-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-002: Query failed — $_"
}
