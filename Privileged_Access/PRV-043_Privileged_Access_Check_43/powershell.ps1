...
try {
    ...
    Write-Host "PRV-043: found $($found.Count) objects"
    ...
    Write-Warning "PRV-043: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-043: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-043: Query failed — $_"
}
