...
try {
    ...
    Write-Host "PRV-023: found $($found.Count) objects"
    ...
    Write-Warning "PRV-023: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-023: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-023: Query failed — $_"
}
