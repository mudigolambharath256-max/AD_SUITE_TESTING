...
try {
    ...
    Write-Host "PRV-008: found $($found.Count) objects"
    ...
    Write-Warning "PRV-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-008: Query failed — $_"
}
