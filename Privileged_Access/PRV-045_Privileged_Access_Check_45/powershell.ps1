...
try {
    ...
    Write-Host "PRV-045: found $($found.Count) objects"
    ...
    Write-Warning "PRV-045: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-045: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-045: Query failed — $_"
}
