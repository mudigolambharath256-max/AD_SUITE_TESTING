...
Write-Host "=== Multi-Engine Execution: Membership: Group Policy Creator Owners ===" -ForegroundColor Cyan
Write-Host ""
...
public class Program
{
  ...
  {
    string filter = @"(&(objectCategory=group)(cn=Group Policy Creator Owners))";
