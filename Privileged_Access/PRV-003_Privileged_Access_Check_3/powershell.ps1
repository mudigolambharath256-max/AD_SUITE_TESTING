...
try {
    ...
    Write-Host "PRV-003: found $($found.Count) objects"
    ...
    Write-Warning "PRV-003: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-003: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-003: Query failed — $_"
}
