...
try {
    ...
    Write-Host "PRV-027: found $($found.Count) objects"
    ...
    Write-Warning "PRV-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-027: Query failed : $_"
}
