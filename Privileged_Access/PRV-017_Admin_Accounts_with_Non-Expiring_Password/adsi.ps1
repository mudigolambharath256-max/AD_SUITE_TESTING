...
(@('name', 'distinguishedName', 'samAccountName', 'userAccountControl', 'pwdLastSet', 'adminCount', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PRV-017_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Admin Accounts with Non-Expiring Password
# Category: Privileged Access
# Severity: critical
# ID: PRV-017
# Requirements: None
