...
try {
    ...
    Write-Host "PRV-025: found $($found.Count) objects"
    ...
    Write-Warning "PRV-025: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-025: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-025: Query failed — $_"
}
