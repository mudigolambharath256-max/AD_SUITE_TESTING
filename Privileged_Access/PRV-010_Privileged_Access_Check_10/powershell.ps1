...
try {
    ...
    Write-Host "PRV-010: found $($found.Count) objects"
    ...
    Write-Warning "PRV-010: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-010: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-010: Query failed : $_"
}
