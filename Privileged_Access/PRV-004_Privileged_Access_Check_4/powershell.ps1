...
try {
    ...
    Write-Host "PRV-004: found $($found.Count) objects"
    ...
    Write-Warning "PRV-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-004: Query failed : $_"
}
