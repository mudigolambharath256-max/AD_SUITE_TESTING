...
@('name', 'distinguishedName', 'cn', 'nTSecurityDescriptor', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PRV-026_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: AdminSDHolder Object
# Category: Privileged Access
# Severity: info
# ID: PRV-026
# Requirements: None
