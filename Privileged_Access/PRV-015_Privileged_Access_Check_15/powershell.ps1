...
try {
    ...
    Write-Host "PRV-015: found $($found.Count) objects"
    ...
    Write-Warning "PRV-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-015: Query failed — $_"
}
