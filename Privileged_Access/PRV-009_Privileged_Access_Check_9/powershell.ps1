...
try {
    ...
    Write-Host "PRV-009: found $($found.Count) objects"
    ...
    Write-Warning "PRV-009: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-009: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-009: Query failed : $_"
}
