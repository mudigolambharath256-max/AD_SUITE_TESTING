...
# Check: Privileged Access Check 9
...
Write-Host "=== Privileged Access Check 9 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-009 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-009 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-009 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-009: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-009_results.csv"
$uniqueResults |
