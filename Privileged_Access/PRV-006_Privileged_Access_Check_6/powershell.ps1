...
try {
    ...
    Write-Host "PRV-006: found $($found.Count) objects"
    ...
    Write-Warning "PRV-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-006: Query failed : $_"
}
