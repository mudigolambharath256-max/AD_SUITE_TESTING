...
(@('name', 'distinguishedName', 'samAccountName', 'servicePrincipalName', 'pwdLastSet', 'adminCount', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PRV-018_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Admin Accounts with SPNs (Kerberoasting Risk)
# Category: Privileged Access
# Severity: critical
# ID: PRV-018
# Requirements: None
