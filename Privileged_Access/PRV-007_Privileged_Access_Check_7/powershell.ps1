...
try {
    ...
    Write-Host "PRV-007: found $($found.Count) objects"
    ...
    Write-Warning "PRV-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-007: Query failed — $_"
}
