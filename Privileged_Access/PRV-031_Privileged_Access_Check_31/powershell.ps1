...
try {
    ...
    Write-Host "PRV-031: found $($found.Count) objects"
    ...
    Write-Warning "PRV-031: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-031: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-031: Query failed : $_"
}
