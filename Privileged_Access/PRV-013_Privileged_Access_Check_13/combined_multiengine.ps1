...
# Check: Privileged Access Check 13
...
Write-Host "=== Privileged Access Check 13 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-013 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-013 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-013 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-013: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-013_results.csv"
$uniqueResults |
