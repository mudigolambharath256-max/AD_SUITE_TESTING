...
try {
    ...
    Write-Host "PRV-013: found $($found.Count) objects"
    ...
    Write-Warning "PRV-013: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-013: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-013: Query failed : $_"
}
