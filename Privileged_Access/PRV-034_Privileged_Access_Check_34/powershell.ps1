...
try {
    ...
    Write-Host "PRV-034: found $($found.Count) objects"
    ...
    Write-Warning "PRV-034: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-034: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-034: Query failed : $_"
}
