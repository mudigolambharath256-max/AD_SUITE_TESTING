...
try {
    ...
    Write-Host "PRV-020: found $($found.Count) objects"
    ...
    Write-Warning "PRV-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-020: Query failed — $_"
}
