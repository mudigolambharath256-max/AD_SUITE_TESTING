...
try {
    ...
    Write-Host "PRV-030: found $($found.Count) objects"
    ...
    Write-Warning "PRV-030: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-030: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-030: Query failed : $_"
}
