...
@('name', 'distinguishedName', 'samAccountName', 'adminCount', 'operatingSystem', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PRV-016_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Privileged Computers (adminCount=1)
# Category: Privileged Access
# Severity: high
# ID: PRV-016
# Requirements: None
