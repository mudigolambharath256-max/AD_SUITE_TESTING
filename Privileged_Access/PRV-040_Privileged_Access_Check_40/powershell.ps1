...
try {
    ...
    Write-Host "PRV-040: found $($found.Count) objects"
    ...
    Write-Warning "PRV-040: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-040: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-040: Query failed — $_"
}
