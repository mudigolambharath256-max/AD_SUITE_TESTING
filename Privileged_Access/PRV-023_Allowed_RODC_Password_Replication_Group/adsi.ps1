...
@('name', 'distinguishedName', 'cn', 'member', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PRV-023_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Allowed RODC Password Replication Group
# Category: Privileged Access
# Severity: medium
# ID: PRV-023
# Requirements: None
