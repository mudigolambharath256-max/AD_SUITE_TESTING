...
try {
    ...
    Write-Host "PRV-016: found $($found.Count) objects"
    ...
    Write-Warning "PRV-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-016: Query failed — $_"
}
