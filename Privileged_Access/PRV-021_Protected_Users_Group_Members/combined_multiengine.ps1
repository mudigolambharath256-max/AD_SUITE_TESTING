...
try {
    ...
    $psResults = @(
        ...
        $ldapFilter = '(&(objectCategory=group)(cn=Protected Users))'
...
public class Program
{
  ...
  {
    string filter = @"(&(objectCategory=group)(cn=Protected Users))";
...
try {
    ...
    $bhFile = Join-Path $bhDir "PRV-021_$bhTs.json"
    @{
