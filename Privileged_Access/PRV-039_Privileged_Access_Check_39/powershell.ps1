...
try {
    ...
    Write-Host "PRV-039: found $($found.Count) objects"
    ...
    Write-Warning "PRV-039: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "PRV-039: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "PRV-039: Query failed : $_"
}
