...
# Check: Privileged Access Check 39
...
Write-Host "=== Privileged Access Check 39 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "PRV-039 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "PRV-039 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "PRV-039 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== PRV-039: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "PRV-039_results.csv"
$uniqueResults |
