...
try {
    ...
    Write-Host "ADV-001: found $($found.Count) objects"
    ...
    Write-Warning "ADV-001: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-001: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-001: Query failed : $_"
}
