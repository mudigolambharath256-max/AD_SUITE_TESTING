...
try {
    ...
    Write-Host "ADV-010: found $($found.Count) objects"
    ...
    Write-Warning "ADV-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-010: Query failed — $_"
}
