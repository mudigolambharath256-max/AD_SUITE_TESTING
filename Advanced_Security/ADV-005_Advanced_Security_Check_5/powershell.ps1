...
try {
    ...
    Write-Host "ADV-005: found $($found.Count) objects"
    ...
    Write-Warning "ADV-005: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-005: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-005: Query failed : $_"
}
