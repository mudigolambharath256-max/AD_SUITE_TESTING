...
try {
    ...
    Write-Host "ADV-008: found $($found.Count) objects"
    ...
    Write-Warning "ADV-008: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-008: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-008: Query failed : $_"
}
