...
Write-Host "Severity: CRITICAL | Risk: 9/10 | MITRE: T1649" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=pKIEnrollmentService)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ADV-009'}}, `
    @{N='CheckName'; E={'ADCS Web Enrollment Vulnerabilities'}}, `
    @{N='RiskScore'; E={9}}, `
