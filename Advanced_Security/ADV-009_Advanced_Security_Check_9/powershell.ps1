...
try {
    ...
    Write-Host "ADV-009: found $($found.Count) objects"
    ...
    Write-Warning "ADV-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-009: Query failed — $_"
}
