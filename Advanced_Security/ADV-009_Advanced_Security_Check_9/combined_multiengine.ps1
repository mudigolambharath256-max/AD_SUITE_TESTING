...
# Check: Advanced Security Check 9
...
Write-Host "=== Advanced Security Check 9 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ADV-009 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "ADV-009 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "ADV-009 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== ADV-009: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "ADV-009_results.csv"
$uniqueResults |
