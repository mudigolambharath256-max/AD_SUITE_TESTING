...
try {
    ...
    Write-Host "ADV-004: found $($found.Count) objects"
    ...
    Write-Warning "ADV-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-004: Query failed — $_"
}
