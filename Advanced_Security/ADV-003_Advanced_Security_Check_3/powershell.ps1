...
try {
    ...
    Write-Host "ADV-003: found $($found.Count) objects"
    ...
    Write-Warning "ADV-003: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-003: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-003: Query failed — $_"
}
