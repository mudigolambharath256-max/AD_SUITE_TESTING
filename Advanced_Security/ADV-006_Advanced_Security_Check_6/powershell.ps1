...
try {
    ...
    Write-Host "ADV-006: found $($found.Count) objects"
    ...
    Write-Warning "ADV-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ADV-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ADV-006: Query failed — $_"
}
