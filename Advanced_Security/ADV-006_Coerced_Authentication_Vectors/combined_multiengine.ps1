# ============================================================================
# ADV-006: Coerced Authentication Vectors - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[ADV-006] Coerced Authentication Vectors" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'ADV-006'
                adSuiteCheckName  = 'Coerced_Authentication_Vectors'
    ...
    $bhFile = Join-Path $bhDir "ADV-006_$bhTs.json"
    @{
