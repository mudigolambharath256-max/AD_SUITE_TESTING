...
# Check: Advanced Security Check 2
...
Write-Host "=== Advanced Security Check 2 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ADV-002 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "ADV-002 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "ADV-002 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== ADV-002: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "ADV-002_results.csv"
$uniqueResults |
