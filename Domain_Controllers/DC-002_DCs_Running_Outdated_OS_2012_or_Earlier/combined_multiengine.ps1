...
Write-Host "=== Multi-Engine Execution: DCs Running Outdated OS (2012 or Earlier) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $psResults = @(
        ...
        $ldapFilter = '(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=8192)(|(operatingSystem=*2003*)(operatingSystem=*2008*)(operatingSystem=*2012*)))'
...
try {
    $adsiResults = @(
        ...
        $searcher = [ADSISearcher]'(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=8192)(|(operatingSystem=*2003*)(operatingSystem=*2008*)(operatingSystem=*2012*)))'
        ...
        $searcher.FindAll() | ForEach-Object {
          $p = $_.Properties
          [PSCustomObject]@{
            Label = 'DCs Running Outdated OS (2012 or Earlier)'
            Name = $p['name'][0]
...
class DC004
{
  ...
  {
    string filter = @"(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=8192)(|(operatingSystem=*2003*)(operatingSystem=*2008*)(operatingSystem=*2012*)))";
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'DC-002'
                adSuiteCheckName  = 'DCs_Running_Outdated_OS_2012_or_Earlier'
    ...
    $bhFile = Join-Path $bhDir "DC-002_$bhTs.json"
    @{
