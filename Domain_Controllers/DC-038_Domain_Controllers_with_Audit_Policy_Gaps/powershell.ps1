...
Write-Host "Executing: Domain Controllers with Audit Policy Gaps" -ForegroundColor Cyan
Write-Host "Check ID: DC-038" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'DC-038'}}, `
    @{N='CheckName'; E={'Domain Controllers with Audit Policy Gaps'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1562.002'}}, `
