...
Write-Host "=== Multi-Engine Execution: FRS SYSVOL (Deprecated) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $psResults = @(
        ...
        $searchBase = $systemNC
        $ldapFilter = '(&(objectClass=nTFRSReplicaSet)(cn=Domain System Volume*))'
...
public class DC023Checker
{
  public static void Run()
  {
    string filter = @"(&(objectClass=nTFRSReplicaSet)(cn=Domain System Volume*))";
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'FRS_SYSVOL_Deprecated'
