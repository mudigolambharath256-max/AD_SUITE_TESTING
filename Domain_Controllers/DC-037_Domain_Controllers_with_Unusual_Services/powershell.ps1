...
Write-Host "Executing: Domain Controllers with Unusual Services" -ForegroundColor Cyan
Write-Host "Check ID: DC-037" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'DC-037'}}, `
    @{N='CheckName'; E={'Domain Controllers with Unusual Services'}}, `
    @{N='RiskScore'; E={8}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1543.003'}}, `
