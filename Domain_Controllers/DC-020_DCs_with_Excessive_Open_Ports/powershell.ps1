...
try {
    ...
    foreach ($dc in $dcs) {
        ...
        try {
            # TODO: Implement specific check logic for DC-044
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'DC-020'
                adSuiteCheckName  = 'DCs_with_Excessive_Open_Ports'
    ...
    $bhFile = Join-Path $bhDir "DC-020_$bhTs.json"
    @{
