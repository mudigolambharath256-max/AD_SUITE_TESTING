...
Write-Host "Found $($results.Count) objects for check: Certificate Template Authorized Signatures" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PKI-017_nodes.json"
