...
## Overview
This security check performs analysis for: **Certificate Template Authorized Signatures**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Authorized Signatures. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-017)
- **CheckName**: The check name (Certificate Template Authorized Signatures)
- **Name**: Object name
