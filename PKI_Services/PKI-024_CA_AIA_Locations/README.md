...
## Overview
This security check performs analysis for: **CA AIA Locations**
...
## Description
This check queries Active Directory to identify objects related to CA AIA Locations. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-024)
- **CheckName**: The check name (CA AIA Locations)
- **Name**: Object name
