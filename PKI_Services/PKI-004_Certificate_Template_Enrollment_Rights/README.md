...
## Overview
This security check performs analysis for: **Certificate Template Enrollment Rights**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Enrollment Rights. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-004)
- **CheckName**: The check name (Certificate Template Enrollment Rights)
- **Name**: Object name
