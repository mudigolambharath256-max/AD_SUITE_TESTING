...
## Overview
This security check performs analysis for: **Certificate Template Subject Name**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Subject Name. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-006)
- **CheckName**: The check name (Certificate Template Subject Name)
- **Name**: Object name
