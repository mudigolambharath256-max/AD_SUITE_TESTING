...
## Overview
This security check performs analysis for: **AD-Integrated Certificate Authorities**
...
## Description
This check queries Active Directory to identify objects related to AD-Integrated Certificate Authorities. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-001)
- **CheckName**: The check name (AD-Integrated Certificate Authorities)
- **Name**: Object name
