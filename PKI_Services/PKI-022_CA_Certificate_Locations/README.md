...
## Overview
This security check performs analysis for: **CA Certificate Locations**
...
## Description
This check queries Active Directory to identify objects related to CA Certificate Locations. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-022)
- **CheckName**: The check name (CA Certificate Locations)
- **Name**: Object name
