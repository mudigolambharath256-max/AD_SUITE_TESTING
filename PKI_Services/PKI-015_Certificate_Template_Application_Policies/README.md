...
## Overview
This security check performs analysis for: **Certificate Template Application Policies**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Application Policies. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-015)
- **CheckName**: The check name (Certificate Template Application Policies)
- **Name**: Object name
