...
Write-Host "Found $($results.Count) objects for check: Certificate Template Application Policies" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PKI-015_nodes.json"
