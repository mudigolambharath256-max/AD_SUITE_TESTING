...
## Overview
This security check performs analysis for: **Certificate Template Key Size**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Key Size. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-011)
- **CheckName**: The check name (Certificate Template Key Size)
- **Name**: Object name
