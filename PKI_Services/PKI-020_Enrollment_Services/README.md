...
## Overview
This security check performs analysis for: **Enrollment Services**
...
## Description
This check queries Active Directory to identify objects related to Enrollment Services. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-020)
- **CheckName**: The check name (Enrollment Services)
- **Name**: Object name
