...
## Overview
This security check performs analysis for: **CA Certificate Managers**
...
## Description
This check queries Active Directory to identify objects related to CA Certificate Managers. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-027)
- **CheckName**: The check name (CA Certificate Managers)
- **Name**: Object name
