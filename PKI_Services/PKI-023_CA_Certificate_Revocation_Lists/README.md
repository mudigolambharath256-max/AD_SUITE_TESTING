# PKI-023: CA Certificate Revocation Lists

## Overview
This security check performs analysis for: **CA Certificate Revocation Lists**
...
## Description
This check queries Active Directory to identify objects related to CA Certificate Revocation Lists. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-023)
- **CheckName**: The check name (CA Certificate Revocation Lists)
- **Name**: Object name
