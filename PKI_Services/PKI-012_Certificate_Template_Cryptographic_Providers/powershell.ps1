...
Write-Host "Executing security check: Certificate Template Cryptographic Providers" -ForegroundColor Yellow
Write-Host "Check ID: PKI-012" -ForegroundColor Gray
