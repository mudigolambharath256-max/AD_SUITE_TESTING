...
Write-Host "Found $($results.Count) objects for check: Certificate Template Cryptographic Providers" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PKI-012_nodes.json"
