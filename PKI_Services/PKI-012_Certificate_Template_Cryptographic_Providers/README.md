...
## Overview
This security check performs analysis for: **Certificate Template Cryptographic Providers**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Cryptographic Providers. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-012)
- **CheckName**: The check name (Certificate Template Cryptographic Providers)
- **Name**: Object name
...
## Related Checks
This check is part of the **PKI_Services** category. Related checks:
