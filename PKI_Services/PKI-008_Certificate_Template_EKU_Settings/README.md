...
## Overview
This security check performs analysis for: **Certificate Template EKU Settings**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template EKU Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-008)
- **CheckName**: The check name (Certificate Template EKU Settings)
- **Name**: Object name
