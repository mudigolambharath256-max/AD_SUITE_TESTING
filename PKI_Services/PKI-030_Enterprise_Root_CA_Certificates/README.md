...
## Overview
This security check performs analysis for: **Enterprise Root CA Certificates**
...
## Description
This check queries Active Directory to identify objects related to Enterprise Root CA Certificates. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-030)
- **CheckName**: The check name (Enterprise Root CA Certificates)
- **Name**: Object name
