...
## Overview
This security check performs analysis for: **Certificate Template Private Key Archival**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Private Key Archival. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-018)
- **CheckName**: The check name (Certificate Template Private Key Archival)
- **Name**: Object name
