...
Write-Host "Found $($results.Count) objects for check: Certificate Template Private Key Archival" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PKI-018_nodes.json"
