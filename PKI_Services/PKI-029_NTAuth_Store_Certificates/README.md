...
## Overview
This security check performs analysis for: **NTAuth Store Certificates**
...
## Description
This check queries Active Directory to identify objects related to NTAuth Store Certificates. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-029)
- **CheckName**: The check name (NTAuth Store Certificates)
- **Name**: Object name
