...
## Overview
This security check performs analysis for: **CA Auditors**
...
## Description
This check queries Active Directory to identify objects related to CA Auditors. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-028)
- **CheckName**: The check name (CA Auditors)
- **Name**: Object name
