...
## Overview
This security check performs analysis for: **Certificate Template Renewal Period**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Renewal Period. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-010)
- **CheckName**: The check name (Certificate Template Renewal Period)
- **Name**: Object name
