...
## Overview
This security check performs analysis for: **Certificate Template Manager Approval**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Manager Approval. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-016)
- **CheckName**: The check name (Certificate Template Manager Approval)
- **Name**: Object name
