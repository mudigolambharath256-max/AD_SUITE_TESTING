...
## Overview
This security check performs analysis for: **CA OCSP Responders**
...
## Description
This check queries Active Directory to identify objects related to CA OCSP Responders. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-025)
- **CheckName**: The check name (CA OCSP Responders)
- **Name**: Object name
