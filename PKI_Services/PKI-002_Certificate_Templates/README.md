...
## Overview
This security check performs analysis for: **Certificate Templates**
...
## Description
This check queries Active Directory to identify objects related to Certificate Templates. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-002)
- **CheckName**: The check name (Certificate Templates)
- **Name**: Object name
