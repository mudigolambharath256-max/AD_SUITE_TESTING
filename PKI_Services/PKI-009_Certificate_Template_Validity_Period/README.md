...
## Overview
This security check performs analysis for: **Certificate Template Validity Period**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Validity Period. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-009)
- **CheckName**: The check name (Certificate Template Validity Period)
- **Name**: Object name
