...
## Overview
This security check performs analysis for: **Certificate Template Auto Enrollment**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Auto Enrollment. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-005)
- **CheckName**: The check name (Certificate Template Auto Enrollment)
- **Name**: Object name
