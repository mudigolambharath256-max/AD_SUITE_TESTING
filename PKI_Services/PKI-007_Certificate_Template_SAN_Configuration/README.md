...
## Overview
This security check performs analysis for: **Certificate Template SAN Configuration**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template SAN Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-007)
- **CheckName**: The check name (Certificate Template SAN Configuration)
- **Name**: Object name
