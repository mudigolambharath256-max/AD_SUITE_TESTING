...
## Overview
This security check performs analysis for: **Certificate Template Permissions**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Permissions. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-003)
- **CheckName**: The check name (Certificate Template Permissions)
- **Name**: Object name
