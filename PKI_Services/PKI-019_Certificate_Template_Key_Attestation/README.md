...
## Overview
This security check performs analysis for: **Certificate Template Key Attestation**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Key Attestation. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-019)
- **CheckName**: The check name (Certificate Template Key Attestation)
- **Name**: Object name
