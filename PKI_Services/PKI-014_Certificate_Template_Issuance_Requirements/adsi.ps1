...
Write-Host "Found $($results.Count) objects for check: Certificate Template Issuance Requirements" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PKI-014_nodes.json"
