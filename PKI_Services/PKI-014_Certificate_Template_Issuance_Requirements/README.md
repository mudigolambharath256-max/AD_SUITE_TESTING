...
## Overview
This security check performs analysis for: **Certificate Template Issuance Requirements**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Issuance Requirements. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-014)
- **CheckName**: The check name (Certificate Template Issuance Requirements)
- **Name**: Object name
