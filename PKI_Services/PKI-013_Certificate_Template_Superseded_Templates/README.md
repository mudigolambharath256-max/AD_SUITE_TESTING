...
## Overview
This security check performs analysis for: **Certificate Template Superseded Templates**
...
## Description
This check queries Active Directory to identify objects related to Certificate Template Superseded Templates. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-013)
- **CheckName**: The check name (Certificate Template Superseded Templates)
- **Name**: Object name
