...
Write-Host "Found $($results.Count) objects for check: Certificate Template Superseded Templates" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "PKI-013_nodes.json"
