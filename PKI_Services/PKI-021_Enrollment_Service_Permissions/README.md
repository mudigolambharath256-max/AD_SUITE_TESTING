...
## Overview
This security check performs analysis for: **Enrollment Service Permissions**
...
## Description
This check queries Active Directory to identify objects related to Enrollment Service Permissions. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-021)
- **CheckName**: The check name (Enrollment Service Permissions)
- **Name**: Object name
