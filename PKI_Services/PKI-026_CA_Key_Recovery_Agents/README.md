...
## Overview
This security check performs analysis for: **CA Key Recovery Agents**
...
## Description
This check queries Active Directory to identify objects related to CA Key Recovery Agents. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (PKI-026)
- **CheckName**: The check name (CA Key Recovery Agents)
- **Name**: Object name
