...
(@('name', 'distinguishedName', 'samAccountName', 'description', 'memberOf', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-013_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Device Registration Service Account
# Category: Azure AD Integration
# Severity: info
# ID: AAD-013
# Requirements: None
