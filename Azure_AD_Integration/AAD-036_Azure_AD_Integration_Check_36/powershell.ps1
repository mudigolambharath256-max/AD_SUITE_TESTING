...
try {
    ...
    Write-Host "AAD-036: found $($found.Count) objects"
    ...
    Write-Warning "AAD-036: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-036: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-036: Query failed : $_"
}
