...
@('name', 'distinguishedName', 'samAccountName', 'msDS-DeviceID', 'operatingSystem', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-024_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Hybrid Azure AD Joined Devices
# Category: Azure AD Integration
# Severity: info
# ID: AAD-024
# Requirements: None
