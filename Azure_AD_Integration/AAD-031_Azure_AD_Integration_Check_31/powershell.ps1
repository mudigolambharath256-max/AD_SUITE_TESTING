...
try {
    ...
    Write-Host "AAD-031: found $($found.Count) objects"
    ...
    Write-Warning "AAD-031: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-031: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-031: Query failed : $_"
}
