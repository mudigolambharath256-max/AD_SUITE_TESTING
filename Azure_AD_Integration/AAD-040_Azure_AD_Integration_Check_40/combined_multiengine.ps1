...
# Check: Azure AD Integration Check 40
...
Write-Host "=== Azure AD Integration Check 40 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "AAD-040 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "AAD-040 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "AAD-040 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== AAD-040: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "AAD-040_results.csv"
$uniqueResults |
