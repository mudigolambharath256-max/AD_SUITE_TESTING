...
try {
    ...
    Write-Host "AAD-040: found $($found.Count) objects"
    ...
    Write-Warning "AAD-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-040: Query failed : $_"
}
