...
try {
    ...
    Write-Host "AAD-003: found $($found.Count) objects"
    ...
    Write-Warning "AAD-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-003: Query failed : $_"
}
