...
try {
    ...
    Write-Host "AAD-005: found $($found.Count) objects"
    ...
    Write-Warning "AAD-005: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-005: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-005: Query failed : $_"
}
