...
try {
    ...
    Write-Host "AAD-020: found $($found.Count) objects"
    ...
    Write-Warning "AAD-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-020: Query failed — $_"
}
