...
try {
    ...
    Write-Host "AAD-012: found $($found.Count) objects"
    ...
    Write-Warning "AAD-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-012: Query failed : $_"
}
