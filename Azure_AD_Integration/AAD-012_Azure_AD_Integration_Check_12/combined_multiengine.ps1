...
# Check: Azure AD Integration Check 12
...
Write-Host "=== Azure AD Integration Check 12 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "AAD-012 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "AAD-012 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "AAD-012 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== AAD-012: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "AAD-012_results.csv"
$uniqueResults |
