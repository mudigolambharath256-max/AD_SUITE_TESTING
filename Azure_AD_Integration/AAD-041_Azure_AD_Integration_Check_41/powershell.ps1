...
try {
    ...
    Write-Host "AAD-041: found $($found.Count) objects"
    ...
    Write-Warning "AAD-041: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-041: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-041: Query failed — $_"
}
