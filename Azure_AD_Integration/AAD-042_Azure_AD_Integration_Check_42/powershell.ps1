...
try {
    ...
    Write-Host "AAD-042: found $($found.Count) objects"
    ...
    Write-Warning "AAD-042: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-042: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-042: Query failed : $_"
}
