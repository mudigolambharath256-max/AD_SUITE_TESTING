...
try {
    ...
    Write-Host "AAD-002: found $($found.Count) objects"
    ...
    Write-Warning "AAD-002: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-002: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-002: Query failed : $_"
}
