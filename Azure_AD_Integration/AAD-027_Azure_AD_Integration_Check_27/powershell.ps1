...
try {
    ...
    Write-Host "AAD-027: found $($found.Count) objects"
    ...
    Write-Warning "AAD-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-027: Query failed : $_"
}
