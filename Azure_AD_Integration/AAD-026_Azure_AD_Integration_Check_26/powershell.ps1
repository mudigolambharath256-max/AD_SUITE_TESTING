...
try {
    ...
    Write-Host "AAD-026: found $($found.Count) objects"
    ...
    Write-Warning "AAD-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-026: Query failed : $_"
}
