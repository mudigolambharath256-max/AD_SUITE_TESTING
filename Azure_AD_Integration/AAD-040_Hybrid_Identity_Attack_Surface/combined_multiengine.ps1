# ============================================================================
# AAD-040: Hybrid Identity Attack Surface - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[AAD-040] Hybrid Identity Attack Surface" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Hybrid_Identity_Attack_Surface'
    ...
    $bhFile = Join-Path $bhDir "AAD-040_$bhTs.json"
    @{
