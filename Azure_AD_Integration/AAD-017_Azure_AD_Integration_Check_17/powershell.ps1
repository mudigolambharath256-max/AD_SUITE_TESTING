...
try {
    ...
    Write-Host "AAD-017: found $($found.Count) objects"
    ...
    Write-Warning "AAD-017: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-017: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-017: Query failed : $_"
}
