...
try {
    ...
    Write-Host "AAD-016: found $($found.Count) objects"
    ...
    Write-Warning "AAD-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-016: Query failed — $_"
}
