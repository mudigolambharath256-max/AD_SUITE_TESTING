...
try {
    ...
    Write-Host "AAD-007: found $($found.Count) objects"
    ...
    Write-Warning "AAD-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-007: Query failed — $_"
}
