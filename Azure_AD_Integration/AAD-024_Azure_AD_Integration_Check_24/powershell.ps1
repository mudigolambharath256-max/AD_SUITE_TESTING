...
try {
    ...
    Write-Host "AAD-024: found $($found.Count) objects"
    ...
    Write-Warning "AAD-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-024: Query failed : $_"
}
