...
(@('name', 'distinguishedName', 'samAccountName', 'msDS-RegisteredOwner', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-025_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Azure AD Device Registration
# Category: Azure AD Integration
# Severity: info
# ID: AAD-025
# Requirements: None
