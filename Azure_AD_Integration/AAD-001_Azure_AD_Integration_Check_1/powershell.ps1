...
try {
    ...
    Write-Host "AAD-001: found $($found.Count) objects"
    ...
    Write-Warning "AAD-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-001: Query failed — $_"
}
