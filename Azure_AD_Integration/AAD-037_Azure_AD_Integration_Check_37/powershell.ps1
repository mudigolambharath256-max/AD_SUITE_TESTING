...
try {
    ...
    Write-Host "AAD-037: found $($found.Count) objects"
    ...
    Write-Warning "AAD-037: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-037: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-037: Query failed — $_"
}
