...
try {
    ...
    Write-Host "AAD-015: found $($found.Count) objects"
    ...
    Write-Warning "AAD-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-015: Query failed — $_"
}
