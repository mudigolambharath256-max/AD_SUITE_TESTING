...
(@('name', 'distinguishedName', 'samAccountName', 'memberOf', 'description', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-028_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Writeback Enabled Indicators
# Category: Azure AD Integration
# Severity: high
# ID: AAD-028
# Requirements: None
