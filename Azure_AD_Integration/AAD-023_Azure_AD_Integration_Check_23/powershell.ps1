...
try {
    ...
    Write-Host "AAD-023: found $($found.Count) objects"
    ...
    Write-Warning "AAD-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-023: Query failed : $_"
}
