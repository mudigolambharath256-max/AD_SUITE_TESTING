...
try {
    ...
    Write-Host "AAD-022: found $($found.Count) objects"
    ...
    Write-Warning "AAD-022: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-022: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-022: Query failed — $_"
}
