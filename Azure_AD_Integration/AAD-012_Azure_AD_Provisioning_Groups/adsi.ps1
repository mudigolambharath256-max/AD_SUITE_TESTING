...
@('name', 'distinguishedName', 'cn', 'member', 'description', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-012_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Azure AD Provisioning Groups
# Category: Azure AD Integration
# Severity: info
# ID: AAD-012
# Requirements: None
