...
try {
    ...
    Write-Host "AAD-006: found $($found.Count) objects"
    ...
    Write-Warning "AAD-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-006: Query failed — $_"
}
