...
# Check: Azure AD Integration Check 6
...
Write-Host "=== Azure AD Integration Check 6 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "AAD-006 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "AAD-006 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "AAD-006 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== AAD-006: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "AAD-006_results.csv"
$uniqueResults |
