...
try {
    ...
    Write-Host "AAD-010: found $($found.Count) objects"
    ...
    Write-Warning "AAD-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-010: Query failed — $_"
}
