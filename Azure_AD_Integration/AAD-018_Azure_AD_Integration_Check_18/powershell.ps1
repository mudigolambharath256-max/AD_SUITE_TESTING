...
try {
    ...
    Write-Host "AAD-018: found $($found.Count) objects"
    ...
    Write-Warning "AAD-018: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-018: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-018: Query failed — $_"
}
