...
Write-Host "=== Multi-Engine Execution: Sync Accounts with Old Passwords (180+ Days) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AAD-006'
                adSuiteCheckName  = 'Sync_Accounts_with_Old_Passwords_180_Days'
    ...
    $bhFile = Join-Path $bhDir "AAD-006_$bhTs.json"
    @{
