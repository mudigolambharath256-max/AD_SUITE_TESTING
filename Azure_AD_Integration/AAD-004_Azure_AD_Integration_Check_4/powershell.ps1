...
try {
    ...
    Write-Host "AAD-004: found $($found.Count) objects"
    ...
    Write-Warning "AAD-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-004: Query failed — $_"
}
