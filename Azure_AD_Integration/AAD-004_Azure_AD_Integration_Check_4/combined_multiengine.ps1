...
# Check: Azure AD Integration Check 4
...
Write-Host "=== Azure AD Integration Check 4 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "AAD-004 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "AAD-004 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "AAD-004 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== AAD-004: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "AAD-004_results.csv"
$uniqueResults |
