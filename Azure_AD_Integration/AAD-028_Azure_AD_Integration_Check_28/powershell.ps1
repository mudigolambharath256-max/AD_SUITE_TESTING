...
try {
    ...
    Write-Host "AAD-028: found $($found.Count) objects"
    ...
    Write-Warning "AAD-028: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-028: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-028: Query failed : $_"
}
