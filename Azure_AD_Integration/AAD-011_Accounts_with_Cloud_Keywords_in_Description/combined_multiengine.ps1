...
# Check: Accounts with Cloud Keywords in Description
...
Write-Host "=== Multi-Engine Execution: Accounts with Cloud Keywords in Description ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $psResults = @(
        ...
        $ldapFilter = '(&(&(objectCategory=person)(objectClass=user)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))(|(description=*azure*)(description=*Azure*)(description=*AAD*)(description=*cloud*)(description=*O365*)(description=*M365*)))'
...
try {
    $adsiResults = @(
        ...
        $searcher = [ADSISearcher]'(&(&(objectCategory=person)(objectClass=user)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))(|(description=*azure*)(description=*Azure*)(description=*AAD*)(description=*cloud*)(description=*O365*)(description=*M365*)))'
        ...
        $searcher.FindAll() | ForEach-Object {
          $p = $_.Properties
          [PSCustomObject]@{
            Label = 'Accounts with Cloud Keywords in Description'
            Name = $p['name'][0]
...
public class Program
{
  ...
  {
    string filter = @"(&(&(objectCategory=person)(objectClass=user)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))(|(description=*azure*)(description=*Azure*)(description=*AAD*)(description=*cloud*)(description=*O365*)(description=*M365*)))";
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AAD-011'
                adSuiteCheckName  = 'Accounts_with_Cloud_Keywords_in_Description'
    ...
    $bhFile = Join-Path $bhDir "AAD-011_$bhTs.json"
    @{
