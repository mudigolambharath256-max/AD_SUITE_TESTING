...
(@('name', 'distinguishedName', 'samAccountName', 'memberOf', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-014_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Password Hash Sync Enabled Indicators
# Category: Azure AD Integration
# Severity: high
# ID: AAD-014
# Requirements: None
