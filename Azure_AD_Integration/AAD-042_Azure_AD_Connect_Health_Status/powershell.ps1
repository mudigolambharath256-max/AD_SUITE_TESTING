...
Write-Host "Severity: MEDIUM | Risk: 5/10 | MITRE: T1562.002" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(samAccountName=MSOL_*)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'AAD-042'}}, `
    @{N='CheckName'; E={'Azure AD Connect Health Status'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1562.002'}}, `
