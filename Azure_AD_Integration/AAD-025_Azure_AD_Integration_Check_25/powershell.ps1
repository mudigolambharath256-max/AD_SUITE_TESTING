...
try {
    ...
    Write-Host "AAD-025: found $($found.Count) objects"
    ...
    Write-Warning "AAD-025: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-025: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-025: Query failed — $_"
}
