...
try {
    ...
    Write-Host "AAD-019: found $($found.Count) objects"
    ...
    Write-Warning "AAD-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-019: Query failed : $_"
}
