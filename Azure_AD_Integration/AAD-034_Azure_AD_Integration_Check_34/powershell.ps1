...
try {
    ...
    Write-Host "AAD-034: found $($found.Count) objects"
    ...
    Write-Warning "AAD-034: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-034: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-034: Query failed — $_"
}
