...
(@('name', 'distinguishedName', 'samAccountName', 'userPrincipalName', 'memberOf', 'description', 'pwdLastSet', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-001_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Azure AD Connect Accounts (MSOL_*)
# Category: Azure AD Integration
# Severity: high
# ID: AAD-001
# Requirements: None
