...
try {
    ...
    Write-Host "AAD-014: found $($found.Count) objects"
    ...
    Write-Warning "AAD-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-014: Query failed — $_"
}
