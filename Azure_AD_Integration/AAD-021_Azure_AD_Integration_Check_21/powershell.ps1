...
try {
    ...
    Write-Host "AAD-021: found $($found.Count) objects"
    ...
    Write-Warning "AAD-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-021: Query failed : $_"
}
