...
(@('name', 'distinguishedName', 'samAccountName', 'userPrincipalName', 'mail', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-009_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts Synced to Azure AD (UPN Set)
# Category: Azure AD Integration
# Severity: info
# ID: AAD-009
# Requirements: None
