# ============================================================================
# AAD-036: Azure AD Joined Device Compliance - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[AAD-036] Azure AD Joined Device Compliance" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AAD-036'
                adSuiteCheckName  = 'Azure_AD_Joined_Device_Compliance'
    ...
    $bhFile = Join-Path $bhDir "AAD-036_$bhTs.json"
    @{
