...
Write-Host "Executing: Password Hash Sync Status" -ForegroundColor Cyan
Write-Host "Check ID: AAD-032" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=person)(objectClass=user)(samAccountName=MSOL_*))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'AAD-032'}}, `
    @{N='CheckName'; E={'Password Hash Sync Status'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1003.006'}}, `
