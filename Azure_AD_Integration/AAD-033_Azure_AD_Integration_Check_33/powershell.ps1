...
try {
    ...
    Write-Host "AAD-033: found $($found.Count) objects"
    ...
    Write-Warning "AAD-033: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-033: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-033: Query failed — $_"
}
