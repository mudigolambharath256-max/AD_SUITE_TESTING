...
Write-Host "Severity: MEDIUM | Risk: 6/10 | MITRE: T1556" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(samAccountName=AZUREADSSOACC$)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'AAD-035'}}, `
    @{N='CheckName'; E={'Seamless SSO Configuration'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1556'}}, `
