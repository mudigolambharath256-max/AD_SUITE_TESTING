...
@('name', 'distinguishedName', 'samAccountName', 'isCriticalSystemObject', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-022_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts Blocked from Sync
# Category: Azure AD Integration
# Severity: info
# ID: AAD-022
# Requirements: None
