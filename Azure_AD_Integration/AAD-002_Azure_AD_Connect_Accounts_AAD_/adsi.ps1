...
(@('name', 'distinguishedName', 'samAccountName', 'userPrincipalName', 'memberOf', 'description', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-002_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Azure AD Connect Accounts (AAD_*)
# Category: Azure AD Integration
# Severity: high
# ID: AAD-002
# Requirements: None
