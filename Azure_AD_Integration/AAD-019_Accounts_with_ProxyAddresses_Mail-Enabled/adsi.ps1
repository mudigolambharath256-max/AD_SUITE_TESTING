...
(@('name', 'distinguishedName', 'samAccountName', 'proxyAddresses', 'mail', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-019_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with ProxyAddresses (Mail-Enabled)
# Category: Azure AD Integration
# Severity: info
# ID: AAD-019
# Requirements: None
