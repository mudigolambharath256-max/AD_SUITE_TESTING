...
try {
    ...
    Write-Host "AAD-032: found $($found.Count) objects"
    ...
    Write-Warning "AAD-032: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-032: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-032: Query failed — $_"
}
