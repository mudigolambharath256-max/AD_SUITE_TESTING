...
@('name', 'distinguishedName', 'samAccountName', 'dNSHostName', 'operatingSystem', 'description', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AAD-020_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Sync Server Computer Accounts
# Category: Azure AD Integration
# Severity: high
# ID: AAD-020
# Requirements: None
