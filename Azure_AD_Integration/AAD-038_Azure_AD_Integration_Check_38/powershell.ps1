...
try {
    ...
    Write-Host "AAD-038: found $($found.Count) objects"
    ...
    Write-Warning "AAD-038: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-038: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-038: Query failed : $_"
}
