# ============================================================================
# AAD-034: Pass Through Authentication Security - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[AAD-034] Pass Through Authentication Security" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AAD-034'
                adSuiteCheckName  = 'Pass_Through_Authentication_Security'
    ...
    $bhFile = Join-Path $bhDir "AAD-034_$bhTs.json"
    @{
