...
try {
    ...
    Write-Host "AAD-029: found $($found.Count) objects"
    ...
    Write-Warning "AAD-029: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-029: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-029: Query failed : $_"
}
