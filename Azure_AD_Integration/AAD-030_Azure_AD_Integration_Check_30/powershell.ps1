...
try {
    ...
    Write-Host "AAD-030: found $($found.Count) objects"
    ...
    Write-Warning "AAD-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-030: Query failed — $_"
}
