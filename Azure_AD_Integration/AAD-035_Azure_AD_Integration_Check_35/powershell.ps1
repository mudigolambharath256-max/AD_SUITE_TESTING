...
try {
    ...
    Write-Host "AAD-035: found $($found.Count) objects"
    ...
    Write-Warning "AAD-035: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-035: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-035: Query failed — $_"
}
