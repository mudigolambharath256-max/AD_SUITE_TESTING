...
try {
    ...
    Write-Host "AAD-008: found $($found.Count) objects"
    ...
    Write-Warning "AAD-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AAD-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AAD-008: Query failed — $_"
}
