...
try {
    ...
    Write-Host "USER-007: found $($found.Count) objects"
    ...
    Write-Warning "USER-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-007: Query failed — $_"
}
