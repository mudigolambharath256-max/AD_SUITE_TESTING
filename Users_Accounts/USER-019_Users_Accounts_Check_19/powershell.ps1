...
try {
    ...
    Write-Host "USER-019: found $($found.Count) objects"
    ...
    Write-Warning "USER-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-019: Query failed : $_"
}
