...
try {
    ...
    Write-Host "USER-045: found $($found.Count) objects"
    ...
    Write-Warning "USER-045: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-045: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-045: Query failed — $_"
}
