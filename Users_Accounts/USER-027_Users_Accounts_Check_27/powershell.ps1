...
try {
    ...
    Write-Host "USER-027: found $($found.Count) objects"
    ...
    Write-Warning "USER-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-027: Query failed : $_"
}
