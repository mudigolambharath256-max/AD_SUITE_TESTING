...
try {
    ...
    Write-Host "USER-001: found $($found.Count) objects"
    ...
    Write-Warning "USER-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-001: Query failed — $_"
}
