...
try {
    ...
    Write-Host "USER-059: found $($found.Count) objects"
    ...
    Write-Warning "USER-059: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-059: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-059: Query failed : $_"
}
