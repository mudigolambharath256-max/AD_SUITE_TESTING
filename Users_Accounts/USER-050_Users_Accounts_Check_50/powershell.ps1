...
try {
    ...
    Write-Host "USER-050: found $($found.Count) objects"
    ...
    Write-Warning "USER-050: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-050: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-050: Query failed : $_"
}
