...
try {
    ...
    Write-Host "USER-070: found $($found.Count) objects"
    ...
    Write-Warning "USER-070: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-070: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-070: Query failed — $_"
}
