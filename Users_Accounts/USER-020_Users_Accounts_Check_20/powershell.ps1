...
try {
    ...
    Write-Host "USER-020: found $($found.Count) objects"
    ...
    Write-Warning "USER-020: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-020: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-020: Query failed : $_"
}
