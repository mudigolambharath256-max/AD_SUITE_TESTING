...
try {
    ...
    Write-Host "USER-013: found $($found.Count) objects"
    ...
    Write-Warning "USER-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-013: Query failed — $_"
}
