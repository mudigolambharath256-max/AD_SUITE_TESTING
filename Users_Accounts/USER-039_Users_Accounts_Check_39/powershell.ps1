...
try {
    ...
    Write-Host "USER-039: found $($found.Count) objects"
    ...
    Write-Warning "USER-039: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-039: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-039: Query failed — $_"
}
