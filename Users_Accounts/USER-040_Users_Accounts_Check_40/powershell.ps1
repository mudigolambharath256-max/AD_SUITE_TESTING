...
try {
    ...
    Write-Host "USER-040: found $($found.Count) objects"
    ...
    Write-Warning "USER-040: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-040: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-040: Query failed — $_"
}
