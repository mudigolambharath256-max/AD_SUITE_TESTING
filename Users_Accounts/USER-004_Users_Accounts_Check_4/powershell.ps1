...
try {
    ...
    Write-Host "USER-004: found $($found.Count) objects"
    ...
    Write-Warning "USER-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-004: Query failed — $_"
}
