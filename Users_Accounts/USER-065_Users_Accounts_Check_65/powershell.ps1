...
try {
    ...
    Write-Host "USER-065: found $($found.Count) objects"
    ...
    Write-Warning "USER-065: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-065: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-065: Query failed — $_"
}
