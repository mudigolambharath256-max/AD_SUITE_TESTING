...
try {
    ...
    Write-Host "USER-015: found $($found.Count) objects"
    ...
    Write-Warning "USER-015: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-015: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-015: Query failed : $_"
}
