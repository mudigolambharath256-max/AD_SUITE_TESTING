...
try {
    ...
    Write-Host "USER-067: found $($found.Count) objects"
    ...
    Write-Warning "USER-067: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-067: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-067: Query failed — $_"
}
