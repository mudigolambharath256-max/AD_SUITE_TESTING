...
try {
    ...
    Write-Host "USER-053: found $($found.Count) objects"
    ...
    Write-Warning "USER-053: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-053: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-053: Query failed : $_"
}
