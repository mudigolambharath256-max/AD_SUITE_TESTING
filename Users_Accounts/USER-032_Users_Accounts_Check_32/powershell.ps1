...
try {
    ...
    Write-Host "USER-032: found $($found.Count) objects"
    ...
    Write-Warning "USER-032: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-032: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-032: Query failed — $_"
}
