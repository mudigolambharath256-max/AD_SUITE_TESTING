...
try {
    ...
    Write-Host "USER-012: found $($found.Count) objects"
    ...
    Write-Warning "USER-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-012: Query failed : $_"
}
