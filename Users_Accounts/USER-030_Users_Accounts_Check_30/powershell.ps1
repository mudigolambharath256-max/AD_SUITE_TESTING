...
try {
    ...
    Write-Host "USER-030: found $($found.Count) objects"
    ...
    Write-Warning "USER-030: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-030: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-030: Query failed : $_"
}
