...
try {
    ...
    Write-Host "USER-025: found $($found.Count) objects"
    ...
    Write-Warning "USER-025: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-025: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-025: Query failed — $_"
}
