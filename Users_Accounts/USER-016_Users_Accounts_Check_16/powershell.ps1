...
try {
    ...
    Write-Host "USER-016: found $($found.Count) objects"
    ...
    Write-Warning "USER-016: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-016: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-016: Query failed : $_"
}
