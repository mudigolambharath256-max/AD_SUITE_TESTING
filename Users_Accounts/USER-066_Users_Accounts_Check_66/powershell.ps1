...
try {
    ...
    Write-Host "USER-066: found $($found.Count) objects"
    ...
    Write-Warning "USER-066: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-066: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-066: Query failed — $_"
}
