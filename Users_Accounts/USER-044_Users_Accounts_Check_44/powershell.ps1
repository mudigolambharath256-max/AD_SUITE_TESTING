...
try {
    ...
    Write-Host "USER-044: found $($found.Count) objects"
    ...
    Write-Warning "USER-044: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-044: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-044: Query failed : $_"
}
