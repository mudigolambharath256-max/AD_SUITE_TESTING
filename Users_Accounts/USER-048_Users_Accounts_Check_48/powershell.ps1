...
try {
    ...
    Write-Host "USER-048: found $($found.Count) objects"
    ...
    Write-Warning "USER-048: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-048: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-048: Query failed — $_"
}
