...
try {
    ...
    Write-Host "USER-018: found $($found.Count) objects"
    ...
    Write-Warning "USER-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-018: Query failed : $_"
}
