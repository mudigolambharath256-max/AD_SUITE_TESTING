...
try {
    ...
    Write-Host "USER-008: found $($found.Count) objects"
    ...
    Write-Warning "USER-008: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-008: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-008: Query failed : $_"
}
