...
try {
    ...
    Write-Host "USER-034: found $($found.Count) objects"
    ...
    Write-Warning "USER-034: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-034: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-034: Query failed : $_"
}
