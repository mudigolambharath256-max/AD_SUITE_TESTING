...
try {
    ...
    Write-Host "USER-005: found $($found.Count) objects"
    ...
    Write-Warning "USER-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-005: Query failed — $_"
}
