...
try {
    ...
    Write-Host "USER-060: found $($found.Count) objects"
    ...
    Write-Warning "USER-060: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-060: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-060: Query failed : $_"
}
