...
try {
    ...
    Write-Host "USER-051: found $($found.Count) objects"
    ...
    Write-Warning "USER-051: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-051: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-051: Query failed : $_"
}
