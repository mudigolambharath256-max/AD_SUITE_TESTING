...
try {
    ...
    Write-Host "USER-026: found $($found.Count) objects"
    ...
    Write-Warning "USER-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-026: Query failed : $_"
}
