...
try {
    ...
    Write-Host "USER-028: found $($found.Count) objects"
    ...
    Write-Warning "USER-028: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-028: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-028: Query failed — $_"
}
