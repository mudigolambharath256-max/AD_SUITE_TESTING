...
try {
    ...
    Write-Host "USER-042: found $($found.Count) objects"
    ...
    Write-Warning "USER-042: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-042: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-042: Query failed : $_"
}
