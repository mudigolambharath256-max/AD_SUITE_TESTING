...
try {
    ...
    Write-Host "USER-024: found $($found.Count) objects"
    ...
    Write-Warning "USER-024: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-024: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-024: Query failed — $_"
}
