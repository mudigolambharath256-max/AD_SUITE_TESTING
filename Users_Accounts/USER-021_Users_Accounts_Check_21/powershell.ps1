...
try {
    ...
    Write-Host "USER-021: found $($found.Count) objects"
    ...
    Write-Warning "USER-021: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-021: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-021: Query failed — $_"
}
