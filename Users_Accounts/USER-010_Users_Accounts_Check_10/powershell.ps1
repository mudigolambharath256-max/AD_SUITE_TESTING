...
try {
    ...
    Write-Host "USER-010: found $($found.Count) objects"
    ...
    Write-Warning "USER-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-010: Query failed — $_"
}
