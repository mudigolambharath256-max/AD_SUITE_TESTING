...
try {
    ...
    Write-Host "USER-047: found $($found.Count) objects"
    ...
    Write-Warning "USER-047: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-047: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-047: Query failed — $_"
}
