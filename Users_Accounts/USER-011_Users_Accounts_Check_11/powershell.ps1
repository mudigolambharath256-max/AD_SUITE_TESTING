...
try {
    ...
    Write-Host "USER-011: found $($found.Count) objects"
    ...
    Write-Warning "USER-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-011: Query failed — $_"
}
