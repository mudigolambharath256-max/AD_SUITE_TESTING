...
try {
    ...
    Write-Host "USER-031: found $($found.Count) objects"
    ...
    Write-Warning "USER-031: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-031: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-031: Query failed : $_"
}
