...
try {
    ...
    Write-Host "USER-023: found $($found.Count) objects"
    ...
    Write-Warning "USER-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-023: Query failed : $_"
}
