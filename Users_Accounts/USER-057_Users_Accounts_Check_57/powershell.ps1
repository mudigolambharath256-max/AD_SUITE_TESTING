...
try {
    ...
    Write-Host "USER-057: found $($found.Count) objects"
    ...
    Write-Warning "USER-057: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-057: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-057: Query failed : $_"
}
