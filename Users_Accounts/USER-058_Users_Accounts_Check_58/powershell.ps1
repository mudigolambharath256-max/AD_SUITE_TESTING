...
try {
    ...
    Write-Host "USER-058: found $($found.Count) objects"
    ...
    Write-Warning "USER-058: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-058: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-058: Query failed — $_"
}
