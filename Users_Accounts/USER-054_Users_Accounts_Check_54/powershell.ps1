...
try {
    ...
    Write-Host "USER-054: found $($found.Count) objects"
    ...
    Write-Warning "USER-054: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-054: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-054: Query failed — $_"
}
