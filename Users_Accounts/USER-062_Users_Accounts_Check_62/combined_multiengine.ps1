...
Write-Host "=== Users Accounts Check 62 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "USER-062 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "USER-062 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "USER-062 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== USER-062: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "USER-062_results.csv"
$uniqueResults |
