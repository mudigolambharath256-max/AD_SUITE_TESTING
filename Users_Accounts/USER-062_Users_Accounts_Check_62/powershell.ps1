...
try {
    ...
    Write-Host "USER-062: found $($found.Count) objects"
    ...
    Write-Warning "USER-062: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-062: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-062: Query failed — $_"
}
