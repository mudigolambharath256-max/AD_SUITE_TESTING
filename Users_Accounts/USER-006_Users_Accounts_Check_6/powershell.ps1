...
try {
    ...
    Write-Host "USER-006: found $($found.Count) objects"
    ...
    Write-Warning "USER-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-006: Query failed — $_"
}
