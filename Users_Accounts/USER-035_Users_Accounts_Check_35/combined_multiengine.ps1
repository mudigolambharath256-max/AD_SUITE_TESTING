...
Write-Host "=== Users Accounts Check 35 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "USER-035 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "USER-035 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "USER-035 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== USER-035: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "USER-035_results.csv"
$uniqueResults |
