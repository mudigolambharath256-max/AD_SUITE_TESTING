...
try {
    ...
    Write-Host "USER-035: found $($found.Count) objects"
    ...
    Write-Warning "USER-035: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-035: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-035: Query failed : $_"
}
