...
try {
    ...
    Write-Host "USER-049: found $($found.Count) objects"
    ...
    Write-Warning "USER-049: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-049: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-049: Query failed — $_"
}
