...
try {
    ...
    Write-Host "USER-046: found $($found.Count) objects"
    ...
    Write-Warning "USER-046: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-046: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-046: Query failed — $_"
}
