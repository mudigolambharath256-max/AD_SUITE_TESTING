...
Write-Host "Executing: Accounts with Unusual Group Memberships" -ForegroundColor Cyan
Write-Host "Check ID: USR-034" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'USR-034'}}, `
    @{N='CheckName'; E={'Accounts with Unusual Group Memberships'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1098'}}, `
