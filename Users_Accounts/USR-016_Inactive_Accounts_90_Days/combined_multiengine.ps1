...
Write-Host "=== Multi-Engine Execution: Inactive Accounts (90+ Days) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'USR-016'
                adSuiteCheckName  = 'Inactive_Accounts_90_Days'
    ...
    $bhFile = Join-Path $bhDir "USR-016_$bhTs.json"
    @{
