...
try {
    ...
    Write-Host "USER-037: found $($found.Count) objects"
    ...
    Write-Warning "USER-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-037: Query failed : $_"
}
