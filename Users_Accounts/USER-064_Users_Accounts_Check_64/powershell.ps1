...
try {
    ...
    Write-Host "USER-064: found $($found.Count) objects"
    ...
    Write-Warning "USER-064: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-064: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-064: Query failed — $_"
}
