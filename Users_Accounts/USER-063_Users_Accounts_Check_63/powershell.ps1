...
try {
    ...
    Write-Host "USER-063: found $($found.Count) objects"
    ...
    Write-Warning "USER-063: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-063: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-063: Query failed : $_"
}
