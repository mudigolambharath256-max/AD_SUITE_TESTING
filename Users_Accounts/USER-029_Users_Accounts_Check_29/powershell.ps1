...
try {
    ...
    Write-Host "USER-029: found $($found.Count) objects"
    ...
    Write-Warning "USER-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-029: Query failed — $_"
}
