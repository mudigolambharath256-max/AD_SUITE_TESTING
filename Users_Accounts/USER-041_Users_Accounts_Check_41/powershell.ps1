...
try {
    ...
    Write-Host "USER-041: found $($found.Count) objects"
    ...
    Write-Warning "USER-041: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-041: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-041: Query failed : $_"
}
