...
try {
    ...
    Write-Host "USER-061: found $($found.Count) objects"
    ...
    Write-Warning "USER-061: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-061: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-061: Query failed — $_"
}
