...
try {
    ...
    Write-Host "USER-043: found $($found.Count) objects"
    ...
    Write-Warning "USER-043: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-043: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-043: Query failed — $_"
}
