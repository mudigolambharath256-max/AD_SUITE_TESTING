...
try {
    ...
    Write-Host "USER-055: found $($found.Count) objects"
    ...
    Write-Warning "USER-055: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-055: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-055: Query failed : $_"
}
