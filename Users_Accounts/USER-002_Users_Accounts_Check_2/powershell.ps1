...
try {
    ...
    Write-Host "USER-002: found $($found.Count) objects"
    ...
    Write-Warning "USER-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-002: Query failed — $_"
}
