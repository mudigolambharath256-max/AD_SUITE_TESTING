...
try {
    ...
    Write-Host "USER-069: found $($found.Count) objects"
    ...
    Write-Warning "USER-069: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-069: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-069: Query failed : $_"
}
