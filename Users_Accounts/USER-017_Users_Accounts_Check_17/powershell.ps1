...
try {
    ...
    Write-Host "USER-017: found $($found.Count) objects"
    ...
    Write-Warning "USER-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-017: Query failed — $_"
}
