...
Write-Host "Executing: Recently Created Privileged Accounts" -ForegroundColor Cyan
Write-Host "Check ID: USR-033" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'USR-033'}}, `
    @{N='CheckName'; E={'Recently Created Privileged Accounts'}}, `
    @{N='RiskScore'; E={8}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1136.002'}}, `
