...
try {
    ...
    Write-Host "USER-014: found $($found.Count) objects"
    ...
    Write-Warning "USER-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-014: Query failed — $_"
}
