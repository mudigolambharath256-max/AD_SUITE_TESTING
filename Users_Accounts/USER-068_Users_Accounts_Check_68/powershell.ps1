...
try {
    ...
    Write-Host "USER-068: found $($found.Count) objects"
    ...
    Write-Warning "USER-068: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-068: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-068: Query failed — $_"
}
