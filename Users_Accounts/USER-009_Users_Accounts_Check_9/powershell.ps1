...
try {
    ...
    Write-Host "USER-009: found $($found.Count) objects"
    ...
    Write-Warning "USER-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-009: Query failed — $_"
}
