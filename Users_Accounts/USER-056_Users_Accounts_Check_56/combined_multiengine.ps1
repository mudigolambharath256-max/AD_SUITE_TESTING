...
Write-Host "=== Users Accounts Check 56 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "USER-056 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "USER-056 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "USER-056 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== USER-056: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "USER-056_results.csv"
$uniqueResults |
