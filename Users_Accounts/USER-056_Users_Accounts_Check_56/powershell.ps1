...
try {
    ...
    Write-Host "USER-056: found $($found.Count) objects"
    ...
    Write-Warning "USER-056: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-056: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-056: Query failed : $_"
}
