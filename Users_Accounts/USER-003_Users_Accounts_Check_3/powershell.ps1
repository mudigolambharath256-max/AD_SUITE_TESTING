...
try {
    ...
    Write-Host "USER-003: found $($found.Count) objects"
    ...
    Write-Warning "USER-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-003: Query failed : $_"
}
