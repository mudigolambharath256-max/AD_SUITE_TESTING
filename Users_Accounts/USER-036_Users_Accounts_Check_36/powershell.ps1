...
try {
    ...
    Write-Host "USER-036: found $($found.Count) objects"
    ...
    Write-Warning "USER-036: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "USER-036: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "USER-036: Query failed — $_"
}
