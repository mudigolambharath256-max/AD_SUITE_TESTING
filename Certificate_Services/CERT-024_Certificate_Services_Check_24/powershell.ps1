...
try {
    ...
    Write-Host "CERT-024: found $($found.Count) objects"
    ...
    Write-Warning "CERT-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-024: Query failed : $_"
}
