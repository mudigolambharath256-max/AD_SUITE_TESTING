# ============================================================================
# CERT-035: CRL Distribution Point Availability
# ============================================================================
# Version: 3.0.0
...
Write-Host "Severity: HIGH | Risk: 7/10 | MITRE: T1649" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=cRLDistributionPoint)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CERT-035'}}, `
    @{N='CheckName'; E={'CRL Distribution Point Availability'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1649'}}, `
