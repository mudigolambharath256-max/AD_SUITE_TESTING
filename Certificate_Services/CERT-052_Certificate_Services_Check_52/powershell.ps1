...
try {
    ...
    Write-Host "CERT-052: found $($found.Count) objects"
    ...
    Write-Warning "CERT-052: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-052: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-052: Query failed : $_"
}
