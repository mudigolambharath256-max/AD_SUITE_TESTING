...
Write-Host "=== Multi-Engine Execution: Templates Enrolled by Everyone ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Templates_Enrolled_by_Everyone'
    ...
    $bhFile = Join-Path $bhDir "CERT-026_$bhTs.json"
    @{
