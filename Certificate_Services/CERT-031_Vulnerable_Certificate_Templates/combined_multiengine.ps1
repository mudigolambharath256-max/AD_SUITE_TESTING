...
Write-Host "=== CERT-031: Vulnerable Certificate Templates ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Vulnerable_Certificate_Templates'
    ...
    $bhFile = Join-Path $bhDir "CERT-031_$bhTs.json"
    @{
