...
Write-Host "Executing: Vulnerable Certificate Templates" -ForegroundColor Cyan
Write-Host "Check ID: CERT-031" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CERT-031'}}, `
    @{N='CheckName'; E={'Vulnerable Certificate Templates'}}, `
    @{N='RiskScore'; E={9}}, `
