...
try {
    ...
    Write-Host "CERT-045: found $($found.Count) objects"
    ...
    Write-Warning "CERT-045: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-045: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-045: Query failed — $_"
}
