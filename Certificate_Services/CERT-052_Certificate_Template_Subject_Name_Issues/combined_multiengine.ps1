# ============================================================================
# CERT-052: Certificate Template Subject Name Issues - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CERT-052] Certificate Template Subject Name Issues" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Certificate_Template_Subject_Name_Issues'
    ...
    $bhFile = Join-Path $bhDir "CERT-052_$bhTs.json"
    @{
