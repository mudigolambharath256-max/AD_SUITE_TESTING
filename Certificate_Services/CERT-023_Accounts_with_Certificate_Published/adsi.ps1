...
@('name', 'distinguishedName', 'samAccountName', 'userCertificate', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-023_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Certificate Published
# Category: Certificate Services
# Severity: info
# ID: CERT-023
# Requirements: None
