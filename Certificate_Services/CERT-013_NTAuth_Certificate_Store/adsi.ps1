...
@('name', 'distinguishedName', 'cn', 'cACertificate', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-013_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: NTAuth Certificate Store
# Category: Certificate Services
# Severity: info
# ID: CERT-013
# Requirements: None
