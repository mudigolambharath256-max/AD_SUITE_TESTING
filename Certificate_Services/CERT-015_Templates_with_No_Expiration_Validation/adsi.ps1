...
@('name', 'distinguishedName', 'cn', 'displayName', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-015_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Templates with No Expiration Validation
# Category: Certificate Services
# Severity: low
# ID: CERT-015
# Requirements: None
