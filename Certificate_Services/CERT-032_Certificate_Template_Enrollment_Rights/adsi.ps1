...
Write-Host "Found $($results.Count) objects for check: Certificate Template Enrollment Rights" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-032_nodes.json"
