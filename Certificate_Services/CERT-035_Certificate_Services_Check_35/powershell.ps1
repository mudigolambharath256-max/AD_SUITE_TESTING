...
try {
    ...
    Write-Host "CERT-035: found $($found.Count) objects"
    ...
    Write-Warning "CERT-035: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-035: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-035: Query failed — $_"
}
