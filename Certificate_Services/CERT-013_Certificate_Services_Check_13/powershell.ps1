...
try {
    ...
    Write-Host "CERT-013: found $($found.Count) objects"
    ...
    Write-Warning "CERT-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-013: Query failed — $_"
}
