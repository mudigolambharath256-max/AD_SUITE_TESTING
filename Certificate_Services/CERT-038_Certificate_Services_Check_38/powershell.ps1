...
try {
    ...
    Write-Host "CERT-038: found $($found.Count) objects"
    ...
    Write-Warning "CERT-038: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-038: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-038: Query failed — $_"
}
