...
try {
    ...
    Write-Host "CERT-048: found $($found.Count) objects"
    ...
    Write-Warning "CERT-048: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-048: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-048: Query failed : $_"
}
