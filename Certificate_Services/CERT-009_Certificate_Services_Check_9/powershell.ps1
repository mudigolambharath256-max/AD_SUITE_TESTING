...
try {
    ...
    Write-Host "CERT-009: found $($found.Count) objects"
    ...
    Write-Warning "CERT-009: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-009: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-009: Query failed : $_"
}
