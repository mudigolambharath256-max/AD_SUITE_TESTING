# ============================================================================
# CERT-049: Smart Card Logon Certificate Issues
# ============================================================================
# Version: 3.0.0
...
Write-Host "Severity: MEDIUM | Risk: 6/10 | MITRE: T1649" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CERT-049'}}, `
    @{N='CheckName'; E={'Smart Card Logon Certificate Issues'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1649'}}, `
