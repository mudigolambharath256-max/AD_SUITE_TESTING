...
try {
    ...
    Write-Host "CERT-036: found $($found.Count) objects"
    ...
    Write-Warning "CERT-036: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-036: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-036: Query failed : $_"
}
