...
try {
    ...
    Write-Host "CERT-032: found $($found.Count) objects"
    ...
    Write-Warning "CERT-032: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-032: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-032: Query failed : $_"
}
