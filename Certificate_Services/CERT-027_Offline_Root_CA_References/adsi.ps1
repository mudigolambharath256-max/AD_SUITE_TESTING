...
@('name', 'distinguishedName', 'cn', 'cACertificate', 'certificateRevocationList', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-027_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Offline Root CA References
# Category: Certificate Services
# Severity: info
# ID: CERT-027
# Requirements: None
