...
try {
    ...
    Write-Host "CERT-029: found $($found.Count) objects"
    ...
    Write-Warning "CERT-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-029: Query failed — $_"
}
