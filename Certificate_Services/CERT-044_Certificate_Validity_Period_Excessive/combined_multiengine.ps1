# ============================================================================
# CERT-044: Certificate Validity Period Excessive - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CERT-044] Certificate Validity Period Excessive" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Certificate_Validity_Period_Excessive'
    ...
    $bhFile = Join-Path $bhDir "CERT-044_$bhTs.json"
    @{
