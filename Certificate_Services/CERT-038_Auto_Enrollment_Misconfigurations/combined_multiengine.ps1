# ============================================================================
# CERT-038: Auto Enrollment Misconfigurations - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CERT-038] Auto Enrollment Misconfigurations" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Auto_Enrollment_Misconfigurations'
    ...
    $bhFile = Join-Path $bhDir "CERT-038_$bhTs.json"
    @{
