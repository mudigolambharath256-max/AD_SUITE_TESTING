...
try {
    ...
    Write-Host "CERT-012: found $($found.Count) objects"
    ...
    Write-Warning "CERT-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-012: Query failed : $_"
}
