...
try {
    ...
    Write-Host "CERT-034: found $($found.Count) objects"
    ...
    Write-Warning "CERT-034: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-034: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-034: Query failed — $_"
}
