...
try {
    ...
    Write-Host "CERT-023: found $($found.Count) objects"
    ...
    Write-Warning "CERT-023: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-023: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-023: Query failed — $_"
}
