...
try {
    ...
    Write-Host "CERT-008: found $($found.Count) objects"
    ...
    Write-Warning "CERT-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-008: Query failed — $_"
}
