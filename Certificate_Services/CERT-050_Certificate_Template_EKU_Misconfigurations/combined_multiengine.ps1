# ============================================================================
# CERT-050: Certificate Template EKU Misconfigurations - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CERT-050] Certificate Template EKU Misconfigurations" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Certificate_Template_EKU_Misconfigurations'
    ...
    $bhFile = Join-Path $bhDir "CERT-050_$bhTs.json"
    @{
