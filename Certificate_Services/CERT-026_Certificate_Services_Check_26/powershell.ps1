...
try {
    ...
    Write-Host "CERT-026: found $($found.Count) objects"
    ...
    Write-Warning "CERT-026: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-026: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-026: Query failed — $_"
}
