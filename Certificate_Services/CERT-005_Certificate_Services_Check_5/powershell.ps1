...
try {
    ...
    Write-Host "CERT-005: found $($found.Count) objects"
    ...
    Write-Warning "CERT-005: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-005: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-005: Query failed : $_"
}
