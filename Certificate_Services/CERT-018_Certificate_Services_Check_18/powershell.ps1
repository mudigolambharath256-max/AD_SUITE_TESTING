...
try {
    ...
    Write-Host "CERT-018: found $($found.Count) objects"
    ...
    Write-Warning "CERT-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-018: Query failed : $_"
}
