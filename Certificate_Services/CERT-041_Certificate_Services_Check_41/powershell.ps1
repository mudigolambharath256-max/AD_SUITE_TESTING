...
try {
    ...
    Write-Host "CERT-041: found $($found.Count) objects"
    ...
    Write-Warning "CERT-041: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-041: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-041: Query failed — $_"
}
