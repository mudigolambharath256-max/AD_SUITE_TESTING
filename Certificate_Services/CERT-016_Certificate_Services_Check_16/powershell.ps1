...
try {
    ...
    Write-Host "CERT-016: found $($found.Count) objects"
    ...
    Write-Warning "CERT-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-016: Query failed — $_"
}
