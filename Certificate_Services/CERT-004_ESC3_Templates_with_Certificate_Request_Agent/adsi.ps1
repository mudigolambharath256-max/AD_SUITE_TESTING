...
@('name', 'distinguishedName', 'cn', 'displayName', 'pKIExtendedKeyUsage', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-004_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: ESC3: Templates with Certificate Request Agent
# Category: Certificate Services
# Severity: critical
# ID: CERT-004
# Requirements: None
