...
try {
    ...
    Write-Host "CERT-040: found $($found.Count) objects"
    ...
    Write-Warning "CERT-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-040: Query failed : $_"
}
