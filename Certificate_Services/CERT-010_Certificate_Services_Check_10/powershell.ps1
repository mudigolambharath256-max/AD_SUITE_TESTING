...
try {
    ...
    Write-Host "CERT-010: found $($found.Count) objects"
    ...
    Write-Warning "CERT-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-010: Query failed — $_"
}
