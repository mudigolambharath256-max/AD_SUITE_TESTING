...
try {
    ...
    Write-Host "CERT-049: found $($found.Count) objects"
    ...
    Write-Warning "CERT-049: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-049: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-049: Query failed — $_"
}
