...
try {
    ...
    Write-Host "CERT-047: found $($found.Count) objects"
    ...
    Write-Warning "CERT-047: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-047: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-047: Query failed : $_"
}
