...
Write-Host "Executing: Certificates with Client Authentication" -ForegroundColor Cyan
Write-Host "Check ID: CERT-033" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CERT-033'}}, `
    @{N='CheckName'; E={'Certificates with Client Authentication'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1649'}}, `
