...
try {
    ...
    Write-Host "CERT-051: found $($found.Count) objects"
    ...
    Write-Warning "CERT-051: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-051: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-051: Query failed : $_"
}
