...
@('name', 'distinguishedName', 'cn', 'displayName', 'pKIExtendedKeyUsage', 'msPKI-Enrollment-Flag', 'msPKI-Certificate-Name-Flag', 'msPKI-RA-Signature', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-001_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Certificate Template Inventory
# Category: Certificate Services
# Severity: info
# ID: CERT-001
# Requirements: None
