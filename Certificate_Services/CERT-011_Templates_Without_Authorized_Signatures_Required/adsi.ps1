...
@('name', 'distinguishedName', 'cn', 'displayName', 'msPKI-RA-Signature', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-011_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Templates Without Authorized Signatures Required
# Category: Certificate Services
# Severity: medium
# ID: CERT-011
# Requirements: None
