...
try {
    ...
    Write-Host "CERT-031: found $($found.Count) objects"
    ...
    Write-Warning "CERT-031: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-031: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-031: Query failed — $_"
}
