...
@('name', 'distinguishedName', 'cn', 'displayName', 'msPKI-Certificate-Name-Flag', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-029_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Templates with Subject Name from AD
# Category: Certificate Services
# Severity: info
# ID: CERT-029
# Requirements: None
