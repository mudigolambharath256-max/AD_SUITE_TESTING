...
try {
    ...
    Write-Host "CERT-039: found $($found.Count) objects"
    ...
    Write-Warning "CERT-039: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-039: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-039: Query failed : $_"
}
