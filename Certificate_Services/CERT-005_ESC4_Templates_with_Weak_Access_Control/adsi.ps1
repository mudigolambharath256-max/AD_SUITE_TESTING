...
@('name', 'distinguishedName', 'cn', 'displayName', 'nTSecurityDescriptor', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-005_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: ESC4: Templates with Weak Access Control
# Category: Certificate Services
# Severity: high
# ID: CERT-005
# Requirements: None
