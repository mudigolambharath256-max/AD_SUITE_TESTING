...
try {
    ...
    Write-Host "CERT-006: found $($found.Count) objects"
    ...
    Write-Warning "CERT-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-006: Query failed : $_"
}
