...
@('name', 'distinguishedName', 'cn', 'displayName', 'msPKI-Enrollment-Flag', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-019_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Templates Allowing Renewal with Different Key
# Category: Certificate Services
# Severity: low
# ID: CERT-019
# Requirements: None
