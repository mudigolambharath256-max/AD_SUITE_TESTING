...
try {
    ...
    Write-Host "CERT-046: found $($found.Count) objects"
    ...
    Write-Warning "CERT-046: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-046: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-046: Query failed — $_"
}
