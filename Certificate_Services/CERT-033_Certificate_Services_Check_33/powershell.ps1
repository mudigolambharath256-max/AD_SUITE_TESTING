...
try {
    ...
    Write-Host "CERT-033: found $($found.Count) objects"
    ...
    Write-Warning "CERT-033: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-033: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-033: Query failed — $_"
}
