...
try {
    ...
    Write-Host "CERT-030: found $($found.Count) objects"
    ...
    Write-Warning "CERT-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-030: Query failed — $_"
}
