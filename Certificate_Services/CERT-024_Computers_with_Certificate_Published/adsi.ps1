...
@('name', 'distinguishedName', 'samAccountName', 'userCertificate', 'operatingSystem', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-024_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers with Certificate Published
# Category: Certificate Services
# Severity: info
# ID: CERT-024
# Requirements: None
