...
try {
    ...
    Write-Host "CERT-004: found $($found.Count) objects"
    ...
    Write-Warning "CERT-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-004: Query failed — $_"
}
