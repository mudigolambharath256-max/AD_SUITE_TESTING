...
try {
    ...
    Write-Host "CERT-022: found $($found.Count) objects"
    ...
    Write-Warning "CERT-022: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-022: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-022: Query failed — $_"
}
