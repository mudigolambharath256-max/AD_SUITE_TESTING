...
Write-Host "=== Multi-Engine Execution: Trusted Root CAs in AD ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Trusted_Root_CAs_in_AD'
    ...
    $bhFile = Join-Path $bhDir "CERT-014_$bhTs.json"
    @{
