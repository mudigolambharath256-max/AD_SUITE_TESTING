...
try {
    ...
    Write-Host "CERT-044: found $($found.Count) objects"
    ...
    Write-Warning "CERT-044: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-044: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-044: Query failed — $_"
}
