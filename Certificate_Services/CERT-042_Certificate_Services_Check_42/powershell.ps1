...
try {
    ...
    Write-Host "CERT-042: found $($found.Count) objects"
    ...
    Write-Warning "CERT-042: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-042: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-042: Query failed : $_"
}
