...
try {
    ...
    Write-Host "CERT-037: found $($found.Count) objects"
    ...
    Write-Warning "CERT-037: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-037: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-037: Query failed — $_"
}
