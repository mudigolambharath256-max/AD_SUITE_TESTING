...
try {
    ...
    Write-Host "CERT-019: found $($found.Count) objects"
    ...
    Write-Warning "CERT-019: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-019: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-019: Query failed — $_"
}
