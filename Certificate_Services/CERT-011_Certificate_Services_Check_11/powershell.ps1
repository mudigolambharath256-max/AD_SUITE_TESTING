...
try {
    ...
    Write-Host "CERT-011: found $($found.Count) objects"
    ...
    Write-Warning "CERT-011: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-011: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-011: Query failed : $_"
}
