...
try {
    ...
    Write-Host "CERT-015: found $($found.Count) objects"
    ...
    Write-Warning "CERT-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-015: Query failed — $_"
}
