...
try {
    ...
    Write-Host "CERT-014: found $($found.Count) objects"
    ...
    Write-Warning "CERT-014: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-014: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-014: Query failed : $_"
}
