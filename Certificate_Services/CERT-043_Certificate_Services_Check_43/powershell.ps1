...
try {
    ...
    Write-Host "CERT-043: found $($found.Count) objects"
    ...
    Write-Warning "CERT-043: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-043: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-043: Query failed — $_"
}
