...
@('name', 'distinguishedName', 'cn', 'dNSHostName', 'cACertificate', 'certificateTemplates', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-012_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Enterprise Certificate Authorities
# Category: Certificate Services
# Severity: info
# ID: CERT-012
# Requirements: None
