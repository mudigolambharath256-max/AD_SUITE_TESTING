...
@('name', 'distinguishedName', 'cn', 'dNSHostName', 'nTSecurityDescriptor', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-021_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: ESC7: CA with Manage Certificates Permission
# Category: Certificate Services
# Severity: high
# ID: CERT-021
# Requirements: None
