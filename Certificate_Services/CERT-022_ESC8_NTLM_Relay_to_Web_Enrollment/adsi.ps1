...
@('name', 'distinguishedName', 'cn', 'dNSHostName', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-022_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: ESC8: NTLM Relay to Web Enrollment
# Category: Certificate Services
# Severity: high
# ID: CERT-022
# Requirements: None
