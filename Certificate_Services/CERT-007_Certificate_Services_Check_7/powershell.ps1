...
try {
    ...
    Write-Host "CERT-007: found $($found.Count) objects"
    ...
    Write-Warning "CERT-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-007: Query failed — $_"
}
