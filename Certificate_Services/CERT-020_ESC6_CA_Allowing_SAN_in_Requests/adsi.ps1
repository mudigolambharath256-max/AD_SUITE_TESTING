...
@('name', 'distinguishedName', 'cn', 'dNSHostName', 'flags', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CERT-020_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: ESC6: CA Allowing SAN in Requests
# Category: Certificate Services
# Severity: high
# ID: CERT-020
# Requirements: None
