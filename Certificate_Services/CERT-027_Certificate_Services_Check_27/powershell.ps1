...
try {
    ...
    Write-Host "CERT-027: found $($found.Count) objects"
    ...
    Write-Warning "CERT-027: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-027: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-027: Query failed — $_"
}
