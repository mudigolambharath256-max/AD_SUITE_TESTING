...
try {
    ...
    Write-Host "CERT-025: found $($found.Count) objects"
    ...
    Write-Warning "CERT-025: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-025: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-025: Query failed — $_"
}
