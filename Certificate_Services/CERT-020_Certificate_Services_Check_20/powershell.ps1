...
try {
    ...
    Write-Host "CERT-020: found $($found.Count) objects"
    ...
    Write-Warning "CERT-020: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CERT-020: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CERT-020: Query failed : $_"
}
