...
## Overview
This security check performs analysis for: **RPC Groups**
...
## Description
This check queries Active Directory to identify objects related to RPC Groups. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-015.exe csharp.cs
PUBRES-015.exe
```
...
- **CheckID**: The check identifier (PUBRES-015)
- **CheckName**: The check name (RPC Groups)
- **Name**: Object name
