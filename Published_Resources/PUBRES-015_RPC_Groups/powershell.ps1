...
$ldapFilter = '(objectClass=rpcGroup)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: RPC Groups" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-015" -ForegroundColor Gray
