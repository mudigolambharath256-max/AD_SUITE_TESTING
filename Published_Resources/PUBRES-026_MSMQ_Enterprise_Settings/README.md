...
## Overview
This security check performs analysis for: **MSMQ Enterprise Settings**
...
## Description
This check queries Active Directory to identify objects related to MSMQ Enterprise Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-026.exe csharp.cs
PUBRES-026.exe
```
...
- **CheckID**: The check identifier (PUBRES-026)
- **CheckName**: The check name (MSMQ Enterprise Settings)
- **Name**: Object name
