...
$ldapFilter = '(objectClass=mSMQEnterpriseSettings)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: MSMQ Enterprise Settings" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-026" -ForegroundColor Gray
