...
$ldapFilter = '(|(objectClass=volume)(objectClass=printQueue)(objectClass=serviceConnectionPoint))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Published Resources Inventory" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-030" -ForegroundColor Gray
