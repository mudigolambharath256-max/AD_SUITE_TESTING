...
## Overview
This security check performs analysis for: **Published Resources Inventory**
...
## Description
This check queries Active Directory to identify objects related to Published Resources Inventory. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-030.exe csharp.cs
PUBRES-030.exe
```
...
- **CheckID**: The check identifier (PUBRES-030)
- **CheckName**: The check name (Published Resources Inventory)
- **Name**: Object name
