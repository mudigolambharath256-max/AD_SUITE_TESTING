...
## Overview
This security check performs analysis for: **Printer Queue Permissions**
...
## Description
This check queries Active Directory to identify objects related to Printer Queue Permissions. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-005.exe csharp.cs
PUBRES-005.exe
```
...
- **CheckID**: The check identifier (PUBRES-005)
- **CheckName**: The check name (Printer Queue Permissions)
- **Name**: Object name
