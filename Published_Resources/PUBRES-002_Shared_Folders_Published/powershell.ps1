# ============================================================================
# PUBRES-002: Shared Folders Published
# ============================================================================
...
$ldapFilter = '(objectClass=volume)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Shared Folders Published" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-002" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PUBRES-002'}}, `
    @{N='CheckName'; E={'Shared Folders Published'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-002'
                adSuiteCheckName  = 'Shared_Folders_Published'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-002_$bhTs.json"
    @{
