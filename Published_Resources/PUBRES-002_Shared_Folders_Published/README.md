...
## Overview
This security check performs analysis for: **Shared Folders Published**
...
## Description
This check queries Active Directory to identify objects related to Shared Folders Published. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-002.exe csharp.cs
PUBRES-002.exe
```
...
- **CheckID**: The check identifier (PUBRES-002)
- **CheckName**: The check name (Shared Folders Published)
- **Name**: Object name
