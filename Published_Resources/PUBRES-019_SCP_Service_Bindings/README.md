...
## Overview
This security check performs analysis for: **SCP Service Bindings**
...
## Description
This check queries Active Directory to identify objects related to SCP Service Bindings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-019.exe csharp.cs
PUBRES-019.exe
```
...
- **CheckID**: The check identifier (PUBRES-019)
- **CheckName**: The check name (SCP Service Bindings)
- **Name**: Object name
