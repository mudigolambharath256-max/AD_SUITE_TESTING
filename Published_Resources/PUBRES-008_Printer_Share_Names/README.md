...
## Overview
This security check performs analysis for: **Printer Share Names**
...
## Description
This check queries Active Directory to identify objects related to Printer Share Names. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-008.exe csharp.cs
PUBRES-008.exe
```
...
- **CheckID**: The check identifier (PUBRES-008)
- **CheckName**: The check name (Printer Share Names)
- **Name**: Object name
