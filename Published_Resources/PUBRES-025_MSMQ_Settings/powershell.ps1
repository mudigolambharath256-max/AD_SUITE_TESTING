...
$ldapFilter = '(objectClass=mSMQSettings)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: MSMQ Settings" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-025" -ForegroundColor Gray
