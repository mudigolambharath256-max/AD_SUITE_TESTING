...
## Overview
This security check performs analysis for: **MSMQ Settings**
...
## Description
This check queries Active Directory to identify objects related to MSMQ Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-025.exe csharp.cs
PUBRES-025.exe
```
...
- **CheckID**: The check identifier (PUBRES-025)
- **CheckName**: The check name (MSMQ Settings)
- **Name**: Object name
