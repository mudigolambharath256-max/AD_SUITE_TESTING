...
$ldapFilter = '(objectClass=rpcProfileElement)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: RPC Profile Elements" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-014" -ForegroundColor Gray
