...
## Overview
This security check performs analysis for: **RPC Profile Elements**
...
## Description
This check queries Active Directory to identify objects related to RPC Profile Elements. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-014.exe csharp.cs
PUBRES-014.exe
```
...
- **CheckID**: The check identifier (PUBRES-014)
- **CheckName**: The check name (RPC Profile Elements)
- **Name**: Object name
