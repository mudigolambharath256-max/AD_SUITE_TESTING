...
## Overview
This security check performs analysis for: **RPC Service Bindings**
...
## Description
This check queries Active Directory to identify objects related to RPC Service Bindings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-012.exe csharp.cs
PUBRES-012.exe
```
...
- **CheckID**: The check identifier (PUBRES-012)
- **CheckName**: The check name (RPC Service Bindings)
- **Name**: Object name
