# ============================================================================
# PUBRES-028: Application Settings
# ============================================================================
...
Write-Host "=== PUBRES-028: Application Settings ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        # Execute query
        $adObjects = Get-ADObject -LDAPFilter '(objectClass=applicationSettings)' `
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'PUBRES-028'}}, `
            @{N='CheckName'; E={'Application Settings'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $searcher.Filter = '(objectClass=applicationSettings)'
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'PUBRES-028'
                CheckName         = 'Application Settings'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-028'
                adSuiteCheckName  = 'Application_Settings'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-028_$bhTs.json"
    @{
