...
## Overview
This security check performs analysis for: **Application Settings**
...
## Description
This check queries Active Directory to identify objects related to Application Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-028.exe csharp.cs
PUBRES-028.exe
```
...
- **CheckID**: The check identifier (PUBRES-028)
- **CheckName**: The check name (Application Settings)
- **Name**: Object name
