...
$ldapFilter = '(objectClass=applicationSettings)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Application Settings" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-028" -ForegroundColor Gray
