...
$ldapFilter = '(objectClass=mSMQQueueAlias)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: MSMQ Queue Aliases" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-023" -ForegroundColor Gray
