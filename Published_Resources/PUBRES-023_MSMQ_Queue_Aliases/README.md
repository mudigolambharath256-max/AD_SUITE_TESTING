...
## Overview
This security check performs analysis for: **MSMQ Queue Aliases**
...
## Description
This check queries Active Directory to identify objects related to MSMQ Queue Aliases. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-023.exe csharp.cs
PUBRES-023.exe
```
...
- **CheckID**: The check identifier (PUBRES-023)
- **CheckName**: The check name (MSMQ Queue Aliases)
- **Name**: Object name
