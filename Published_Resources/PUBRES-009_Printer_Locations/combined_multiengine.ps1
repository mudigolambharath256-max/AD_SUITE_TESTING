...
Write-Host "=== PUBRES-009: Printer Locations ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'PUBRES-009'}}, `
            @{N='CheckName'; E={'Printer Locations'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-009'
                adSuiteCheckName  = 'Printer_Locations'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-009_$bhTs.json"
    @{
