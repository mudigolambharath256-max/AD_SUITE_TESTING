...
## Overview
This security check performs analysis for: **Printer Locations**
...
## Description
This check queries Active Directory to identify objects related to Printer Locations. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-009.exe csharp.cs
PUBRES-009.exe
```
...
- **CheckID**: The check identifier (PUBRES-009)
- **CheckName**: The check name (Printer Locations)
- **Name**: Object name
