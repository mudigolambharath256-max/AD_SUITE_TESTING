...
## Overview
This security check performs analysis for: **RPC Server Elements**
...
## Description
This check queries Active Directory to identify objects related to RPC Server Elements. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-017.exe csharp.cs
PUBRES-017.exe
```
...
- **CheckID**: The check identifier (PUBRES-017)
- **CheckName**: The check name (RPC Server Elements)
- **Name**: Object name
