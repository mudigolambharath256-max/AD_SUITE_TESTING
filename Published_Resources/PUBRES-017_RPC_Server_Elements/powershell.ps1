...
$ldapFilter = '(objectClass=rpcServerElement)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: RPC Server Elements" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-017" -ForegroundColor Gray
