...
## Overview
This security check performs analysis for: **Exchange Servers Published**
...
## Description
This check queries Active Directory to identify objects related to Exchange Servers Published. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-022.exe csharp.cs
PUBRES-022.exe
```
...
- **CheckID**: The check identifier (PUBRES-022)
- **CheckName**: The check name (Exchange Servers Published)
- **Name**: Object name
