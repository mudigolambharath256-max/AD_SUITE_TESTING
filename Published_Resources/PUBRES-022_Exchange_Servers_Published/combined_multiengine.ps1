# ============================================================================
# PUBRES-022: Exchange Servers Published
# ============================================================================
...
Write-Host "=== PUBRES-022: Exchange Servers Published ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'PUBRES-022'}}, `
            @{N='CheckName'; E={'Exchange Servers Published'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'PUBRES-022'
                CheckName         = 'Exchange Servers Published'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-022'
                adSuiteCheckName  = 'Exchange_Servers_Published'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-022_$bhTs.json"
    @{
