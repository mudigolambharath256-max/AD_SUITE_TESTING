...
$ldapFilter = '(objectClass=applicationSiteSettings)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Application Site Settings" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-029" -ForegroundColor Gray
