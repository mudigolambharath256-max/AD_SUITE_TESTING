# ============================================================================
# PUBRES-029: Application Site Settings
# ============================================================================
...
Write-Host "=== PUBRES-029: Application Site Settings ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        # Execute query
        $adObjects = Get-ADObject -LDAPFilter '(objectClass=applicationSiteSettings)' `
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'PUBRES-029'}}, `
            @{N='CheckName'; E={'Application Site Settings'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $searcher.Filter = '(objectClass=applicationSiteSettings)'
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'PUBRES-029'
                CheckName         = 'Application Site Settings'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-029'
                adSuiteCheckName  = 'Application_Site_Settings'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-029_$bhTs.json"
    @{
