...
## Overview
This security check performs analysis for: **Application Site Settings**
...
## Description
This check queries Active Directory to identify objects related to Application Site Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-029.exe csharp.cs
PUBRES-029.exe
```
...
- **CheckID**: The check identifier (PUBRES-029)
- **CheckName**: The check name (Application Site Settings)
- **Name**: Object name
