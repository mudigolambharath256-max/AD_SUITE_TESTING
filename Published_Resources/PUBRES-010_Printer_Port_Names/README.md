...
## Overview
This security check performs analysis for: **Printer Port Names**
...
## Description
This check queries Active Directory to identify objects related to Printer Port Names. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-010.exe csharp.cs
PUBRES-010.exe
```
...
- **CheckID**: The check identifier (PUBRES-010)
- **CheckName**: The check name (Printer Port Names)
- **Name**: Object name
