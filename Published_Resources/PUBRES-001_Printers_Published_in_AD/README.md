...
## Overview
This security check performs analysis for: **Printers Published in AD**
...
## Description
This check queries Active Directory to identify objects related to Printers Published in AD. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-001.exe csharp.cs
PUBRES-001.exe
```
...
- **CheckID**: The check identifier (PUBRES-001)
- **CheckName**: The check name (Printers Published in AD)
- **Name**: Object name
