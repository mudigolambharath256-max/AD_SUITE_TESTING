...
$ldapFilter = '(objectClass=rpcProfile)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: RPC Profiles" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-013" -ForegroundColor Gray
