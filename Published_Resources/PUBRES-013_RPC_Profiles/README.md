...
## Overview
This security check performs analysis for: **RPC Profiles**
...
## Description
This check queries Active Directory to identify objects related to RPC Profiles. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-013.exe csharp.cs
PUBRES-013.exe
```
...
- **CheckID**: The check identifier (PUBRES-013)
- **CheckName**: The check name (RPC Profiles)
- **Name**: Object name
