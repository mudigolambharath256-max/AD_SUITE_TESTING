...
$ldapFilter = '(objectClass=rpcServer)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: RPC Servers" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-016" -ForegroundColor Gray
