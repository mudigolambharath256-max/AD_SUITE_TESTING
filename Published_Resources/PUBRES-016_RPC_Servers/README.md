...
## Overview
This security check performs analysis for: **RPC Servers**
...
## Description
This check queries Active Directory to identify objects related to RPC Servers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-016.exe csharp.cs
PUBRES-016.exe
```
...
- **CheckID**: The check identifier (PUBRES-016)
- **CheckName**: The check name (RPC Servers)
- **Name**: Object name
