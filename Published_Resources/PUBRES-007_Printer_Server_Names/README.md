...
## Overview
This security check performs analysis for: **Printer Server Names**
...
## Description
This check queries Active Directory to identify objects related to Printer Server Names. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-007.exe csharp.cs
PUBRES-007.exe
```
...
- **CheckID**: The check identifier (PUBRES-007)
- **CheckName**: The check name (Printer Server Names)
- **Name**: Object name
