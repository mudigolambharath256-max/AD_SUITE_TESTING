...
## Overview
This security check performs analysis for: **RPC Services Published**
...
## Description
This check queries Active Directory to identify objects related to RPC Services Published. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-011.exe csharp.cs
PUBRES-011.exe
```
...
- **CheckID**: The check identifier (PUBRES-011)
- **CheckName**: The check name (RPC Services Published)
- **Name**: Object name
