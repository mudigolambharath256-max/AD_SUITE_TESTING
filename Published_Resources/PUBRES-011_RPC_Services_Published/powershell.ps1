...
$ldapFilter = '(objectClass=rpcEntry)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: RPC Services Published" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-011" -ForegroundColor Gray
