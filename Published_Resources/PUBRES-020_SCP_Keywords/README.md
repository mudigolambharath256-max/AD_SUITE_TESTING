...
## Overview
This security check performs analysis for: **SCP Keywords**
...
## Description
This check queries Active Directory to identify objects related to SCP Keywords. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-020.exe csharp.cs
PUBRES-020.exe
```
...
- **CheckID**: The check identifier (PUBRES-020)
- **CheckName**: The check name (SCP Keywords)
- **Name**: Object name
