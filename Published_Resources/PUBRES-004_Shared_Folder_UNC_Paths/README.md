...
## Overview
This security check performs analysis for: **Shared Folder UNC Paths**
...
## Description
This check queries Active Directory to identify objects related to Shared Folder UNC Paths. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-004.exe csharp.cs
PUBRES-004.exe
```
...
- **CheckID**: The check identifier (PUBRES-004)
- **CheckName**: The check name (Shared Folder UNC Paths)
- **Name**: Object name
