# ============================================================================
# PUBRES-004: Shared Folder UNC Paths
# ============================================================================
...
Write-Host "Executing security check: Shared Folder UNC Paths" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-004" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PUBRES-004'}}, `
    @{N='CheckName'; E={'Shared Folder UNC Paths'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-004'
                adSuiteCheckName  = 'Shared_Folder_UNC_Paths'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-004_$bhTs.json"
    @{
