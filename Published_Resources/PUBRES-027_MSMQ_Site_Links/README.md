...
## Overview
This security check performs analysis for: **MSMQ Site Links**
...
## Description
This check queries Active Directory to identify objects related to MSMQ Site Links. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-027.exe csharp.cs
PUBRES-027.exe
```
...
- **CheckID**: The check identifier (PUBRES-027)
- **CheckName**: The check name (MSMQ Site Links)
- **Name**: Object name
