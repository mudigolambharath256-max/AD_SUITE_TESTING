...
$ldapFilter = '(objectClass=mSMQSiteLink)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: MSMQ Site Links" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-027" -ForegroundColor Gray
