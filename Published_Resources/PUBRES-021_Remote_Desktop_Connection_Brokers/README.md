...
## Overview
This security check performs analysis for: **Remote Desktop Connection Brokers**
...
## Description
This check queries Active Directory to identify objects related to Remote Desktop Connection Brokers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-021.exe csharp.cs
PUBRES-021.exe
```
...
- **CheckID**: The check identifier (PUBRES-021)
- **CheckName**: The check name (Remote Desktop Connection Brokers)
- **Name**: Object name
