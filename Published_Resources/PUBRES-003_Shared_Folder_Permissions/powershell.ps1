...
Write-Host "Executing security check: Shared Folder Permissions" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-003" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PUBRES-003'}}, `
    @{N='CheckName'; E={'Shared Folder Permissions'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PUBRES-003'
                adSuiteCheckName  = 'Shared_Folder_Permissions'
    ...
    $bhFile = Join-Path $bhDir "PUBRES-003_$bhTs.json"
    @{
