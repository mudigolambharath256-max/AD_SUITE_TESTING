...
$ldapFilter = '(objectClass=mSMQQueue)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: MSMQ Queues" -ForegroundColor Yellow
Write-Host "Check ID: PUBRES-024" -ForegroundColor Gray
