...
## Overview
This security check performs analysis for: **MSMQ Queues**
...
## Description
This check queries Active Directory to identify objects related to MSMQ Queues. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-024.exe csharp.cs
PUBRES-024.exe
```
...
- **CheckID**: The check identifier (PUBRES-024)
- **CheckName**: The check name (MSMQ Queues)
- **Name**: Object name
