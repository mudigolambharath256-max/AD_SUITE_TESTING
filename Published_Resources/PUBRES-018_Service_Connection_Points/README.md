...
## Overview
This security check performs analysis for: **Service Connection Points**
...
## Description
This check queries Active Directory to identify objects related to Service Connection Points. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:PUBRES-018.exe csharp.cs
PUBRES-018.exe
```
...
- **CheckID**: The check identifier (PUBRES-018)
- **CheckName**: The check name (Service Connection Points)
- **Name**: Object name
