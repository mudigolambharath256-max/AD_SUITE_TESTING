# ============================================================================
# COMPLY-004: HIPAA AD Controls - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-004] HIPAA AD Controls" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-004'
                adSuiteCheckName  = 'HIPAA_AD_Controls'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-004_$bhTs.json"
    @{
