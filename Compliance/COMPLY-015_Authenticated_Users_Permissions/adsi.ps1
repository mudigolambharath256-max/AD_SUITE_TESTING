...
@('name', 'distinguishedName', 'whenCreated', 'whenChanged', 'objectSid', 'samAccountName') | ForEach-Object {
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID = 'COMPLY-015'
        CheckName = 'Authenticated Users Permissions'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMPLY-015_nodes.json"
