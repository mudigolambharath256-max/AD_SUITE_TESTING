# ============================================================================
# COMPLY-018: Audit Policy Success Failure - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-018] Audit Policy Success Failure" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-018'
                adSuiteCheckName  = 'Audit_Policy_Success_Failure'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-018_$bhTs.json"
    @{
