# ============================================================================
# COMPLY-003: PCI DSS AD Requirements - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-003] PCI DSS AD Requirements" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-003'
                adSuiteCheckName  = 'PCI_DSS_AD_Requirements'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-003_$bhTs.json"
    @{
