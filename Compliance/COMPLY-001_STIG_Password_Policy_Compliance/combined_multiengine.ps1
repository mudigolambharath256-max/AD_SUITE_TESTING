# ============================================================================
# COMPLY-001: STIG Password Policy Compliance - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-001] STIG Password Policy Compliance" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-001'
                adSuiteCheckName  = 'STIG_Password_Policy_Compliance'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-001_$bhTs.json"
    @{
