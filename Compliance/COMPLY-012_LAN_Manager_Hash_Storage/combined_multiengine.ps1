# ============================================================================
# COMPLY-012: LAN Manager Hash Storage - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-012] LAN Manager Hash Storage" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-012'
                adSuiteCheckName  = 'LAN_Manager_Hash_Storage'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-012_$bhTs.json"
    @{
