# ============================================================================
# COMPLY-013: Anonymous SID Translation - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-013] Anonymous SID Translation" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-013'
                adSuiteCheckName  = 'Anonymous_SID_Translation'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-013_$bhTs.json"
    @{
