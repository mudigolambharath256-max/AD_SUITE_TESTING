# ============================================================================
# COMPLY-005: Advanced Audit Policy Validation - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-005] Advanced Audit Policy Validation" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-005'
                adSuiteCheckName  = 'Advanced_Audit_Policy_Validation'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-005_$bhTs.json"
    @{
