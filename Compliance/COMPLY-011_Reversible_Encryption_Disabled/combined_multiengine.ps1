# ============================================================================
# COMPLY-011: Reversible Encryption Disabled - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-011] Reversible Encryption Disabled" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-011'
                adSuiteCheckName  = 'Reversible_Encryption_Disabled'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-011_$bhTs.json"
    @{
