# ============================================================================
# COMPLY-009: Minimum Password Age Compliance - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-009] Minimum Password Age Compliance" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-009'
                adSuiteCheckName  = 'Minimum_Password_Age_Compliance'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-009_$bhTs.json"
    @{
