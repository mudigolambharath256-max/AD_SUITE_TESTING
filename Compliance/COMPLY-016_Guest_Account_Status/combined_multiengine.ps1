# ============================================================================
# COMPLY-016: Guest Account Status - Multi-Engine
# ============================================================================
...
if ($useADModule) {
    ...
    $results = Get-ADObject -LDAPFilter '(samAccountName=Guest)' -Properties name,distinguishedName,samAccountName -SearchBase $SearchBase -SearchScope Subtree -ResultSetSize $null -ErrorAction SilentlyContinue
} else {
    $root = [ADSI]'LDAP://RootDSE'
    $searcher = New-Object System.DirectoryServices.DirectorySearcher
    $searcher.SearchRoot = [ADSI]"LDAP://$($root.defaultNamingContext)"
    $searcher.Filter = '(samAccountName=Guest)'
