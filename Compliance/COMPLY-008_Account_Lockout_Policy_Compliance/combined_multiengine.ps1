# ============================================================================
# COMPLY-008: Account Lockout Policy Compliance - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-008] Account Lockout Policy Compliance" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-008'
                adSuiteCheckName  = 'Account_Lockout_Policy_Compliance'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-008_$bhTs.json"
    @{
