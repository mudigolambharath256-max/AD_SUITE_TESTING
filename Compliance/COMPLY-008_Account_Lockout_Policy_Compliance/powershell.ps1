...
Write-Host "Severity: MEDIUM | Risk: 6/10 | MITRE: T1110" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=domainDNS)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'COMPLY-008'}}, `
    @{N='CheckName'; E={'Account Lockout Policy Compliance'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1110'}}, `
