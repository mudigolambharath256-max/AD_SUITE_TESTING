# ============================================================================
# COMPLY-010: Password History Compliance - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-010] Password History Compliance" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-010'
                adSuiteCheckName  = 'Password_History_Compliance'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-010_$bhTs.json"
    @{
