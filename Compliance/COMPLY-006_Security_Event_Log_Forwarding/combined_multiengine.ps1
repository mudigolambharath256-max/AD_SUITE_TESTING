# ============================================================================
# COMPLY-006: Security Event Log Forwarding - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-006] Security Event Log Forwarding" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-006'
                adSuiteCheckName  = 'Security_Event_Log_Forwarding'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-006_$bhTs.json"
    @{
