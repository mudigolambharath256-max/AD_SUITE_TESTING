# ============================================================================
# COMPLY-019: Security Log Size Compliance - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-019] Security Log Size Compliance" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-019'
                adSuiteCheckName  = 'Security_Log_Size_Compliance'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-019_$bhTs.json"
    @{
