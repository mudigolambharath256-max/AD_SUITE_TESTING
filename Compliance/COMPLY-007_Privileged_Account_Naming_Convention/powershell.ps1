...
Write-Host "Severity: MEDIUM | Risk: 5/10 | MITRE: T1078.002" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=person)(objectClass=user)(adminCount=1))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'COMPLY-007'}}, `
    @{N='CheckName'; E={'Privileged Account Naming Convention'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1078.002'}}, `
