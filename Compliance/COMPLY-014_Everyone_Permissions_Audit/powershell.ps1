# ============================================================================
# COMPLY-014: Everyone Permissions Audit
# ============================================================================
# Version: 3.0.0
# Category: Compliance
...
Write-Host "Severity: HIGH | Risk: 7/10 | MITRE: T1222.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=*)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'COMPLY-014'}}, `
    @{N='CheckName'; E={'Everyone Permissions Audit'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1222.001'}}, `
