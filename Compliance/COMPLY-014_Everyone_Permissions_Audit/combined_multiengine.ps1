# ============================================================================
# COMPLY-014: Everyone Permissions Audit - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-014] Everyone Permissions Audit" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-014'
                adSuiteCheckName  = 'Everyone_Permissions_Audit'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-014_$bhTs.json"
    @{
