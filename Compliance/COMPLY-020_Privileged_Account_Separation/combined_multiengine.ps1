# ============================================================================
# COMPLY-020: Privileged Account Separation - Multi-Engine
# ============================================================================
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-020'
                adSuiteCheckName  = 'Privileged_Account_Separation'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-020_$bhTs.json"
    @{
