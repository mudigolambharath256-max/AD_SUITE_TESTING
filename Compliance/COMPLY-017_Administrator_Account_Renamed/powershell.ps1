...
Write-Host "Severity: MEDIUM | Risk: 5/10 | MITRE: T1078.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectSid=*-500)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'COMPLY-017'}}, `
    @{N='CheckName'; E={'Administrator Account Renamed'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1078.001'}}, `
