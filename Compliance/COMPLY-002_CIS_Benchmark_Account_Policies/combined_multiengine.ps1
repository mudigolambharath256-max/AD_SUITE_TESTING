# ============================================================================
# COMPLY-002: CIS Benchmark Account Policies - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[CMP-002] CIS Benchmark Account Policies" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMPLY-002'
                adSuiteCheckName  = 'CIS_Benchmark_Account_Policies'
    ...
    $bhFile = Join-Path $bhDir "COMPLY-002_$bhTs.json"
    @{
