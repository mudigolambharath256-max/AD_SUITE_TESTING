...
PRIORITY 2 — HIGH (affects correctness):
  ...
  FIX-B10: Add -SearchBase to Get-AD* calls in 2 powershell.ps1 files

PRIORITY 3 — MEDIUM (affects quality):
  FIX-B2: Add 'samAccountName' to PropertiesToLoad in 0 adsi.ps1 files
