...
try {
    ...
    Write-Host "KRB-024: found $($found.Count) objects"
    ...
    Write-Warning "KRB-024: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-024: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-024: Query failed — $_"
}
