...
Write-Host "=== Multi-Engine Execution: DES-Only Kerberos (Users) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'KRB-009'
                adSuiteCheckName  = 'DES-Only_Kerberos_Users'
    ...
    $bhFile = Join-Path $bhDir "KRB-009_$bhTs.json"
    @{
