...
try {
    ...
    Write-Host "KRB-040: found $($found.Count) objects"
    ...
    Write-Warning "KRB-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-040: Query failed : $_"
}
