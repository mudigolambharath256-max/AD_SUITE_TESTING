...
try {
    ...
    Write-Host "KRB-005: found $($found.Count) objects"
    ...
    Write-Warning "KRB-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-005: Query failed — $_"
}
