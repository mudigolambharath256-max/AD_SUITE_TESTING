...
@echo off
dsquery * -filter "(&(objectCategory=computer)(servicePrincipalName=*))" -limit 0 -attr name distinguishedName samAccountName servicePrincipalName
