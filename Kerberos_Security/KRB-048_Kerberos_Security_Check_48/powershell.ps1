...
try {
    ...
    Write-Host "KRB-048: found $($found.Count) objects"
    ...
    Write-Warning "KRB-048: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-048: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-048: Query failed : $_"
}
