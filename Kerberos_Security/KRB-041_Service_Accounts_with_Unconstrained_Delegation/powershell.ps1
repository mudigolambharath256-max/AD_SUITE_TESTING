...
Write-Host "Severity: CRITICAL | Risk: 10/10 | MITRE: T1134.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=person)(objectClass=user)(servicePrincipalName=*)(userAccountControl:1.2.840.113556.1.4.803:=524288))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'KRB-041'}}, `
    @{N='CheckName'; E={'Service Accounts with Unconstrained Delegation'}}, `
    @{N='RiskScore'; E={10}}, `
