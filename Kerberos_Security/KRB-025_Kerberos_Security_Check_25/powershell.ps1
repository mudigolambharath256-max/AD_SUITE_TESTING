...
try {
    ...
    Write-Host "KRB-025: found $($found.Count) objects"
    ...
    Write-Warning "KRB-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-025: Query failed : $_"
}
