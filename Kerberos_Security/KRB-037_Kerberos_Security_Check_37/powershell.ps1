...
try {
    ...
    Write-Host "KRB-037: found $($found.Count) objects"
    ...
    Write-Warning "KRB-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-037: Query failed : $_"
}
