...
try {
    ...
    Write-Host "KRB-041: found $($found.Count) objects"
    ...
    Write-Warning "KRB-041: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-041: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-041: Query failed : $_"
}
