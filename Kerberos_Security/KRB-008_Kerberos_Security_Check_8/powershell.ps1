...
try {
    ...
    Write-Host "KRB-008: found $($found.Count) objects"
    ...
    Write-Warning "KRB-008: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-008: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-008: Query failed : $_"
}
