# ============================================================================
# KRB-038: Kerberos Ticket Lifetime Excessive - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[KRB-038] Kerberos Ticket Lifetime Excessive" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                adSuiteCheckName  = 'Kerberos_Ticket_Lifetime_Excessive'
    ...
    $bhFile = Join-Path $bhDir "KRB-038_$bhTs.json"
    @{
