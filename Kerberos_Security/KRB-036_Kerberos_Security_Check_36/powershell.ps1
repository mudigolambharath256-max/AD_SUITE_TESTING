...
try {
    ...
    Write-Host "KRB-036: found $($found.Count) objects"
    ...
    Write-Warning "KRB-036: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-036: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-036: Query failed — $_"
}
