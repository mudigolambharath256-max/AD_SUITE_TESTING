...
try {
    ...
    Write-Host "KRB-038: found $($found.Count) objects"
    ...
    Write-Warning "KRB-038: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-038: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-038: Query failed — $_"
}
