...
try {
    ...
    Write-Host "KRB-047: found $($found.Count) objects"
    ...
    Write-Warning "KRB-047: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-047: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-047: Query failed : $_"
}
