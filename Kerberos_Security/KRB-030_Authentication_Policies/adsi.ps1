...
@('name', 'distinguishedName', 'cn', 'msDS-UserAllowedToAuthenticateTo', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-030_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Authentication Policies
# Category: Kerberos Security
# Severity: info
# ID: KRB-030
# Requirements: None
