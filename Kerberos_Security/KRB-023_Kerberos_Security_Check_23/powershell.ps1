...
try {
    ...
    Write-Host "KRB-023: found $($found.Count) objects"
    ...
    Write-Warning "KRB-023: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-023: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-023: Query failed — $_"
}
