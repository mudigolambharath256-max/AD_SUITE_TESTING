...
try {
    ...
    Write-Host "KRB-016: found $($found.Count) objects"
    ...
    Write-Warning "KRB-016: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-016: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-016: Query failed : $_"
}
