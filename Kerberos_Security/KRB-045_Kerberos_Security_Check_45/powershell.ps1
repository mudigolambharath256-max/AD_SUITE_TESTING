...
try {
    ...
    Write-Host "KRB-045: found $($found.Count) objects"
    ...
    Write-Warning "KRB-045: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-045: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-045: Query failed : $_"
}
