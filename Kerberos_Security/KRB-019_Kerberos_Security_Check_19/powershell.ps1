...
try {
    ...
    Write-Host "KRB-019: found $($found.Count) objects"
    ...
    Write-Warning "KRB-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-019: Query failed : $_"
}
