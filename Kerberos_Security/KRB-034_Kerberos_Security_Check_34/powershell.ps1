...
try {
    ...
    Write-Host "KRB-034: found $($found.Count) objects"
    ...
    Write-Warning "KRB-034: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-034: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-034: Query failed — $_"
}
