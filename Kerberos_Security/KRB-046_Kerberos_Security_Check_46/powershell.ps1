...
try {
    ...
    Write-Host "KRB-046: found $($found.Count) objects"
    ...
    Write-Warning "KRB-046: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-046: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-046: Query failed : $_"
}
