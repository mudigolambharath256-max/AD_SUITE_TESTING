...
try {
    ...
    Write-Host "KRB-035: found $($found.Count) objects"
    ...
    Write-Warning "KRB-035: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-035: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-035: Query failed — $_"
}
