...
try {
    ...
    Write-Host "KRB-043: found $($found.Count) objects"
    ...
    Write-Warning "KRB-043: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-043: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-043: Query failed : $_"
}
