...
(@('name', 'distinguishedName', 'samAccountName', 'objectClass', 'msDS-AllowedToDelegateTo', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-007_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Protocol Transition (S4U2Self)
# Category: Kerberos Security
# Severity: high
# ID: KRB-007
# Requirements: None
