...
try {
    ...
    Write-Host "KRB-012: found $($found.Count) objects"
    ...
    Write-Warning "KRB-012: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-012: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-012: Query failed — $_"
}
