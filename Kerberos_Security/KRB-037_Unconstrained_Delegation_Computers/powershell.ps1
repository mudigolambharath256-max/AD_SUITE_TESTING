...
Write-Host "Severity: CRITICAL | Risk: 9/10 | MITRE: T1134.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=524288))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'KRB-037'}}, `
    @{N='CheckName'; E={'Unconstrained Delegation Computers'}}, `
    @{N='RiskScore'; E={9}}, `
