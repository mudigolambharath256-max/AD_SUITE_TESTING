...
Write-Host "Severity: HIGH | Risk: 7/10 | MITRE: T1134.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(userAccountControl:1.2.840.113556.1.4.803:=16777216)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'KRB-034'}}, `
    @{N='CheckName'; E={'S4U2Self Abuse Detection'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1134.001'}}, `
