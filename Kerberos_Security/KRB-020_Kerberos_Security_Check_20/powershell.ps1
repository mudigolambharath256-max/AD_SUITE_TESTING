...
try {
    ...
    Write-Host "KRB-020: found $($found.Count) objects"
    ...
    Write-Warning "KRB-020: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-020: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-020: Query failed : $_"
}
