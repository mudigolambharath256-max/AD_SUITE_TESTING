...
Write-Host "Severity: HIGH | Risk: 7/10 | MITRE: T1558" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=person)(objectClass=user)(msDS-SupportedEncryptionTypes=*))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'KRB-032'}}, `
    @{N='CheckName'; E={'Kerberos Encryption Downgrade Risk'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1558'}}, `
