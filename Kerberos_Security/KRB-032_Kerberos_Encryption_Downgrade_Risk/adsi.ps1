...
(@('name', 'distinguishedName', 'whenCreated', 'whenChanged', 'msDS-SupportedEncryptionTypes', 'samAccountName', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_)
}
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID = 'KRB-032'
        CheckName = 'Kerberos Encryption Downgrade Risk'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-032_nodes.json"
