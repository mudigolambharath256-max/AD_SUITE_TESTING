...
try {
    ...
    Write-Host "KRB-049: found $($found.Count) objects"
    ...
    Write-Warning "KRB-049: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-049: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-049: Query failed — $_"
}
