...
# Check: Kerberos Security Check 49
...
Write-Host "=== Kerberos Security Check 49 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "KRB-049 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "KRB-049 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "KRB-049 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== KRB-049: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "KRB-049_results.csv"
$uniqueResults |
