...
try {
    ...
    Write-Host "KRB-044: found $($found.Count) objects"
    ...
    Write-Warning "KRB-044: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-044: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-044: Query failed : $_"
}
