...
(@('name', 'distinguishedName', 'samAccountName', 'msDS-SupportedEncryptionTypes', 'adminCount', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-027_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Sensitive Accounts Without AES
# Category: Kerberos Security
# Severity: high
# ID: KRB-027
# Requirements: None
