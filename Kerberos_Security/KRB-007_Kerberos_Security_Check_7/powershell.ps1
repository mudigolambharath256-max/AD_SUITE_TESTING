...
try {
    ...
    Write-Host "KRB-007: found $($found.Count) objects"
    ...
    Write-Warning "KRB-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-007: Query failed — $_"
}
