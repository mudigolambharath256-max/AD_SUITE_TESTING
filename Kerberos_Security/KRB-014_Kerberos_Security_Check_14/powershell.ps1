...
try {
    ...
    Write-Host "KRB-014: found $($found.Count) objects"
    ...
    Write-Warning "KRB-014: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-014: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-014: Query failed : $_"
}
