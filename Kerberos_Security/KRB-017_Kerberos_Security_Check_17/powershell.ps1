...
try {
    ...
    Write-Host "KRB-017: found $($found.Count) objects"
    ...
    Write-Warning "KRB-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-017: Query failed — $_"
}
