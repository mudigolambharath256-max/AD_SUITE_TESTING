...
try {
    ...
    Write-Host "KRB-027: found $($found.Count) objects"
    ...
    Write-Warning "KRB-027: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-027: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-027: Query failed — $_"
}
