...
Write-Host "Severity: HIGH | Risk: 7/10 | MITRE: T1558.004" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=4194304))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'KRB-042'}}, `
    @{N='CheckName'; E={'Kerberos Pre Auth Not Required Computers'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1558.004'}}, `
