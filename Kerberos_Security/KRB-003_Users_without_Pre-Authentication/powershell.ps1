...
try {
    ...
    Write-Host "KRB-003: found $($found.Count) objects"
    ...
    Write-Warning "KRB-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-003: Query failed : $_"
}
