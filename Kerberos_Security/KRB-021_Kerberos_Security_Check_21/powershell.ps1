...
try {
    ...
    Write-Host "KRB-021: found $($found.Count) objects"
    ...
    Write-Warning "KRB-021: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-021: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-021: Query failed — $_"
}
