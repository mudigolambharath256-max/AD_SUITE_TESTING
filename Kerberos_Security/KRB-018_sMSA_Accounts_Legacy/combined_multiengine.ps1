...
Write-Host "=== Multi-Engine Execution: sMSA Accounts (Legacy) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'KRB-018'
                adSuiteCheckName  = 'sMSA_Accounts_Legacy'
    ...
    $bhFile = Join-Path $bhDir "KRB-018_$bhTs.json"
    @{
