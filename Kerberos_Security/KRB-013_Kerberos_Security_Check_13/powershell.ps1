...
try {
    ...
    Write-Host "KRB-013: found $($found.Count) objects"
    ...
    Write-Warning "KRB-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-013: Query failed — $_"
}
