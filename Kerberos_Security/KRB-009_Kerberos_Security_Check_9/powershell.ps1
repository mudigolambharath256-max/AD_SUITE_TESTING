...
try {
    ...
    Write-Host "KRB-009: found $($found.Count) objects"
    ...
    Write-Warning "KRB-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-009: Query failed — $_"
}
