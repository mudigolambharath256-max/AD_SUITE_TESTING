...
# Check: Kerberos Security Check 9
...
Write-Host "=== Kerberos Security Check 9 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "KRB-009 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "KRB-009 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "KRB-009 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== KRB-009: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "KRB-009_results.csv"
$uniqueResults |
