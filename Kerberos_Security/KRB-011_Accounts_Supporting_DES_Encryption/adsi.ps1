...
(@('name', 'distinguishedName', 'samAccountName', 'msDS-SupportedEncryptionTypes', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-011_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts Supporting DES Encryption
# Category: Kerberos Security
# Severity: high
# ID: KRB-011
# Requirements: None
