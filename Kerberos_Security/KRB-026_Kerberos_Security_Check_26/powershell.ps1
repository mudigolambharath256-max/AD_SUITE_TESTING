...
try {
    ...
    Write-Host "KRB-026: found $($found.Count) objects"
    ...
    Write-Warning "KRB-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-026: Query failed : $_"
}
