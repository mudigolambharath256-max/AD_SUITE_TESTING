...
$ldapFilter = '(&(objectClass=user)(servicePrincipalName=*)(!(cn=krbtgt)))'
...
try {
    ...
    Write-Host "KRB-004: found $($found.Count) objects"
    ...
    Write-Warning "KRB-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-004: Query failed — $_"
}
