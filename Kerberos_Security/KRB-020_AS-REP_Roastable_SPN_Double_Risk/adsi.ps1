...
@('name', 'distinguishedName', 'samAccountName', 'servicePrincipalName', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-020_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: AS-REP Roastable + SPN (Double Risk)
# Category: Kerberos Security
# Severity: critical
# ID: KRB-020
# Requirements: None
