# ============================================================================
# KRB-045: Protected Users Group Not Used - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[KRB-045] Protected Users Group Not Used" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'KRB-045'
                adSuiteCheckName  = 'Protected_Users_Group_Not_Used'
    ...
    $bhFile = Join-Path $bhDir "KRB-045_$bhTs.json"
    @{
