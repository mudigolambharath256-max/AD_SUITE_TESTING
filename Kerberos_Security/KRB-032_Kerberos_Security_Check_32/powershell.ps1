...
try {
    ...
    Write-Host "KRB-032: found $($found.Count) objects"
    ...
    Write-Warning "KRB-032: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-032: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-032: Query failed : $_"
}
