...
Write-Host "=== Multi-Engine Execution: SPN Duplicates Check (Computers) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'KRB-028'
                adSuiteCheckName  = 'SPN_Duplicates_Check_Computers'
    ...
    $bhFile = Join-Path $bhDir "KRB-028_$bhTs.json"
    @{
