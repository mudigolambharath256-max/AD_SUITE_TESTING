...
try {
    ...
    Write-Host "KRB-039: found $($found.Count) objects"
    ...
    Write-Warning "KRB-039: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-039: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-039: Query failed : $_"
}
