...
try {
    ...
    Write-Host "KRB-018: found $($found.Count) objects"
    ...
    Write-Warning "KRB-018: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-018: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-018: Query failed — $_"
}
