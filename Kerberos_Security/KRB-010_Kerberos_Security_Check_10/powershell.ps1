...
try {
    ...
    Write-Host "KRB-010: found $($found.Count) objects"
    ...
    Write-Warning "KRB-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-010: Query failed — $_"
}
