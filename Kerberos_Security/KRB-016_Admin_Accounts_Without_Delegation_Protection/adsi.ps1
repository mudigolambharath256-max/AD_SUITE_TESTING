...
(@('name', 'distinguishedName', 'samAccountName', 'userAccountControl', 'memberOf', 'adminCount', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "KRB-016_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Admin Accounts Without Delegation Protection
# Category: Kerberos Security
# Severity: high
# ID: KRB-016
# Requirements: None
