...
try {
    ...
    Write-Host "KRB-031: found $($found.Count) objects"
    ...
    Write-Warning "KRB-031: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-031: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-031: Query failed : $_"
}
