...
try {
    ...
    Write-Host "KRB-011: found $($found.Count) objects"
    ...
    Write-Warning "KRB-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-011: Query failed — $_"
}
