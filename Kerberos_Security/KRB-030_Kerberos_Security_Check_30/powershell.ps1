...
try {
    ...
    Write-Host "KRB-030: found $($found.Count) objects"
    ...
    Write-Warning "KRB-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-030: Query failed — $_"
}
