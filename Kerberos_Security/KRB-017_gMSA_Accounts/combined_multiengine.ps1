...
Write-Host "=== Multi-Engine Execution: gMSA Accounts ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'KRB-017'
                adSuiteCheckName  = 'gMSA_Accounts'
    ...
    $bhFile = Join-Path $bhDir "KRB-017_$bhTs.json"
    @{
