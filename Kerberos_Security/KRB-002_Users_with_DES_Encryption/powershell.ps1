...
$ldapFilter = '(&(objectClass=user)(userAccountControl:1.2.840.113556.1.4.803:=2097152))'
...
try {
    ...
    Write-Host "KRB-002: found $($found.Count) objects"
    ...
    Write-Warning "KRB-002: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-002: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-002: Query failed : $_"
}
