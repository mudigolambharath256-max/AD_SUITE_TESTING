...
try {
    ...
    Write-Host "KRB-028: found $($found.Count) objects"
    ...
    Write-Warning "KRB-028: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-028: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-028: Query failed : $_"
}
