...
try {
    ...
    Write-Host "KRB-042: found $($found.Count) objects"
    ...
    Write-Warning "KRB-042: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-042: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-042: Query failed : $_"
}
