...
try {
    ...
    Write-Host "KRB-029: found $($found.Count) objects"
    ...
    Write-Warning "KRB-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-029: Query failed — $_"
}
