...
try {
    ...
    Write-Host "KRB-050: found $($found.Count) objects"
    ...
    Write-Warning "KRB-050: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-050: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-050: Query failed : $_"
}
