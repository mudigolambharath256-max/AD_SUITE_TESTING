...
try {
    ...
    Write-Host "KRB-015: found $($found.Count) objects"
    ...
    Write-Warning "KRB-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "KRB-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "KRB-015: Query failed — $_"
}
