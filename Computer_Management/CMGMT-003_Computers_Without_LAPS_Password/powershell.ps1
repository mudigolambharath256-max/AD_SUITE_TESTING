...
$ldapFilter = '(&(objectCategory=computer)(!(ms-Mcs-AdmPwdExpirationTime=*))(!(userAccountControl:1.2.840.113556.1.4.803:=2)))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers Without LAPS Password" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-003" -ForegroundColor Gray
