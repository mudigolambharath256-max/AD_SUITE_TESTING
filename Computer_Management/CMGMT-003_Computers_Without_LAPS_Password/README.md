...
## Overview
This security check performs analysis for: **Computers Without LAPS Password**
...
## Description
This check queries Active Directory to identify objects related to Computers Without LAPS Password. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-003.exe csharp.cs
CMGMT-003.exe
```
...
- **CheckID**: The check identifier (CMGMT-003)
- **CheckName**: The check name (Computers Without LAPS Password)
- **Name**: Object name
