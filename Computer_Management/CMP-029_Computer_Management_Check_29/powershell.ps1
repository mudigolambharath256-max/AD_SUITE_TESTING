...
try {
    ...
    Write-Host "CMP-029: found $($found.Count) objects"
    ...
    Write-Warning "CMP-029: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-029: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-029: Query failed : $_"
}
