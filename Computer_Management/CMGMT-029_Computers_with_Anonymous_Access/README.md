# CMGMT-029: Computers with Anonymous Access

## Overview
This security check performs analysis for: **Computers with Anonymous Access**
...
## Description
This check queries Active Directory to identify objects related to Computers with Anonymous Access. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-029.exe csharp.cs
CMGMT-029.exe
```
...
- **CheckID**: The check identifier (CMGMT-029)
- **CheckName**: The check name (Computers with Anonymous Access)
- **Name**: Object name
