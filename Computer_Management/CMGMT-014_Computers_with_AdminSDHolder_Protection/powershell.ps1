...
$ldapFilter = '(&(objectCategory=computer)(adminCount=1))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with AdminSDHolder Protection" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-014" -ForegroundColor Gray
