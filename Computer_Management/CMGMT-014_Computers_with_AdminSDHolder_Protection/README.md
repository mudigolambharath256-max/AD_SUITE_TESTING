...
## Overview
This security check performs analysis for: **Computers with AdminSDHolder Protection**
...
## Description
This check queries Active Directory to identify objects related to Computers with AdminSDHolder Protection. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-014.exe csharp.cs
CMGMT-014.exe
```
...
- **CheckID**: The check identifier (CMGMT-014)
- **CheckName**: The check name (Computers with AdminSDHolder Protection)
- **Name**: Object name
