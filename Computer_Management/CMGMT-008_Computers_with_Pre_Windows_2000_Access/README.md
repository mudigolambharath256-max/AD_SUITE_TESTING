...
## Overview
This security check performs analysis for: **Computers with Pre Windows 2000 Access**
...
## Description
This check queries Active Directory to identify objects related to Computers with Pre Windows 2000 Access. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-008.exe csharp.cs
CMGMT-008.exe
```
...
- **CheckID**: The check identifier (CMGMT-008)
- **CheckName**: The check name (Computers with Pre Windows 2000 Access)
- **Name**: Object name
