...
$ldapFilter = '(&(objectCategory=computer)(operatingSystem=Windows*2000*))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with Pre Windows 2000 Access" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-008" -ForegroundColor Gray
