...
try {
    ...
    Write-Host "CMP-047: found $($found.Count) objects"
    ...
    Write-Warning "CMP-047: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-047: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-047: Query failed : $_"
}
