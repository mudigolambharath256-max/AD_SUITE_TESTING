...
try {
    ...
    Write-Host "CMP-033: found $($found.Count) objects"
    ...
    Write-Warning "CMP-033: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-033: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-033: Query failed : $_"
}
