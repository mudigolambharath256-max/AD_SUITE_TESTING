...
## Overview
This security check performs analysis for: **Computers with Not Delegated Flag**
...
## Description
This check queries Active Directory to identify objects related to Computers with Not Delegated Flag. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-022.exe csharp.cs
CMGMT-022.exe
```
...
- **CheckID**: The check identifier (CMGMT-022)
- **CheckName**: The check name (Computers with Not Delegated Flag)
- **Name**: Object name
