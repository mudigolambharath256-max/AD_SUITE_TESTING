...
try {
    ...
    Write-Host "CMP-049: found $($found.Count) objects"
    ...
    Write-Warning "CMP-049: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-049: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-049: Query failed — $_"
}
