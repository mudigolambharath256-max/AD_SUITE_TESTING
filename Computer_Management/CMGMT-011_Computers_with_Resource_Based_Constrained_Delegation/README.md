...
## Overview
This security check performs analysis for: **Computers with Resource Based Constrained Delegation**
...
## Description
This check queries Active Directory to identify objects related to Computers with Resource Based Constrained Delegation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-011.exe csharp.cs
CMGMT-011.exe
```
...
- **CheckID**: The check identifier (CMGMT-011)
- **CheckName**: The check name (Computers with Resource Based Constrained Delegation)
- **Name**: Object name
...
## Related Checks
This check is part of the **Computer_Management** category. Related checks:
