...
Write-Host "Executing security check: Computers with Resource Based Constrained Delegation" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-011" -ForegroundColor Gray
