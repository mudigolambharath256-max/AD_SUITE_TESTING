# CMGMT-001: LAPS Schema Extended

## Overview
This security check performs analysis for: **LAPS Schema Extended**
...
## Description
This check queries Active Directory to identify objects related to LAPS Schema Extended. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-001.exe csharp.cs
CMGMT-001.exe
```
...
- **CheckID**: The check identifier (CMGMT-001)
- **CheckName**: The check name (LAPS Schema Extended)
- **Name**: Object name
