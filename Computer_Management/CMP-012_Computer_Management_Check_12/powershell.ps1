...
try {
    ...
    Write-Host "CMP-012: found $($found.Count) objects"
    ...
    Write-Warning "CMP-012: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-012: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-012: Query failed — $_"
}
