...
Write-Host "Found $($results.Count) objects for check: Computers with Unconstrained Delegation" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CMGMT-009_nodes.json"
