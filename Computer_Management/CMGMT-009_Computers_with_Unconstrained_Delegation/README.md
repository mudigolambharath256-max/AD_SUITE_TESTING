...
## Overview
This security check performs analysis for: **Computers with Unconstrained Delegation**
...
## Description
This check queries Active Directory to identify objects related to Computers with Unconstrained Delegation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-009.exe csharp.cs
CMGMT-009.exe
```
...
- **CheckID**: The check identifier (CMGMT-009)
- **CheckName**: The check name (Computers with Unconstrained Delegation)
- **Name**: Object name
