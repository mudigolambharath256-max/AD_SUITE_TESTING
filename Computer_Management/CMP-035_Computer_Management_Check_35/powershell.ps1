...
try {
    ...
    Write-Host "CMP-035: found $($found.Count) objects"
    ...
    Write-Warning "CMP-035: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-035: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-035: Query failed — $_"
}
