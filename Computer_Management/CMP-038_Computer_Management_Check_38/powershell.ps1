...
try {
    ...
    Write-Host "CMP-038: found $($found.Count) objects"
    ...
    Write-Warning "CMP-038: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-038: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-038: Query failed — $_"
}
