...
$ldapFilter = '(&(objectCategory=computer)(!(primaryGroupID=515)))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with Primary Group ID Not 515" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-026" -ForegroundColor Gray
