...
## Overview
This security check performs analysis for: **Computers with Primary Group ID Not 515**
...
## Description
This check queries Active Directory to identify objects related to Computers with Primary Group ID Not 515. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-026.exe csharp.cs
CMGMT-026.exe
```
...
- **CheckID**: The check identifier (CMGMT-026)
- **CheckName**: The check name (Computers with Primary Group ID Not 515)
- **Name**: Object name
