...
try {
    ...
    Write-Host "CMP-002: found $($found.Count) objects"
    ...
    Write-Warning "CMP-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-002: Query failed — $_"
}
