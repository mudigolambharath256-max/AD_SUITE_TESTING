...
try {
    ...
    Write-Host "CMP-019: found $($found.Count) objects"
    ...
    Write-Warning "CMP-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-019: Query failed : $_"
}
