...
## Overview
This security check performs analysis for: **Computers with Constrained Delegation**
...
## Description
This check queries Active Directory to identify objects related to Computers with Constrained Delegation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-010.exe csharp.cs
CMGMT-010.exe
```
...
- **CheckID**: The check identifier (CMGMT-010)
- **CheckName**: The check name (Computers with Constrained Delegation)
- **Name**: Object name
