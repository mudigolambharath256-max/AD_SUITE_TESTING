...
try {
    ...
    Write-Host "CMP-043: found $($found.Count) objects"
    ...
    Write-Warning "CMP-043: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-043: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-043: Query failed : $_"
}
