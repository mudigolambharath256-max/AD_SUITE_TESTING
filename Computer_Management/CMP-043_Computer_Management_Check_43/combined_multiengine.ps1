...
# Check: Computer Management Check 43
...
Write-Host "=== Computer Management Check 43 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "CMP-043 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "CMP-043 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "CMP-043 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== CMP-043: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "CMP-043_results.csv"
$uniqueResults |
