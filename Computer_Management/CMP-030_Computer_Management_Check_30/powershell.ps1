...
try {
    ...
    Write-Host "CMP-030: found $($found.Count) objects"
    ...
    Write-Warning "CMP-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-030: Query failed — $_"
}
