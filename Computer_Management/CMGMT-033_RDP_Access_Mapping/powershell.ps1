...
Write-Host "Executing: RDP Access Mapping" -ForegroundColor Cyan
Write-Host "Check ID: CMGMT-033" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CMGMT-033'}}, `
    @{N='CheckName'; E={'RDP Access Mapping'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1021.001'}}, `
