...
Write-Host "=== CMGMT-033: RDP Access Mapping ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'CMGMT-033'
                adSuiteCheckName  = 'RDP_Access_Mapping'
    ...
    $bhFile = Join-Path $bhDir "CMGMT-033_$bhTs.json"
    @{
