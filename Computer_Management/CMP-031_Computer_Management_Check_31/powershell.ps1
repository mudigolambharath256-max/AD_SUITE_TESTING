...
try {
    ...
    Write-Host "CMP-031: found $($found.Count) objects"
    ...
    Write-Warning "CMP-031: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-031: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-031: Query failed : $_"
}
