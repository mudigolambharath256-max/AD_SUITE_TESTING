...
try {
    ...
    Write-Host "CMP-015: found $($found.Count) objects"
    ...
    Write-Warning "CMP-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-015: Query failed — $_"
}
