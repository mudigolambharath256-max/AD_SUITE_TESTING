...
try {
    ...
    Write-Host "CMP-042: found $($found.Count) objects"
    ...
    Write-Warning "CMP-042: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-042: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-042: Query failed : $_"
}
