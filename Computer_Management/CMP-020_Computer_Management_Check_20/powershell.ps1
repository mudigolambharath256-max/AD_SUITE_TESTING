...
try {
    ...
    Write-Host "CMP-020: found $($found.Count) objects"
    ...
    Write-Warning "CMP-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-020: Query failed — $_"
}
