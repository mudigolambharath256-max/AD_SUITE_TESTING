...
## Overview
This security check performs analysis for: **Computers with Password Not Required**
...
## Description
This check queries Active Directory to identify objects related to Computers with Password Not Required. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-024.exe csharp.cs
CMGMT-024.exe
```
...
- **CheckID**: The check identifier (CMGMT-024)
- **CheckName**: The check name (Computers with Password Not Required)
- **Name**: Object name
