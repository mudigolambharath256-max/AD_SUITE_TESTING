...
try {
    ...
    Write-Host "CMP-044: found $($found.Count) objects"
    ...
    Write-Warning "CMP-044: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-044: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-044: Query failed : $_"
}
