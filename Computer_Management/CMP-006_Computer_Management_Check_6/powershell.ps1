...
try {
    ...
    Write-Host "CMP-006: found $($found.Count) objects"
    ...
    Write-Warning "CMP-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-006: Query failed : $_"
}
