...
## Overview
This security check performs analysis for: **Computers with SID History**
...
## Description
This check queries Active Directory to identify objects related to Computers with SID History. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-027.exe csharp.cs
CMGMT-027.exe
```
...
- **CheckID**: The check identifier (CMGMT-027)
- **CheckName**: The check name (Computers with SID History)
- **Name**: Object name
