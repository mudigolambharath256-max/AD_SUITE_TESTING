...
# Check: Computer Management Check 16
...
Write-Host "=== Computer Management Check 16 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "CMP-016 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "CMP-016 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "CMP-016 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== CMP-016: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "CMP-016_results.csv"
$uniqueResults |
