...
try {
    ...
    Write-Host "CMP-016: found $($found.Count) objects"
    ...
    Write-Warning "CMP-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-016: Query failed — $_"
}
