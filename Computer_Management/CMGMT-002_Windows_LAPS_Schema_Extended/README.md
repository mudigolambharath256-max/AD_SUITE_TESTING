# CMGMT-002: Windows LAPS Schema Extended

## Overview
This security check performs analysis for: **Windows LAPS Schema Extended**
...
## Description
This check queries Active Directory to identify objects related to Windows LAPS Schema Extended. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-002.exe csharp.cs
CMGMT-002.exe
```
...
- **CheckID**: The check identifier (CMGMT-002)
- **CheckName**: The check name (Windows LAPS Schema Extended)
- **Name**: Object name
