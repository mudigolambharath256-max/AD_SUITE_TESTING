...
try {
    ...
    Write-Host "CMP-014: found $($found.Count) objects"
    ...
    Write-Warning "CMP-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-014: Query failed — $_"
}
