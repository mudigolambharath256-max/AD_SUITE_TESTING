...
try {
    ...
    Write-Host "CMP-026: found $($found.Count) objects"
    ...
    Write-Warning "CMP-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-026: Query failed : $_"
}
