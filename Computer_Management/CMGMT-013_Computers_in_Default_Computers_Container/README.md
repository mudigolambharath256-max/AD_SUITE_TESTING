# CMGMT-013: Computers in Default Computers Container

## Overview
This security check performs analysis for: **Computers in Default Computers Container**
...
## Description
This check queries Active Directory to identify objects related to Computers in Default Computers Container. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-013.exe csharp.cs
CMGMT-013.exe
```
...
- **CheckID**: The check identifier (CMGMT-013)
- **CheckName**: The check name (Computers in Default Computers Container)
- **Name**: Object name
