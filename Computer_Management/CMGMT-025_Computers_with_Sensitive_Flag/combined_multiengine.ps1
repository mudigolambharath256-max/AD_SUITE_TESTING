# ============================================================================
# CMGMT-025: Computers with Sensitive Flag
# ============================================================================
...
Write-Host "=== CMGMT-025: Computers with Sensitive Flag ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'CMGMT-025'}}, `
            @{N='CheckName'; E={'Computers with Sensitive Flag'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'CMGMT-025'
                CheckName         = 'Computers with Sensitive Flag'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'CMGMT-025'
                adSuiteCheckName  = 'Computers_with_Sensitive_Flag'
    ...
    $bhFile = Join-Path $bhDir "CMGMT-025_$bhTs.json"
    @{
