...
## Overview
This security check performs analysis for: **Computers with Sensitive Flag**
...
## Description
This check queries Active Directory to identify objects related to Computers with Sensitive Flag. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-025.exe csharp.cs
CMGMT-025.exe
```
...
- **CheckID**: The check identifier (CMGMT-025)
- **CheckName**: The check name (Computers with Sensitive Flag)
- **Name**: Object name
