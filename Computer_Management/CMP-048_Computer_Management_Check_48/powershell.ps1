...
try {
    ...
    Write-Host "CMP-048: found $($found.Count) objects"
    ...
    Write-Warning "CMP-048: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-048: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-048: Query failed — $_"
}
