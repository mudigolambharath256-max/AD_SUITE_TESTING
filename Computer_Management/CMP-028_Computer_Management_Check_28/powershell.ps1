...
try {
    ...
    Write-Host "CMP-028: found $($found.Count) objects"
    ...
    Write-Warning "CMP-028: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-028: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-028: Query failed — $_"
}
