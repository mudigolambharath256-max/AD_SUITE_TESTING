...
Write-Host "Executing: Computers Without LAPS" -ForegroundColor Cyan
Write-Host "Check ID: CMGMT-035" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(&(objectCategory=computer)(!(userAccountControl:1.2.840.113556.1.4.803:=2))(!(ms-Mcs-AdmPwd=*)))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CMGMT-035'}}, `
    @{N='CheckName'; E={'Computers Without LAPS'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1003.002'}}, `
