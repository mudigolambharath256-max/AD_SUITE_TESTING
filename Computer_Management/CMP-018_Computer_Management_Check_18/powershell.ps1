...
try {
    ...
    Write-Host "CMP-018: found $($found.Count) objects"
    ...
    Write-Warning "CMP-018: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-018: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-018: Query failed — $_"
}
