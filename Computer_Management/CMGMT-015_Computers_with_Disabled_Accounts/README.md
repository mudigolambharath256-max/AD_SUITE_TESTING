...
## Overview
This security check performs analysis for: **Computers with Disabled Accounts**
...
## Description
This check queries Active Directory to identify objects related to Computers with Disabled Accounts. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-015.exe csharp.cs
CMGMT-015.exe
```
...
- **CheckID**: The check identifier (CMGMT-015)
- **CheckName**: The check name (Computers with Disabled Accounts)
- **Name**: Object name
