...
try {
    ...
    Write-Host "CMP-040: found $($found.Count) objects"
    ...
    Write-Warning "CMP-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-040: Query failed : $_"
}
