...
try {
    ...
    Write-Host "CMP-011: found $($found.Count) objects"
    ...
    Write-Warning "CMP-011: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-011: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-011: Query failed : $_"
}
