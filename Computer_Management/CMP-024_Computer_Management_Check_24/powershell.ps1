...
try {
    ...
    Write-Host "CMP-024: found $($found.Count) objects"
    ...
    Write-Warning "CMP-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-024: Query failed : $_"
}
