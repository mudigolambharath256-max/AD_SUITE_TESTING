...
## Overview
This security check performs analysis for: **Computers with Smartcard Required**
...
## Description
This check queries Active Directory to identify objects related to Computers with Smartcard Required. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-023.exe csharp.cs
CMGMT-023.exe
```
...
- **CheckID**: The check identifier (CMGMT-023)
- **CheckName**: The check name (Computers with Smartcard Required)
- **Name**: Object name
