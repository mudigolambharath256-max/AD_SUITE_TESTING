...
try {
    ...
    Write-Host "CMP-008: found $($found.Count) objects"
    ...
    Write-Warning "CMP-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-008: Query failed — $_"
}
