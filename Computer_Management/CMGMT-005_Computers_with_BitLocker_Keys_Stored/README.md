# CMGMT-005: Computers with BitLocker Keys Stored

## Overview
This security check performs analysis for: **Computers with BitLocker Keys Stored**
...
## Description
This check queries Active Directory to identify objects related to Computers with BitLocker Keys Stored. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-005.exe csharp.cs
CMGMT-005.exe
```
...
- **CheckID**: The check identifier (CMGMT-005)
- **CheckName**: The check name (Computers with BitLocker Keys Stored)
- **Name**: Object name
