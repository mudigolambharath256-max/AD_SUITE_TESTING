...
Write-Host "=== CMGMT-031: Local Admin Rights Mapping ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'CMGMT-031'
                adSuiteCheckName  = 'Local_Admin_Rights_Mapping'
    ...
    $bhFile = Join-Path $bhDir "CMGMT-031_$bhTs.json"
    @{
