...
Write-Host "Executing: Local Admin Rights Mapping" -ForegroundColor Cyan
Write-Host "Check ID: CMGMT-031" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CMGMT-031'}}, `
    @{N='CheckName'; E={'Local Admin Rights Mapping'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1078.003'}}, `
