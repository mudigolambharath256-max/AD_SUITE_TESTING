...
Write-Host "Found $($results.Count) objects for check: Computers with Trusted for Delegation" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "CMGMT-021_nodes.json"
