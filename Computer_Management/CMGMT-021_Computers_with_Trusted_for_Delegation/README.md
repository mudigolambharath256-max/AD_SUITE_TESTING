...
## Overview
This security check performs analysis for: **Computers with Trusted for Delegation**
...
## Description
This check queries Active Directory to identify objects related to Computers with Trusted for Delegation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-021.exe csharp.cs
CMGMT-021.exe
```
...
- **CheckID**: The check identifier (CMGMT-021)
- **CheckName**: The check name (Computers with Trusted for Delegation)
- **Name**: Object name
