...
try {
    ...
    Write-Host "CMP-017: found $($found.Count) objects"
    ...
    Write-Warning "CMP-017: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-017: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-017: Query failed : $_"
}
