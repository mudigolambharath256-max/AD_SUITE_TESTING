# CMGMT-030: Computers with Legacy Operating Systems

## Overview
This security check performs analysis for: **Computers with Legacy Operating Systems**
...
## Description
This check queries Active Directory to identify objects related to Computers with Legacy Operating Systems. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-030.exe csharp.cs
CMGMT-030.exe
```
...
- **CheckID**: The check identifier (CMGMT-030)
- **CheckName**: The check name (Computers with Legacy Operating Systems)
- **Name**: Object name
