...
$ldapFilter = '(&(objectCategory=computer)(operatingSystem=*))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with Legacy Operating Systems" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-030" -ForegroundColor Gray
