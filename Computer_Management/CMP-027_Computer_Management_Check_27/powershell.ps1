...
try {
    ...
    Write-Host "CMP-027: found $($found.Count) objects"
    ...
    Write-Warning "CMP-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-027: Query failed : $_"
}
