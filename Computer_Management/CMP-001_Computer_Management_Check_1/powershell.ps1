...
try {
    ...
    Write-Host "CMP-001: found $($found.Count) objects"
    ...
    Write-Warning "CMP-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-001: Query failed — $_"
}
