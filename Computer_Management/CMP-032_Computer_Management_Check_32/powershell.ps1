...
try {
    ...
    Write-Host "CMP-032: found $($found.Count) objects"
    ...
    Write-Warning "CMP-032: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-032: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-032: Query failed — $_"
}
