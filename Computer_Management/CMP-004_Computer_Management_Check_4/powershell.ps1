...
try {
    ...
    Write-Host "CMP-004: found $($found.Count) objects"
    ...
    Write-Warning "CMP-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-004: Query failed : $_"
}
