...
$ldapFilter = '(&(objectCategory=computer)(servicePrincipalName=*))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with Duplicate SPNs" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-012" -ForegroundColor Gray
