...
## Overview
This security check performs analysis for: **Computers with Duplicate SPNs**
...
## Description
This check queries Active Directory to identify objects related to Computers with Duplicate SPNs. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-012.exe csharp.cs
CMGMT-012.exe
```
...
- **CheckID**: The check identifier (CMGMT-012)
- **CheckName**: The check name (Computers with Duplicate SPNs)
- **Name**: Object name
