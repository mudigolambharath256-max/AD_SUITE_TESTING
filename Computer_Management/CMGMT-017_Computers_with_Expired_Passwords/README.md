# CMGMT-017: Computers with Expired Passwords

## Overview
This security check performs analysis for: **Computers with Expired Passwords**
...
## Description
This check queries Active Directory to identify objects related to Computers with Expired Passwords. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-017.exe csharp.cs
CMGMT-017.exe
```
...
- **CheckID**: The check identifier (CMGMT-017)
- **CheckName**: The check name (Computers with Expired Passwords)
- **Name**: Object name
