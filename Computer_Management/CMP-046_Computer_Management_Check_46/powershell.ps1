...
try {
    ...
    Write-Host "CMP-046: found $($found.Count) objects"
    ...
    Write-Warning "CMP-046: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-046: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-046: Query failed — $_"
}
