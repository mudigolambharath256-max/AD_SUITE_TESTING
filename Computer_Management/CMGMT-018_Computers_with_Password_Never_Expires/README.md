...
## Overview
This security check performs analysis for: **Computers with Password Never Expires**
...
## Description
This check queries Active Directory to identify objects related to Computers with Password Never Expires. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-018.exe csharp.cs
CMGMT-018.exe
```
...
- **CheckID**: The check identifier (CMGMT-018)
- **CheckName**: The check name (Computers with Password Never Expires)
- **Name**: Object name
