...
try {
    ...
    Write-Host "CMP-007: found $($found.Count) objects"
    ...
    Write-Warning "CMP-007: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-007: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-007: Query failed : $_"
}
