...
try {
    ...
    Write-Host "CMP-039: found $($found.Count) objects"
    ...
    Write-Warning "CMP-039: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-039: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-039: Query failed — $_"
}
