...
## Overview
This security check performs analysis for: **Computers with Reversible Encryption**
...
## Description
This check queries Active Directory to identify objects related to Computers with Reversible Encryption. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-019.exe csharp.cs
CMGMT-019.exe
```
...
- **CheckID**: The check identifier (CMGMT-019)
- **CheckName**: The check name (Computers with Reversible Encryption)
- **Name**: Object name
