...
try {
    ...
    Write-Host "CMP-022: found $($found.Count) objects"
    ...
    Write-Warning "CMP-022: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-022: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-022: Query failed — $_"
}
