...
try {
    ...
    Write-Host "CMP-005: found $($found.Count) objects"
    ...
    Write-Warning "CMP-005: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-005: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-005: Query failed : $_"
}
