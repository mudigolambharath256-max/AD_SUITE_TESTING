...
$ldapFilter = '(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=4194304))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with Weak Encryption" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-007" -ForegroundColor Gray
