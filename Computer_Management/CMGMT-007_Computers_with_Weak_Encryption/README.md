...
## Overview
This security check performs analysis for: **Computers with Weak Encryption**
...
## Description
This check queries Active Directory to identify objects related to Computers with Weak Encryption. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-007.exe csharp.cs
CMGMT-007.exe
```
...
- **CheckID**: The check identifier (CMGMT-007)
- **CheckName**: The check name (Computers with Weak Encryption)
- **Name**: Object name
