# CMGMT-016: Computers Never Logged On

## Overview
This security check performs analysis for: **Computers Never Logged On**
...
## Description
This check queries Active Directory to identify objects related to Computers Never Logged On. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-016.exe csharp.cs
CMGMT-016.exe
```
...
- **CheckID**: The check identifier (CMGMT-016)
- **CheckName**: The check name (Computers Never Logged On)
- **Name**: Object name
