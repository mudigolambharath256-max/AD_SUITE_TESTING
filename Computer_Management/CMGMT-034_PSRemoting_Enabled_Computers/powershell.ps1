...
Write-Host "Executing: PSRemoting Enabled Computers" -ForegroundColor Cyan
Write-Host "Check ID: CMGMT-034" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CMGMT-034'}}, `
    @{N='CheckName'; E={'PSRemoting Enabled Computers'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1021.006'}}, `
