...
## Overview
This security check performs analysis for: **Computers with LAPS Inventory**
...
## Description
This check queries Active Directory to identify objects related to Computers with LAPS Inventory. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-004.exe csharp.cs
CMGMT-004.exe
```
...
- **CheckID**: The check identifier (CMGMT-004)
- **CheckName**: The check name (Computers with LAPS Inventory)
- **Name**: Object name
