# ============================================================================
# CMGMT-004: Computers with LAPS Inventory
# ============================================================================
...
Write-Host "=== CMGMT-004: Computers with LAPS Inventory ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'CMGMT-004'}}, `
            @{N='CheckName'; E={'Computers with LAPS Inventory'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'CMGMT-004'
                CheckName         = 'Computers with LAPS Inventory'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'CMGMT-004'
                adSuiteCheckName  = 'Computers_with_LAPS_Inventory'
    ...
    $bhFile = Join-Path $bhDir "CMGMT-004_$bhTs.json"
    @{
