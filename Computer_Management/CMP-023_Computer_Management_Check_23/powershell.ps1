...
try {
    ...
    Write-Host "CMP-023: found $($found.Count) objects"
    ...
    Write-Warning "CMP-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-023: Query failed : $_"
}
