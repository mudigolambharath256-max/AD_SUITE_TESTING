...
Write-Host "Executing: LAPS Passwords Expiring Soon" -ForegroundColor Cyan
Write-Host "Check ID: CMGMT-036" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'CMGMT-036'}}, `
    @{N='CheckName'; E={'LAPS Passwords Expiring Soon'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1003.002'}}, `
