...
try {
    ...
    Write-Host "CMP-050: found $($found.Count) objects"
    ...
    Write-Warning "CMP-050: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-050: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-050: Query failed — $_"
}
