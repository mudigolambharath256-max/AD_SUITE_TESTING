...
try {
    ...
    Write-Host "CMP-003: found $($found.Count) objects"
    ...
    Write-Warning "CMP-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-003: Query failed : $_"
}
