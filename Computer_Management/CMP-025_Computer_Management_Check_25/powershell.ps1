...
try {
    ...
    Write-Host "CMP-025: found $($found.Count) objects"
    ...
    Write-Warning "CMP-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-025: Query failed : $_"
}
