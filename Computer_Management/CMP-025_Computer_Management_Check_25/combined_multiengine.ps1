...
# Check: Computer Management Check 25
...
Write-Host "=== Computer Management Check 25 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "CMP-025 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "CMP-025 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "CMP-025 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== CMP-025: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "CMP-025_results.csv"
$uniqueResults |
