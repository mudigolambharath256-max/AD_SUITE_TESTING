...
## Overview
This security check performs analysis for: **Computers with Stale Passwords**
...
## Description
This check queries Active Directory to identify objects related to Computers with Stale Passwords. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (CMGMT-006)
- **CheckName**: The check name (Computers with Stale Passwords)
- **Name**: Object name
