...
try {
    ...
    Write-Host "CMP-021: found $($found.Count) objects"
    ...
    Write-Warning "CMP-021: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-021: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-021: Query failed — $_"
}
