...
try {
    ...
    Write-Host "CMP-010: found $($found.Count) objects"
    ...
    Write-Warning "CMP-010: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-010: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-010: Query failed — $_"
}
