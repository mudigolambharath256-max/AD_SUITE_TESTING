# CMGMT-028: Computers with Null Sessions Allowed

## Overview
This security check performs analysis for: **Computers with Null Sessions Allowed**
...
## Description
This check queries Active Directory to identify objects related to Computers with Null Sessions Allowed. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-028.exe csharp.cs
CMGMT-028.exe
```
...
- **CheckID**: The check identifier (CMGMT-028)
- **CheckName**: The check name (Computers with Null Sessions Allowed)
- **Name**: Object name
