...
try {
    ...
    Write-Host "CMP-013: found $($found.Count) objects"
    ...
    Write-Warning "CMP-013: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-013: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-013: Query failed : $_"
}
