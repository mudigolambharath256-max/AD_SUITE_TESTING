...
try {
    ...
    Write-Host "CMP-037: found $($found.Count) objects"
    ...
    Write-Warning "CMP-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-037: Query failed : $_"
}
