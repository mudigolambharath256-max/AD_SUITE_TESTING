...
# Check: Computer Management Check 37
...
Write-Host "=== Computer Management Check 37 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "CMP-037 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "CMP-037 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "CMP-037 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== CMP-037: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "CMP-037_results.csv"
$uniqueResults |
