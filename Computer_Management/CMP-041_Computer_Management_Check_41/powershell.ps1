...
try {
    ...
    Write-Host "CMP-041: found $($found.Count) objects"
    ...
    Write-Warning "CMP-041: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-041: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-041: Query failed — $_"
}
