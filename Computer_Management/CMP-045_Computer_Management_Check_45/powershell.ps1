...
try {
    ...
    Write-Host "CMP-045: found $($found.Count) objects"
    ...
    Write-Warning "CMP-045: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-045: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-045: Query failed — $_"
}
