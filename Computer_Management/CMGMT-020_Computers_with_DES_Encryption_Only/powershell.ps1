...
$ldapFilter = '(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=2097152))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Computers with DES Encryption Only" -ForegroundColor Yellow
Write-Host "Check ID: CMGMT-020" -ForegroundColor Gray
