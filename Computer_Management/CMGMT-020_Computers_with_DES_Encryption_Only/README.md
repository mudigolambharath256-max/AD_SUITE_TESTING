...
## Overview
This security check performs analysis for: **Computers with DES Encryption Only**
...
## Description
This check queries Active Directory to identify objects related to Computers with DES Encryption Only. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:CMGMT-020.exe csharp.cs
CMGMT-020.exe
```
...
- **CheckID**: The check identifier (CMGMT-020)
- **CheckName**: The check name (Computers with DES Encryption Only)
- **Name**: Object name
