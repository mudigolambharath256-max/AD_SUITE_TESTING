...
try {
    ...
    Write-Host "CMP-036: found $($found.Count) objects"
    ...
    Write-Warning "CMP-036: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "CMP-036: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "CMP-036: Query failed — $_"
}
