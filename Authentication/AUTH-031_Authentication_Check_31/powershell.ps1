...
try {
    ...
    Write-Host "AUTH-031: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-031: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-031: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-031: Query failed — $_"
}
