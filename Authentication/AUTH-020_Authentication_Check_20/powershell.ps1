...
try {
    ...
    Write-Host "AUTH-020: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-020: Query failed — $_"
}
