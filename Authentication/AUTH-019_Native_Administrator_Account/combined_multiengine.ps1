...
Write-Host "=== Multi-Engine Execution: Native Administrator Account ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AUTH-019'
                adSuiteCheckName  = 'Native_Administrator_Account'
    ...
    $bhFile = Join-Path $bhDir "AUTH-019_$bhTs.json"
    @{
