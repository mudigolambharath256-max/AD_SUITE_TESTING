...
try {
    ...
    Write-Host "AUTH-023: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-023: Query failed : $_"
}
