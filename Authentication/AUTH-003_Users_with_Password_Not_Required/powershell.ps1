...
$ldapFilter = '(&(objectClass=user)(userAccountControl:1.2.840.113556.1.4.803:=32))'
...
try {
    ...
    Write-Host "AUTH-003: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-003: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-003: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-003: Query failed — $_"
}
