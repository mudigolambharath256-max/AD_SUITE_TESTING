...
Write-Host "=== Multi-Engine Execution: Service Accounts (SPN Set) ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AUTH-008'
                adSuiteCheckName  = 'Service_Accounts_SPN_Set'
    ...
    $bhFile = Join-Path $bhDir "AUTH-008_$bhTs.json"
    @{
