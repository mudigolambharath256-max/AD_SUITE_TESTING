...
@('name', 'distinguishedName', 'cn', 'msDS-AuthNPolicySiloEnforced', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-028_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Authentication Policy Silos
# Category: Authentication
# Severity: info
# ID: AUTH-028
# Requirements: None
