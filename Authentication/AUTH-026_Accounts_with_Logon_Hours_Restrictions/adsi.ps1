...
(@('name', 'distinguishedName', 'samAccountName', 'logonHours', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-026_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Logon Hours Restrictions
# Category: Authentication
# Severity: info
# ID: AUTH-026
# Requirements: None
