...
$ldapFilter = '(&(objectClass=user)(userAccountControl:1.2.840.113556.1.4.803:=128))'
...
try {
    ...
    Write-Host "AUTH-002: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-002: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-002: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-002: Query failed : $_"
}
