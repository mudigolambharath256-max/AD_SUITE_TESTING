...
try {
    ...
    Write-Host "AUTH-022: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-022: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-022: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-022: Query failed — $_"
}
