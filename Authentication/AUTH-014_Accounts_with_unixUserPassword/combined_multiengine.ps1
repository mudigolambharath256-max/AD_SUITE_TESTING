...
Write-Host "=== Multi-Engine Execution: Accounts with unixUserPassword ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AUTH-014'
                adSuiteCheckName  = 'Accounts_with_unixUserPassword'
    ...
    $bhFile = Join-Path $bhDir "AUTH-014_$bhTs.json"
    @{
