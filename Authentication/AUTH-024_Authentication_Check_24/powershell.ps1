...
try {
    ...
    Write-Host "AUTH-024: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-024: Query failed : $_"
}
