...
try {
    ...
    Write-Host "AUTH-018: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-018: Query failed : $_"
}
