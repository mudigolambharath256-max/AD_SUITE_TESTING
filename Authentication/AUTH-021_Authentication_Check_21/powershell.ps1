...
try {
    ...
    Write-Host "AUTH-021: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-021: Query failed : $_"
}
