...
try {
    ...
    Write-Host "AUTH-028: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-028: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-028: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-028: Query failed : $_"
}
