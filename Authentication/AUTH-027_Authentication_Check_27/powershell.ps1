...
try {
    ...
    Write-Host "AUTH-027: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-027: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-027: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-027: Query failed — $_"
}
