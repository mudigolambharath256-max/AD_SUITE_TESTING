...
(@('name', 'distinguishedName', 'samAccountName', 'profilePath', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-024_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Profile Paths
# Category: Authentication
# Severity: info
# ID: AUTH-024
# Requirements: None
