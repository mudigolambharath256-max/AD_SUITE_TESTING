...
(@('name', 'distinguishedName', 'samAccountName', 'userWorkstations', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-025_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Workstation Restrictions
# Category: Authentication
# Severity: info
# ID: AUTH-025
# Requirements: None
