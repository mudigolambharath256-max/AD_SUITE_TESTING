...
@('name', 'distinguishedName', 'samAccountName', 'msDS-ManagedPasswordInterval', 'msDS-HostServiceAccount', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-015_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: gMSA Accounts (Best Practice)
# Category: Authentication
# Severity: info
# ID: AUTH-015
# Requirements: None
