...
try {
    ...
    Write-Host "AUTH-016: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-016: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-016: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-016: Query failed : $_"
}
