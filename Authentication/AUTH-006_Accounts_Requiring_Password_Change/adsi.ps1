...
(@('name', 'distinguishedName', 'samAccountName', 'pwdLastSet', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-006_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts Requiring Password Change
# Category: Authentication
# Severity: low
# ID: AUTH-006
# Requirements: None
