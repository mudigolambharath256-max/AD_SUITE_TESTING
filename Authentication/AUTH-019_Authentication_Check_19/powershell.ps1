...
try {
    ...
    Write-Host "AUTH-019: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-019: Query failed : $_"
}
