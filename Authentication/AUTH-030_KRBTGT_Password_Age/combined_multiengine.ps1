...
Write-Host "=== Multi-Engine Execution: KRBTGT Password Age ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $bhFile = Join-Path $bhDir "AUTH-030_$bhTs.json"
    @{
