...
@('name', 'distinguishedName', 'samAccountName', 'pwdLastSet', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-030_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: KRBTGT Password Age
# Category: Authentication
# Severity: high
# ID: AUTH-030
# Requirements: None
