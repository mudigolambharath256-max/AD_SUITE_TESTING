...
try {
    ...
    Write-Host "AUTH-032: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-032: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-032: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-032: Query failed — $_"
}
