...
try {
    ...
    Write-Host "AUTH-008: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-008: Query failed — $_"
}
