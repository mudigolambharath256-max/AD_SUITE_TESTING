...
try {
    ...
    Write-Host "AUTH-010: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-010: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-010: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-010: Query failed : $_"
}
