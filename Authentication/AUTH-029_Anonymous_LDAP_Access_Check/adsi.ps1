...
@('name', 'distinguishedName', 'dSHeuristics', 'objectSid', 'samAccountName') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-029_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Anonymous LDAP Access Check
# Category: Authentication
# Severity: high
# ID: AUTH-029
# Requirements: None
