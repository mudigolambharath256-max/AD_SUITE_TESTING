...
try {
    ...
    Write-Host "AUTH-006: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-006: Query failed — $_"
}
