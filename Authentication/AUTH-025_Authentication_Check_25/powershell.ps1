...
try {
    ...
    Write-Host "AUTH-025: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-025: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-025: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-025: Query failed — $_"
}
