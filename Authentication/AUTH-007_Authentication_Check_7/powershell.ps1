...
try {
    ...
    Write-Host "AUTH-007: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-007: Query failed — $_"
}
