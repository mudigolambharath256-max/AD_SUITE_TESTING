...
try {
    ...
    Write-Host "AUTH-011: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-011: Query failed — $_"
}
