...
try {
    ...
    Write-Host "AUTH-030: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-030: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-030: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-030: Query failed : $_"
}
