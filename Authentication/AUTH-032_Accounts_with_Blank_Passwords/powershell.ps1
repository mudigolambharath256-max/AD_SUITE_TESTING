...
Write-Host "Executing: Accounts with Blank Passwords" -ForegroundColor Cyan
Write-Host "Check ID: AUTH-032" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'AUTH-032'}}, `
    @{N='CheckName'; E={'Accounts with Blank Passwords'}}, `
    @{N='RiskScore'; E={10}}, `
