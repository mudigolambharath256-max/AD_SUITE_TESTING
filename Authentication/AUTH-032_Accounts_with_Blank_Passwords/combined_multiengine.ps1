...
Write-Host "=== AUTH-032: Accounts with Blank Passwords ===" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AUTH-032'
                adSuiteCheckName  = 'Accounts_with_Blank_Passwords'
    ...
    $bhFile = Join-Path $bhDir "AUTH-032_$bhTs.json"
    @{
