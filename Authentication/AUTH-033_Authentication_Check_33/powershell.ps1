...
try {
    ...
    Write-Host "AUTH-033: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-033: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-033: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-033: Query failed — $_"
}
