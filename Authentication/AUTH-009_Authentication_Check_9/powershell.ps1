...
try {
    ...
    Write-Host "AUTH-009: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-009: Query failed — $_"
}
