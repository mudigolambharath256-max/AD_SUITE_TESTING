...
try {
    ...
    Write-Host "AUTH-012: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-012: Query failed : $_"
}
