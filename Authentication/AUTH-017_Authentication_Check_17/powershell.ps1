...
try {
    ...
    Write-Host "AUTH-017: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-017: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-017: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-017: Query failed : $_"
}
