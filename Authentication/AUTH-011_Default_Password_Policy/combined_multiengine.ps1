...
Write-Host "=== Multi-Engine Execution: Default Password Policy ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'AUTH-011'
                adSuiteCheckName  = 'Default_Password_Policy'
    ...
    $bhFile = Join-Path $bhDir "AUTH-011_$bhTs.json"
    @{
