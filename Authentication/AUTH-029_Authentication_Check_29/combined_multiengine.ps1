...
Write-Host "=== Authentication Check 29 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "AUTH-029 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "AUTH-029 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "AUTH-029 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== AUTH-029: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "AUTH-029_results.csv"
$uniqueResults |
