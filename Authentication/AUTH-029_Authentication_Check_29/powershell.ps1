...
try {
    ...
    Write-Host "AUTH-029: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-029: Query failed — $_"
}
