...
try {
    ...
    Write-Host "AUTH-014: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-014: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-014: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-014: Query failed : $_"
}
