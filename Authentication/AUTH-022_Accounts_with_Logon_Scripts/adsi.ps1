...
(@('name', 'distinguishedName', 'samAccountName', 'scriptPath', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-022_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Logon Scripts
# Category: Authentication
# Severity: low
# ID: AUTH-022
# Requirements: None
