...
(@('name', 'distinguishedName', 'samAccountName', 'homeDirectory', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "AUTH-023_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Accounts with Home Directories
# Category: Authentication
# Severity: info
# ID: AUTH-023
# Requirements: None
