...
try {
    ...
    Write-Host "AUTH-026: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-026: Query failed : $_"
}
