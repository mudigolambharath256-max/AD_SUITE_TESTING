...
try {
    ...
    Write-Host "AUTH-015: found $($found.Count) objects"
    ...
    Write-Warning "AUTH-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "AUTH-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "AUTH-015: Query failed — $_"
}
