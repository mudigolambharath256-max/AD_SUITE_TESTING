...
## Overview
This security check performs analysis for: **PSO Minimum Password Age**

**Category**: Security_Accounts  
**Check ID**: SECACCT-008  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to PSO Minimum Password Age. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-008.exe csharp.cs
SECACCT-008.exe
```
...
- **CheckID**: The check identifier (SECACCT-008)
- **CheckName**: The check name (PSO Minimum Password Age)
- **Name**: Object name
