# SECACCT-027: Resource Properties

## Overview
This security check performs analysis for: **Resource Properties**

**Category**: Security_Accounts  
**Check ID**: SECACCT-027  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to Resource Properties. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-027.exe csharp.cs
SECACCT-027.exe
```
...
- **CheckID**: The check identifier (SECACCT-027)
- **CheckName**: The check name (Resource Properties)
- **Name**: Object name
