...
$ldapFilter = '(objectClass=msDS-ClaimType)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Claim Types" -ForegroundColor Yellow
Write-Host "Check ID: SECACCT-028" -ForegroundColor Gray
