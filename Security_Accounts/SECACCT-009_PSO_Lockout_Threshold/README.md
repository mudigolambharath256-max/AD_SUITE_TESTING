...
## Overview
This security check performs analysis for: **PSO Lockout Threshold**

**Category**: Security_Accounts  
**Check ID**: SECACCT-009  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to PSO Lockout Threshold. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-009.exe csharp.cs
SECACCT-009.exe
```
...
- **CheckID**: The check identifier (SECACCT-009)
- **CheckName**: The check name (PSO Lockout Threshold)
- **Name**: Object name
