...
## Overview
This security check performs analysis for: **PSO Maximum Password Age**

**Category**: Security_Accounts  
**Check ID**: SECACCT-007  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to PSO Maximum Password Age. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-007.exe csharp.cs
SECACCT-007.exe
```
...
- **CheckID**: The check identifier (SECACCT-007)
- **CheckName**: The check name (PSO Maximum Password Age)
- **Name**: Object name
