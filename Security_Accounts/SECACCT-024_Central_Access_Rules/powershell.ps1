...
$ldapFilter = '(objectClass=msAuthz-CentralAccessRule)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Central Access Rules" -ForegroundColor Yellow
Write-Host "Check ID: SECACCT-024" -ForegroundColor Gray
