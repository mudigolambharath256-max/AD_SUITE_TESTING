# SECACCT-025: Central Access Policies

## Overview
This security check performs analysis for: **Central Access Policies**

**Category**: Security_Accounts  
**Check ID**: SECACCT-025  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to Central Access Policies. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-025.exe csharp.cs
SECACCT-025.exe
```
...
- **CheckID**: The check identifier (SECACCT-025)
- **CheckName**: The check name (Central Access Policies)
- **Name**: Object name
