...
$ldapFilter = '(objectClass=msAuthz-CentralAccessPolicy)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Central Access Policies" -ForegroundColor Yellow
Write-Host "Check ID: SECACCT-025" -ForegroundColor Gray
