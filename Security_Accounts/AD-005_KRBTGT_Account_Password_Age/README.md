...
## Overview
This security check performs analysis for: **KRBTGT Account Password Age**
...
## Description
This check queries Active Directory to identify objects related to KRBTGT Account Password Age. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (AD-005)
- **CheckName**: The check name (KRBTGT Account Password Age)
- **Name**: Object name
