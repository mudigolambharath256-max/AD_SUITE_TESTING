# ============================================================================
# AD-005: KRBTGT Account Password Age
# ============================================================================
...
Write-Host "=== AD-005: KRBTGT Account Password Age ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        # Execute query
        $adObjects = Get-ADObject -LDAPFilter '(&(objectCategory=person)(objectClass=user)(samAccountName=krbtgt))' `
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'AD-005'}}, `
            @{N='CheckName'; E={'KRBTGT Account Password Age'}}, `
...
if (-not $useADModule) {
    ...
    try {
        ...
        $searcher.Filter = '(&(objectCategory=person)(objectClass=user)(samAccountName=krbtgt))'
        ...
        $results = $adsiResults | ForEach-Object {
            ...
            [PSCustomObject]@{
                CheckID           = 'AD-005'
                CheckName         = 'KRBTGT Account Password Age'
                Method            = 'ADSI'
                Domain            = $domainNC
...
try {
    ...
    $bhFile = Join-Path $bhDir "AD-005_$bhTs.json"
    @{
