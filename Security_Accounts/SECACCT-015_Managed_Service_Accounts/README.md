# SECACCT-015: Managed Service Accounts

## Overview
This security check performs analysis for: **Managed Service Accounts**

**Category**: Security_Accounts  
**Check ID**: SECACCT-015  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to Managed Service Accounts. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-015.exe csharp.cs
SECACCT-015.exe
```
...
- **CheckID**: The check identifier (SECACCT-015)
- **CheckName**: The check name (Managed Service Accounts)
- **Name**: Object name
