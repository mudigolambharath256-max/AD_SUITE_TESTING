...
$ldapFilter = '(objectClass=msAuthz-ResourcePropertyList)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Resource Property Lists" -ForegroundColor Yellow
Write-Host "Check ID: SECACCT-026" -ForegroundColor Gray
