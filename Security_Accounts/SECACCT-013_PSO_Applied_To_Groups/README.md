...
## Overview
This security check performs analysis for: **PSO Applied To Groups**

**Category**: Security_Accounts  
**Check ID**: SECACCT-013  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to PSO Applied To Groups. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-013.exe csharp.cs
SECACCT-013.exe
```
...
- **CheckID**: The check identifier (SECACCT-013)
- **CheckName**: The check name (PSO Applied To Groups)
- **Name**: Object name
