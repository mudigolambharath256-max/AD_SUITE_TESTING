...
## Overview
This security check performs analysis for: **Group Managed Service Accounts**

**Category**: Security_Accounts  
**Check ID**: SECACCT-016  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to Group Managed Service Accounts. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-016.exe csharp.cs
SECACCT-016.exe
```
...
- **CheckID**: The check identifier (SECACCT-016)
- **CheckName**: The check name (Group Managed Service Accounts)
- **Name**: Object name
