...
## Overview
This security check performs analysis for: **gMSA Password Interval**

**Category**: Security_Accounts  
**Check ID**: SECACCT-017  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to gMSA Password Interval. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-017.exe csharp.cs
SECACCT-017.exe
```
...
- **CheckID**: The check identifier (SECACCT-017)
- **CheckName**: The check name (gMSA Password Interval)
- **Name**: Object name
