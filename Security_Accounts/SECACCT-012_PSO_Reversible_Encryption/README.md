...
## Overview
This security check performs analysis for: **PSO Reversible Encryption**

**Category**: Security_Accounts  
**Check ID**: SECACCT-012  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to PSO Reversible Encryption. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-012.exe csharp.cs
SECACCT-012.exe
```
...
- **CheckID**: The check identifier (SECACCT-012)
- **CheckName**: The check name (PSO Reversible Encryption)
- **Name**: Object name
