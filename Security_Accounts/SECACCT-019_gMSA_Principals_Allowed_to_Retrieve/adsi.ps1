...
Write-Host "Found $($results.Count) objects for check: gMSA Principals Allowed to Retrieve" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "SECACCT-019_nodes.json"
