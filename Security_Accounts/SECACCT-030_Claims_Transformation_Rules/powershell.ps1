...
$ldapFilter = '(objectClass=msDS-ClaimsTransformationPolicy)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Claims Transformation Rules" -ForegroundColor Yellow
Write-Host "Check ID: SECACCT-030" -ForegroundColor Gray
