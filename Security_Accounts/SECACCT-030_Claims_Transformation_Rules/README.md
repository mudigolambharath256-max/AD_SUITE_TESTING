# SECACCT-030: Claims Transformation Rules

## Overview
This security check performs analysis for: **Claims Transformation Rules**

**Category**: Security_Accounts  
**Check ID**: SECACCT-030  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to Claims Transformation Rules. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-030.exe csharp.cs
SECACCT-030.exe
```
...
- **CheckID**: The check identifier (SECACCT-030)
- **CheckName**: The check name (Claims Transformation Rules)
- **Name**: Object name
