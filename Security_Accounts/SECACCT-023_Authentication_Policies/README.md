# SECACCT-023: Authentication Policies

## Overview
This security check performs analysis for: **Authentication Policies**

**Category**: Security_Accounts  
**Check ID**: SECACCT-023  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to Authentication Policies. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-023.exe csharp.cs
SECACCT-023.exe
```
...
- **CheckID**: The check identifier (SECACCT-023)
- **CheckName**: The check name (Authentication Policies)
- **Name**: Object name
