...
## Overview
This security check performs analysis for: **gMSA Service Principal Names**

**Category**: Security_Accounts  
**Check ID**: SECACCT-021  
**Severity**: INFO

## Description
This check queries Active Directory to identify objects related to gMSA Service Principal Names. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:SECACCT-021.exe csharp.cs
SECACCT-021.exe
```
...
- **CheckID**: The check identifier (SECACCT-021)
- **CheckName**: The check name (gMSA Service Principal Names)
- **Name**: Object name
