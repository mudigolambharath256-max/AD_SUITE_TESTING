...
$ldapFilter = '(objectClass=msDS-ClaimsTransformationPolicyType)'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Claims Transformation Policies" -ForegroundColor Yellow
Write-Host "Check ID: SECACCT-029" -ForegroundColor Gray
