...
try {
    ...
    Write-Host "LDAP-021: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-021: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-021: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-021: Query failed — $_"
}
