...
try {
    ...
    Write-Host "LDAP-005: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-005: Query failed — $_"
}
