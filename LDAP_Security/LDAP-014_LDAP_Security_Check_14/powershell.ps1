...
try {
    ...
    Write-Host "LDAP-014: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-014: Query failed — $_"
}
