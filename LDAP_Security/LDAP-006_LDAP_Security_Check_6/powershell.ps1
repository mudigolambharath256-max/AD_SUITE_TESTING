...
try {
    ...
    Write-Host "LDAP-006: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-006: Query failed — $_"
}
