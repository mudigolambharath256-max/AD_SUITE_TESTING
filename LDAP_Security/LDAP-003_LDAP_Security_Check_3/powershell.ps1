...
try {
    ...
    Write-Host "LDAP-003: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-003: Query failed : $_"
}
