# ============================================================================
# LDAP-012: LDAP Encryption Downgrade Possible - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[LDAP-012] LDAP Encryption Downgrade Possible" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'LDAP-012'
                adSuiteCheckName  = 'LDAP_Encryption_Downgrade_Possible'
    ...
    $bhFile = Join-Path $bhDir "LDAP-012_$bhTs.json"
    @{
