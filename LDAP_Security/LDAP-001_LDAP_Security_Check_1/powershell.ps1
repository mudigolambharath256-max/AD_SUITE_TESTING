...
try {
    ...
    Write-Host "LDAP-001: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-001: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-001: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-001: Query failed : $_"
}
