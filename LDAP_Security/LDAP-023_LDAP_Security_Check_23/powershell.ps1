...
try {
    ...
    Write-Host "LDAP-023: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-023: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-023: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-023: Query failed — $_"
}
