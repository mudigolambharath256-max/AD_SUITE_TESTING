...
try {
    ...
    Write-Host "LDAP-018: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-018: Query failed : $_"
}
