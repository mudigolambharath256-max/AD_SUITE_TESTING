...
try {
    ...
    Write-Host "LDAP-013: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-013: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-013: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-013: Query failed — $_"
}
