...
try {
    ...
    Write-Host "LDAP-009: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-009: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-009: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-009: Query failed : $_"
}
