...
try {
    ...
    Write-Host "LDAP-015: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-015: Query failed — $_"
}
