# ============================================================================
# LDAP-010: LDAP Admin Limits Not Set - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[LDAP-010] LDAP Admin Limits Not Set" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'LDAP-010'
                adSuiteCheckName  = 'LDAP_Admin_Limits_Not_Set'
    ...
    $bhFile = Join-Path $bhDir "LDAP-010_$bhTs.json"
    @{
