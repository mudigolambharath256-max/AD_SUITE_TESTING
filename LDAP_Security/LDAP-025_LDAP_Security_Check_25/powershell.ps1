...
try {
    ...
    Write-Host "LDAP-025: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-025: Query failed : $_"
}
