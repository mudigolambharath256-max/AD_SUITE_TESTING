...
try {
    ...
    Write-Host "LDAP-012: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-012: Query failed : $_"
}
