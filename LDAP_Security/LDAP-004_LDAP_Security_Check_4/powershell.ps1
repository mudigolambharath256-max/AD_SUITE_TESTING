...
try {
    ...
    Write-Host "LDAP-004: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-004: Query failed : $_"
}
