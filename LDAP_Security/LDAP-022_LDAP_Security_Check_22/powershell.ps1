...
try {
    ...
    Write-Host "LDAP-022: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-022: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-022: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-022: Query failed — $_"
}
