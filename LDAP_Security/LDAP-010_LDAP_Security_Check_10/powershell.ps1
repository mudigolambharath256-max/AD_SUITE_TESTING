...
try {
    ...
    Write-Host "LDAP-010: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-010: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-010: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-010: Query failed : $_"
}
