...
try {
    ...
    Write-Host "LDAP-008: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-008: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-008: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-008: Query failed : $_"
}
