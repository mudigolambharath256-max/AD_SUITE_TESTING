...
try {
    ...
    Write-Host "LDAP-002: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-002: Query failed — $_"
}
