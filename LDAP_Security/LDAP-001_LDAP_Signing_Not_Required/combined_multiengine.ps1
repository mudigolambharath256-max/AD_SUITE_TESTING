# ============================================================================
# LDAP-001: LDAP Signing Not Required - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[LDAP-001] LDAP Signing Not Required" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'LDAP-001'
                adSuiteCheckName  = 'LDAP_Signing_Not_Required'
    ...
    $bhFile = Join-Path $bhDir "LDAP-001_$bhTs.json"
    @{
