...
try {
    ...
    Write-Host "LDAP-024: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-024: Query failed : $_"
}
