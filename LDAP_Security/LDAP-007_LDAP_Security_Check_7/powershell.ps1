...
try {
    ...
    Write-Host "LDAP-007: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-007: Query failed — $_"
}
