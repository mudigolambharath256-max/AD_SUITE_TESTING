...
try {
    ...
    Write-Host "LDAP-017: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-017: Query failed — $_"
}
