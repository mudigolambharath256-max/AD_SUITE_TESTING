# ============================================================================
# LDAP-011: LDAP Null Base Search Allowed - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[LDAP-011] LDAP Null Base Search Allowed" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'LDAP-011'
                adSuiteCheckName  = 'LDAP_Null_Base_Search_Allowed'
    ...
    $bhFile = Join-Path $bhDir "LDAP-011_$bhTs.json"
    @{
