...
try {
    ...
    Write-Host "LDAP-020: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-020: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-020: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-020: Query failed : $_"
}
