# ============================================================================
# LDAP-003: Anonymous LDAP Bind Allowed - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[LDAP-003] Anonymous LDAP Bind Allowed" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'LDAP-003'
                adSuiteCheckName  = 'Anonymous_LDAP_Bind_Allowed'
    ...
    $bhFile = Join-Path $bhDir "LDAP-003_$bhTs.json"
    @{
