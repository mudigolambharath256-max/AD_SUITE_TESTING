...
try {
    ...
    Write-Host "LDAP-011: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-011: Query failed — $_"
}
