...
try {
    ...
    Write-Host "LDAP-019: found $($found.Count) objects"
    ...
    Write-Warning "LDAP-019: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "LDAP-019: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "LDAP-019: Query failed — $_"
}
