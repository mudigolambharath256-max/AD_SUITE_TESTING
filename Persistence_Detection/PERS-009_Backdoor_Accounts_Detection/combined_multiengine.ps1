# ============================================================================
# PERS-009: Backdoor Accounts Detection - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[PERS-009] Backdoor Accounts Detection" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'PERS-009'
                adSuiteCheckName  = 'Backdoor_Accounts_Detection'
    ...
    $bhFile = Join-Path $bhDir "PERS-009_$bhTs.json"
    @{
