...
Write-Host "Severity: HIGH | Risk: 8/10 | MITRE: T1222.001" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(|(objectClass=user)(objectClass=group)(objectClass=computer))' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PERS-011'}}, `
    @{N='CheckName'; E={'ACL Backdoors'}}, `
    @{N='RiskScore'; E={8}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1222.001'}}, `
