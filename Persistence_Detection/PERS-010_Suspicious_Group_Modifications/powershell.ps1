...
Write-Host "Severity: HIGH | Risk: 7/10 | MITRE: T1098" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=group)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PERS-010'}}, `
    @{N='CheckName'; E={'Suspicious Group Modifications'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1098'}}, `
