...
Write-Host "Severity: HIGH | Risk: 9/10 | MITRE: T1558.002" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(servicePrincipalName=*)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PERS-003'}}, `
    @{N='CheckName'; E={'Silver Ticket Indicators'}}, `
    @{N='RiskScore'; E={9}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1558.002'}}, `
