...
Write-Host "Severity: CRITICAL | Risk: 9/10 | MITRE: T1098" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(distinguishedName=CN=AdminSDHolder,CN=System,*)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'PERS-005'}}, `
    @{N='CheckName'; E={'AdminSDHolder Tampering'}}, `
    @{N='RiskScore'; E={9}}, `
