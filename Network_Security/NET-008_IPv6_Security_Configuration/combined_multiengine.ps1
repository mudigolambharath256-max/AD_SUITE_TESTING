# ============================================================================
# NET-008: IPv6 Security Configuration - Multi-Engine
# ============================================================================

[CmdletBinding()]
param([Parameter()][string]$SearchBase, [Parameter()][string]$ExportPath)

Write-Host "[NET-008] IPv6 Security Configuration" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'NET-008'
                adSuiteCheckName  = 'IPv6_Security_Configuration'
    ...
    $bhFile = Join-Path $bhDir "NET-008_$bhTs.json"
    @{
