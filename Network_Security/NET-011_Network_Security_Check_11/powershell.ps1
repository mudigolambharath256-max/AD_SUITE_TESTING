...
try {
    ...
    Write-Host "NET-011: found $($found.Count) objects"
    ...
    Write-Warning "NET-011: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-011: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-011: Query failed : $_"
}
