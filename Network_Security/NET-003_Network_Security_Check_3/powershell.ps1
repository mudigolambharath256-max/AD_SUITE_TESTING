...
try {
    ...
    Write-Host "NET-003: found $($found.Count) objects"
    ...
    Write-Warning "NET-003: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-003: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-003: Query failed — $_"
}
