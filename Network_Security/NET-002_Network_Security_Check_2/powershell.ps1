...
try {
    ...
    Write-Host "NET-002: found $($found.Count) objects"
    ...
    Write-Warning "NET-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-002: Query failed — $_"
}
