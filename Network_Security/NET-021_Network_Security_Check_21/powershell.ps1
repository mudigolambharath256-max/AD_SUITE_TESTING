...
try {
    ...
    Write-Host "NET-021: found $($found.Count) objects"
    ...
    Write-Warning "NET-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-021: Query failed : $_"
}
