...
try {
    ...
    Write-Host "NET-020: found $($found.Count) objects"
    ...
    Write-Warning "NET-020: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-020: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-020: Query failed : $_"
}
