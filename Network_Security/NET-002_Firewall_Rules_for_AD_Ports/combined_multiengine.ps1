# ============================================================================
# NET-002: Firewall Rules for AD Ports - Multi-Engine
# ============================================================================
...
#   It CANNOT determine host firewall rules (requires WMI NetFwProfile or registry) via LDAP alone.
...
Write-Host "[NET-002] Firewall Rules for AD Ports" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'NET-002'
                adSuiteCheckName  = 'Firewall_Rules_for_AD_Ports'
    ...
    $bhFile = Join-Path $bhDir "NET-002_$bhTs.json"
    @{
