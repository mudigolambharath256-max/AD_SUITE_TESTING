...
try {
    ...
    Write-Host "NET-001: found $($found.Count) objects"
    ...
    Write-Warning "NET-001: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-001: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-001: Query failed : $_"
}
