...
try {
    ...
    Write-Host "NET-030: found $($found.Count) objects"
    ...
    Write-Warning "NET-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-030: Query failed — $_"
}
