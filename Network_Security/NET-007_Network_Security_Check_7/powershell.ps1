...
try {
    ...
    Write-Host "NET-007: found $($found.Count) objects"
    ...
    Write-Warning "NET-007: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-007: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-007: Query failed : $_"
}
