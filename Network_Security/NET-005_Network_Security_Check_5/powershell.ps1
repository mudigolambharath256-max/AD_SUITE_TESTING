...
try {
    ...
    Write-Host "NET-005: found $($found.Count) objects"
    ...
    Write-Warning "NET-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-005: Query failed — $_"
}
