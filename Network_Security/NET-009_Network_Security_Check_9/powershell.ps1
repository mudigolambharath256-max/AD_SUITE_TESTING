...
try {
    ...
    Write-Host "NET-009: found $($found.Count) objects"
    ...
    Write-Warning "NET-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-009: Query failed — $_"
}
