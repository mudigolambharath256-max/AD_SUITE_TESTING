...
try {
    ...
    Write-Host "NET-008: found $($found.Count) objects"
    ...
    Write-Warning "NET-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-008: Query failed — $_"
}
