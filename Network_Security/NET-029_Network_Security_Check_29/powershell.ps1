...
try {
    ...
    Write-Host "NET-029: found $($found.Count) objects"
    ...
    Write-Warning "NET-029: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-029: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-029: Query failed : $_"
}
