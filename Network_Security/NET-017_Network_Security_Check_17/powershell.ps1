...
try {
    ...
    Write-Host "NET-017: found $($found.Count) objects"
    ...
    Write-Warning "NET-017: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-017: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-017: Query failed : $_"
}
