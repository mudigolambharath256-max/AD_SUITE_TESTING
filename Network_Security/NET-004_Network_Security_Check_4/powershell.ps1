...
try {
    ...
    Write-Host "NET-004: found $($found.Count) objects"
    ...
    Write-Warning "NET-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-004: Query failed : $_"
}
