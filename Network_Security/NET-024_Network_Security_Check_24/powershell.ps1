...
try {
    ...
    Write-Host "NET-024: found $($found.Count) objects"
    ...
    Write-Warning "NET-024: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-024: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-024: Query failed : $_"
}
