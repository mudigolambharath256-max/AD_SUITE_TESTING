...
try {
    ...
    Write-Host "NET-013: found $($found.Count) objects"
    ...
    Write-Warning "NET-013: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-013: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-013: Query failed : $_"
}
