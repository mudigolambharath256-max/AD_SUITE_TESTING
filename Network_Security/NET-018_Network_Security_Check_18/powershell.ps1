...
try {
    ...
    Write-Host "NET-018: found $($found.Count) objects"
    ...
    Write-Warning "NET-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-018: Query failed : $_"
}
