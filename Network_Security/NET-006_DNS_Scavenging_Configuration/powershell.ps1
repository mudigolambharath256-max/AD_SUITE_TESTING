...
Write-Host "Severity: MEDIUM | Risk: 5/10 | MITRE: T1584.002" -ForegroundColor Gray

$results = Get-ADObject -LDAPFilter '(objectClass=dnsZone)' `
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'NET-006'}}, `
    @{N='CheckName'; E={'DNS Scavenging Configuration'}}, `
    @{N='RiskScore'; E={5}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1584.002'}}, `
