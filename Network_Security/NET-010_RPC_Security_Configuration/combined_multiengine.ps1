# ============================================================================
# NET-010: RPC Security Configuration - Multi-Engine
# ============================================================================
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'NET-010'
                adSuiteCheckName  = 'RPC_Security_Configuration'
    ...
    $bhFile = Join-Path $bhDir "NET-010_$bhTs.json"
    @{
