...
try {
    ...
    Write-Host "NET-006: found $($found.Count) objects"
    ...
    Write-Warning "NET-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-006: Query failed : $_"
}
