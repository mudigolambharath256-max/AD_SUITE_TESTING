...
try {
    ...
    Write-Host "NET-015: found $($found.Count) objects"
    ...
    Write-Warning "NET-015: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-015: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-015: Query failed : $_"
}
