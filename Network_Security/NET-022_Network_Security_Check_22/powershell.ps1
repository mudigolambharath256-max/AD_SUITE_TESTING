...
try {
    ...
    Write-Host "NET-022: found $($found.Count) objects"
    ...
    Write-Warning "NET-022: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-022: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-022: Query failed : $_"
}
