...
try {
    ...
    Write-Host "NET-012: found $($found.Count) objects"
    ...
    Write-Warning "NET-012: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-012: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-012: Query failed — $_"
}
