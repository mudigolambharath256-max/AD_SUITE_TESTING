...
try {
    ...
    Write-Host "NET-027: found $($found.Count) objects"
    ...
    Write-Warning "NET-027: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-027: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-027: Query failed — $_"
}
