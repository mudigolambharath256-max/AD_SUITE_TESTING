...
try {
    ...
    Write-Host "NET-023: found $($found.Count) objects"
    ...
    Write-Warning "NET-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-023: Query failed : $_"
}
