...
try {
    ...
    Write-Host "NET-019: found $($found.Count) objects"
    ...
    Write-Warning "NET-019: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-019: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-019: Query failed — $_"
}
