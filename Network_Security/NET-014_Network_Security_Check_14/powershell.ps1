...
try {
    ...
    Write-Host "NET-014: found $($found.Count) objects"
    ...
    Write-Warning "NET-014: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-014: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-014: Query failed : $_"
}
