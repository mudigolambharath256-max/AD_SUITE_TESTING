...
try {
    ...
    Write-Host "NET-016: found $($found.Count) objects"
    ...
    Write-Warning "NET-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-016: Query failed — $_"
}
