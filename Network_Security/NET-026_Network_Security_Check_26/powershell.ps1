...
try {
    ...
    Write-Host "NET-026: found $($found.Count) objects"
    ...
    Write-Warning "NET-026: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-026: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-026: Query failed — $_"
}
