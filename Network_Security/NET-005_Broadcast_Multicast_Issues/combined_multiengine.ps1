# ============================================================================
# NET-005: Broadcast Multicast Issues - Multi-Engine
# ============================================================================
...
#   It CANNOT determine broadcast/multicast configuration (requires network scanning or host registry) via LDAP alone.
...
Write-Host "[NET-005] Broadcast Multicast Issues" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'NET-005'
                adSuiteCheckName  = 'Broadcast_Multicast_Issues'
    ...
    $bhFile = Join-Path $bhDir "NET-005_$bhTs.json"
    @{
