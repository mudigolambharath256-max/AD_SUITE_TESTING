...
try {
    ...
    Write-Host "NET-025: found $($found.Count) objects"
    ...
    Write-Warning "NET-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "NET-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "NET-025: Query failed : $_"
}
