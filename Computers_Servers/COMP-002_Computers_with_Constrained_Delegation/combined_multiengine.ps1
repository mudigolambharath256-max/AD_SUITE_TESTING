...
Write-Host "=== Multi-Engine Execution: Computers with Constrained Delegation ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $bhFile = Join-Path $bhDir "COMP-002_$bhTs.json"
    @{
