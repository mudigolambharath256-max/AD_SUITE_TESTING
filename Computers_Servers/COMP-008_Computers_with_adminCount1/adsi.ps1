...
(@('name', 'distinguishedName', 'samAccountName', 'adminCount', 'operatingSystem', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-008_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers with adminCount1
# Category: Computers & Servers
# Severity: high
# ID: COMP-008
# Requirements: None
