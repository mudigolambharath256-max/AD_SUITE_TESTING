...
(@('name', 'distinguishedName', 'samAccountName', 'operatingSystem', 'dNSHostName', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-029_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: LinuxUnix Computers
# Category: Computers & Servers
# Severity: info
# ID: COMP-029
# Requirements: None
