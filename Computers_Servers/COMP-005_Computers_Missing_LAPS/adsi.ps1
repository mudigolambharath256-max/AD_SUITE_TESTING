...
(@('name', 'distinguishedName', 'samAccountName', 'operatingSystem', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-005_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers Missing LAPS
# Category: Computers & Servers
# Severity: high
# ID: COMP-005
# Requirements: None
