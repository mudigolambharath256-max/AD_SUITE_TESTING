...
(@('name', 'distinguishedName', 'samAccountName', 'whenCreated', 'operatingSystem', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-019_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers Created in Last 7 Days
# Category: Computers & Servers
# Severity: info
# ID: COMP-019
# Requirements: None
