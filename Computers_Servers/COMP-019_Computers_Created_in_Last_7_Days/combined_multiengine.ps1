...
Write-Host "=== Multi-Engine Execution: Computers Created in Last 7 Days ===" -ForegroundColor Cyan
Write-Host ""
...
public class Program
{
  public static void Run()
  {
    ...
    string[] props = new string[] { "name", "distinguishedName", "samAccountName", "whenCreated", "operatingSystem" };
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMP-019'
                adSuiteCheckName  = 'Computers_Created_in_Last_7_Days'
    ...
    $bhFile = Join-Path $bhDir "COMP-019_$bhTs.json"
    @{
