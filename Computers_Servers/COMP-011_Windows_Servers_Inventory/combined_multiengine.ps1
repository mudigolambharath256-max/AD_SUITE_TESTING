...
Write-Host "=== Multi-Engine Execution: Windows Servers Inventory ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMP-011'
                adSuiteCheckName  = 'Windows_Servers_Inventory'
    ...
    $bhFile = Join-Path $bhDir "COMP-011_$bhTs.json"
    @{
