...
@('name', 'distinguishedName', 'samAccountName', 'userAccountControl', 'primaryGroupID', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-017_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers Trusted as DCs (Not Actual DCs)
# Category: Computers & Servers
# Severity: critical
# ID: COMP-017
# Requirements: None
