...
(@('name', 'distinguishedName', 'samAccountName', 'msDS-AllowedToActOnBehalfOfOtherIdentity', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-003_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers with RBCD Configured
# Category: Computers & Servers
# Severity: high
# ID: COMP-003
# Requirements: None
