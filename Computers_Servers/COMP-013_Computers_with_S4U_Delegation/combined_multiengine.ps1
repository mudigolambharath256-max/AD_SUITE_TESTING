...
Write-Host "=== Multi-Engine Execution: Computers with S4U Delegation ===" -ForegroundColor Cyan
Write-Host ""
...
public class Program
{
  public static void Run()
  {
    ...
    string[] props = new string[] { "name", "distinguishedName", "samAccountName", "userAccountControl", "msDS-AllowedToDelegateTo" };
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMP-013'
                adSuiteCheckName  = 'Computers_with_S4U_Delegation'
    ...
    $bhFile = Join-Path $bhDir "COMP-013_$bhTs.json"
    @{
