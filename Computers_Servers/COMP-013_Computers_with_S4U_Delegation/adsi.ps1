...
@('name', 'distinguishedName', 'samAccountName', 'userAccountControl', 'msDS-AllowedToDelegateTo', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-013_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers with S4U Delegation
# Category: Computers & Servers
# Severity: high
# ID: COMP-013
# Requirements: None
