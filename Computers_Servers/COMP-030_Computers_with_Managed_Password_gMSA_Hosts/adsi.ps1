...
@('name', 'distinguishedName', 'samAccountName', 'msDS-HostServiceAccount', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-030_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Computers with Managed Password (gMSA Hosts)
# Category: Computers & Servers
# Severity: info
# ID: COMP-030
# Requirements: None
