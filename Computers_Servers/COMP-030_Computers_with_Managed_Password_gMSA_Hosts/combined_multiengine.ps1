...
Write-Host "=== Multi-Engine Execution: Computers with Managed Password (gMSA Hosts) ===" -ForegroundColor Cyan
Write-Host ""
...
public class Program
{
  public static void Run()
  {
    ...
    string[] props = new string[] { "name", "distinguishedName", "samAccountName", "msDS-HostServiceAccount" };
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMP-030'
                adSuiteCheckName  = 'Computers_with_Managed_Password_gMSA_Hosts'
    ...
    $bhFile = Join-Path $bhDir "COMP-030_$bhTs.json"
    @{
