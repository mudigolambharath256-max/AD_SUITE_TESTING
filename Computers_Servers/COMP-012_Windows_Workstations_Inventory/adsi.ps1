...
(@('name', 'distinguishedName', 'samAccountName', 'operatingSystem', 'operatingSystemVersion', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-012_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Windows Workstations Inventory
# Category: Computers & Servers
# Severity: info
# ID: COMP-012
# Requirements: None
