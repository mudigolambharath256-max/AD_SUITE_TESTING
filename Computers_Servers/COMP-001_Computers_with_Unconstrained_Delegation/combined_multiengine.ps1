...
Write-Host "=== Multi-Engine Execution: Computers with Unconstrained Delegation ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $bhFile = Join-Path $bhDir "COMP-001_$bhTs.json"
    @{
