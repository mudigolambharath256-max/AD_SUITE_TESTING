...
Write-Host "=== Multi-Engine Execution: Computers with DES-Only Kerberos ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMP-014'
                adSuiteCheckName  = 'Computers_with_DES-Only_Kerberos'
    ...
    $bhFile = Join-Path $bhDir "COMP-014_$bhTs.json"
    @{
