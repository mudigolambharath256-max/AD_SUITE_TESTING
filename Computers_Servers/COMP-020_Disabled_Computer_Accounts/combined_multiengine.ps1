...
Write-Host "=== Multi-Engine Execution: Disabled Computer Accounts ===" -ForegroundColor Cyan
Write-Host ""
...
public class Program
{
  public static void Run()
  {
    ...
    string[] props = new string[] { "name", "distinguishedName", "samAccountName", "whenChanged", "operatingSystem" };
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'COMP-020'
                adSuiteCheckName  = 'Disabled_Computer_Accounts'
    ...
    $bhFile = Join-Path $bhDir "COMP-020_$bhTs.json"
    @{
