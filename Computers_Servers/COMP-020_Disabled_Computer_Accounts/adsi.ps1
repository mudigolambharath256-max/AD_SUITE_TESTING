...
(@('name', 'distinguishedName', 'samAccountName', 'whenChanged', 'operatingSystem', 'userAccountControl', 'objectSid') | ForEach-Object { [void]$searcher.PropertiesToLoad.Add($_) }
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "COMP-020_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Disabled Computer Accounts
# Category: Computers & Servers
# Severity: low
# ID: COMP-020
# Requirements: None
