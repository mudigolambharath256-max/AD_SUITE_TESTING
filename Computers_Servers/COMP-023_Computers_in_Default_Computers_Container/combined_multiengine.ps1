...
Write-Host "=== Multi-Engine Execution: Computers in Default Computers Container ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $bhFile = Join-Path $bhDir "COMP-023_$bhTs.json"
    @{
