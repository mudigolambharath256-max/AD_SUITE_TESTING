...
## Overview
This security check performs analysis for: **Orphaned Trust Objects**
...
## Description
This check queries Active Directory to identify objects related to Orphaned Trust Objects. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-022.exe csharp.cs
TMGMT-022.exe
```
...
- **CheckID**: The check identifier (TMGMT-022)
- **CheckName**: The check name (Orphaned Trust Objects)
- **Name**: Object name
