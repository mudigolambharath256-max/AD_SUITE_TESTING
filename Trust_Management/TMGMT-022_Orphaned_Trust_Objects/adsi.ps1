...
Write-Host "Found $($results.Count) objects for check: Orphaned Trust Objects" -ForegroundColor Cyan
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID           = 'TMGMT-022'
        CheckName         = 'Orphaned Trust Objects'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TMGMT-022_nodes.json"
