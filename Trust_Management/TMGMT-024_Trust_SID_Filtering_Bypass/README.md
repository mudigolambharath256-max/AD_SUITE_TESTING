...
## Overview
This security check performs analysis for: **Trust SID Filtering Bypass**
...
## Description
This check queries Active Directory to identify objects related to Trust SID Filtering Bypass. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-024.exe csharp.cs
TMGMT-024.exe
```
...
- **CheckID**: The check identifier (TMGMT-024)
- **CheckName**: The check name (Trust SID Filtering Bypass)
- **Name**: Object name
