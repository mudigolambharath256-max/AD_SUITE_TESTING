...
## Overview
This security check performs analysis for: **Cross Forest Trust Validation**
...
## Description
This check queries Active Directory to identify objects related to Cross Forest Trust Validation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-015.exe csharp.cs
TMGMT-015.exe
```
...
- **CheckID**: The check identifier (TMGMT-015)
- **CheckName**: The check name (Cross Forest Trust Validation)
- **Name**: Object name
