...
## Overview
This security check performs analysis for: **Trusts Without SID Filtering**
...
## Description
This check queries Active Directory to identify objects related to Trusts Without SID Filtering. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-002.exe csharp.cs
TMGMT-002.exe
```
...
- **CheckID**: The check identifier (TMGMT-002)
- **CheckName**: The check name (Trusts Without SID Filtering)
- **Name**: Object name
