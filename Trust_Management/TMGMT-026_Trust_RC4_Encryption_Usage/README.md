...
## Overview
This security check performs analysis for: **Trust RC4 Encryption Usage**
...
## Description
This check queries Active Directory to identify objects related to Trust RC4 Encryption Usage. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-026.exe csharp.cs
TMGMT-026.exe
```
...
- **CheckID**: The check identifier (TMGMT-026)
- **CheckName**: The check name (Trust RC4 Encryption Usage)
- **Name**: Object name
