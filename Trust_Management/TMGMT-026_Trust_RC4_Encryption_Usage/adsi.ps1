...
Write-Host "Found $($results.Count) objects for check: Trust RC4 Encryption Usage" -ForegroundColor Cyan
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID           = 'TMGMT-026'
        CheckName         = 'Trust RC4 Encryption Usage'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TMGMT-026_nodes.json"
