...
## Overview
This security check performs analysis for: **Trust Transitivity Settings**
...
## Description
This check queries Active Directory to identify objects related to Trust Transitivity Settings. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-007.exe csharp.cs
TMGMT-007.exe
```
...
- **CheckID**: The check identifier (TMGMT-007)
- **CheckName**: The check name (Trust Transitivity Settings)
- **Name**: Object name
