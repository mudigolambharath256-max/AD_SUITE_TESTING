...
## Overview
This security check performs analysis for: **Trust Central Access Policies**
...
## Description
This check queries Active Directory to identify objects related to Trust Central Access Policies. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-030.exe csharp.cs
TMGMT-030.exe
```
...
- **CheckID**: The check identifier (TMGMT-030)
- **CheckName**: The check name (Trust Central Access Policies)
- **Name**: Object name
