...
## Overview
This security check performs analysis for: **Orphaned Foreign Security Principals**
...
## Description
This check queries Active Directory to identify objects related to Orphaned Foreign Security Principals. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-003.exe csharp.cs
TMGMT-003.exe
```
...
- **CheckID**: The check identifier (TMGMT-003)
- **CheckName**: The check name (Orphaned Foreign Security Principals)
- **Name**: Object name
