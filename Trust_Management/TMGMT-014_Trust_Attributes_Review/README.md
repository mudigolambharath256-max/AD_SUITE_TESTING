...
## Overview
This security check performs analysis for: **Trust Attributes Review**
...
## Description
This check queries Active Directory to identify objects related to Trust Attributes Review. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-014.exe csharp.cs
TMGMT-014.exe
```
...
- **CheckID**: The check identifier (TMGMT-014)
- **CheckName**: The check name (Trust Attributes Review)
- **Name**: Object name
