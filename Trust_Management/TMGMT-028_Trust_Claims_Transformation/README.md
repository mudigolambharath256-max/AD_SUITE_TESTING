...
## Overview
This security check performs analysis for: **Trust Claims Transformation**
...
## Description
This check queries Active Directory to identify objects related to Trust Claims Transformation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-028.exe csharp.cs
TMGMT-028.exe
```
...
- **CheckID**: The check identifier (TMGMT-028)
- **CheckName**: The check name (Trust Claims Transformation)
- **Name**: Object name
