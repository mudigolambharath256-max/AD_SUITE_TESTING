...
## Overview
This security check performs analysis for: **Forest Trust Selective Authentication**
...
## Description
This check queries Active Directory to identify objects related to Forest Trust Selective Authentication. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-008.exe csharp.cs
TMGMT-008.exe
```
...
- **CheckID**: The check identifier (TMGMT-008)
- **CheckName**: The check name (Forest Trust Selective Authentication)
- **Name**: Object name
...
## Related Checks
This check is part of the **Trust_Management** category. Related checks:
