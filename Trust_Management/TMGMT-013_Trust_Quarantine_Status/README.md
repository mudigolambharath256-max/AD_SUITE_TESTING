...
## Overview
This security check performs analysis for: **Trust Quarantine Status**
...
## Description
This check queries Active Directory to identify objects related to Trust Quarantine Status. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-013.exe csharp.cs
TMGMT-013.exe
```
...
- **CheckID**: The check identifier (TMGMT-013)
- **CheckName**: The check name (Trust Quarantine Status)
- **Name**: Object name
