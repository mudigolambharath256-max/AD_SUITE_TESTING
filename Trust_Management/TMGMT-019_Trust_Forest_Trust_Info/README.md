...
## Overview
This security check performs analysis for: **Trust Forest Trust Info**
...
## Description
This check queries Active Directory to identify objects related to Trust Forest Trust Info. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-019.exe csharp.cs
TMGMT-019.exe
```
...
- **CheckID**: The check identifier (TMGMT-019)
- **CheckName**: The check name (Trust Forest Trust Info)
- **Name**: Object name
