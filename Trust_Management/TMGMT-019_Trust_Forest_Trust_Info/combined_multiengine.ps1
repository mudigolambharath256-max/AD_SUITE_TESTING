...
Write-Host "=== TMGMT-019: Trust Forest Trust Info ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'TMGMT-019'}}, `
            @{N='CheckName'; E={'Trust Forest Trust Info'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'TMGMT-019'
                adSuiteCheckName  = 'Trust_Forest_Trust_Info'
    ...
    $bhFile = Join-Path $bhDir "TMGMT-019_$bhTs.json"
    @{
