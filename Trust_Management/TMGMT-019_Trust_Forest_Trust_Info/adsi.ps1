...
Write-Host "Found $($results.Count) objects for check: Trust Forest Trust Info" -ForegroundColor Cyan
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID           = 'TMGMT-019'
        CheckName         = 'Trust Forest Trust Info'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TMGMT-019_nodes.json"
