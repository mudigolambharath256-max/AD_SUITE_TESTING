...
Write-Host "Found $($results.Count) objects for check: Trust Name Suffix Routing" -ForegroundColor Cyan
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID           = 'TMGMT-018'
        CheckName         = 'Trust Name Suffix Routing'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TMGMT-018_nodes.json"
