...
## Overview
This security check performs analysis for: **Trust Name Suffix Routing**
...
## Description
This check queries Active Directory to identify objects related to Trust Name Suffix Routing. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-018.exe csharp.cs
TMGMT-018.exe
```
...
- **CheckID**: The check identifier (TMGMT-018)
- **CheckName**: The check name (Trust Name Suffix Routing)
- **Name**: Object name
