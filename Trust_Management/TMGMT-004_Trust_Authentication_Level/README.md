...
## Overview
This security check performs analysis for: **Trust Authentication Level**
...
## Description
This check queries Active Directory to identify objects related to Trust Authentication Level. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-004.exe csharp.cs
TMGMT-004.exe
```
...
- **CheckID**: The check identifier (TMGMT-004)
- **CheckName**: The check name (Trust Authentication Level)
- **Name**: Object name
