...
Write-Host "=== TMGMT-004: Trust Authentication Level ===" -ForegroundColor Cyan
...
if ($useADModule) {
    ...
    try {
        ...
        $results = $adObjects | Select-Object `
            @{N='CheckID'; E={'TMGMT-004'}}, `
            @{N='CheckName'; E={'Trust Authentication Level'}}, `
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'TMGMT-004'
                adSuiteCheckName  = 'Trust_Authentication_Level'
    ...
    $bhFile = Join-Path $bhDir "TMGMT-004_$bhTs.json"
    @{
