...
## Overview
This security check performs analysis for: **Trust Resource Property Lists**
...
## Description
This check queries Active Directory to identify objects related to Trust Resource Property Lists. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-029.exe csharp.cs
TMGMT-029.exe
```
...
- **CheckID**: The check identifier (TMGMT-029)
- **CheckName**: The check name (Trust Resource Property Lists)
- **Name**: Object name
