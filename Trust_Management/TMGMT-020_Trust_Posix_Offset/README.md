...
## Overview
This security check performs analysis for: **Trust Posix Offset**
...
## Description
This check queries Active Directory to identify objects related to Trust Posix Offset. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-020.exe csharp.cs
TMGMT-020.exe
```
...
- **CheckID**: The check identifier (TMGMT-020)
- **CheckName**: The check name (Trust Posix Offset)
- **Name**: Object name
