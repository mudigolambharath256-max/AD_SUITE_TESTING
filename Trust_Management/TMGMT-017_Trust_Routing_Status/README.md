...
## Overview
This security check performs analysis for: **Trust Routing Status**
...
## Description
This check queries Active Directory to identify objects related to Trust Routing Status. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-017.exe csharp.cs
TMGMT-017.exe
```
...
- **CheckID**: The check identifier (TMGMT-017)
- **CheckName**: The check name (Trust Routing Status)
- **Name**: Object name
