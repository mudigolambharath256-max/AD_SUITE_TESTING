...
## Overview
This security check performs analysis for: **Trust TGT Delegation**
...
## Description
This check queries Active Directory to identify objects related to Trust TGT Delegation. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-025.exe csharp.cs
TMGMT-025.exe
```
...
- **CheckID**: The check identifier (TMGMT-025)
- **CheckName**: The check name (Trust TGT Delegation)
- **Name**: Object name
