...
## Overview
This security check performs analysis for: **Trust Encryption Types**
...
## Description
This check queries Active Directory to identify objects related to Trust Encryption Types. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-012.exe csharp.cs
TMGMT-012.exe
```
...
- **CheckID**: The check identifier (TMGMT-012)
- **CheckName**: The check name (Trust Encryption Types)
- **Name**: Object name
