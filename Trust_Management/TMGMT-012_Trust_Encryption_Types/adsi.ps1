...
Write-Host "Found $($results.Count) objects for check: Trust Encryption Types" -ForegroundColor Cyan
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID           = 'TMGMT-012'
        CheckName         = 'Trust Encryption Types'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TMGMT-012_nodes.json"
