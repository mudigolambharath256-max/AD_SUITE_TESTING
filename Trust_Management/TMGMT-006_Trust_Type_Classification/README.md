...
## Overview
This security check performs analysis for: **Trust Type Classification**
...
## Description
This check queries Active Directory to identify objects related to Trust Type Classification. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-006.exe csharp.cs
TMGMT-006.exe
```
...
- **CheckID**: The check identifier (TMGMT-006)
- **CheckName**: The check name (Trust Type Classification)
- **Name**: Object name
