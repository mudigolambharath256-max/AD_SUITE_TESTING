...
## Overview
This security check performs analysis for: **Trust Password Last Set**
...
## Description
This check queries Active Directory to identify objects related to Trust Password Last Set. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-011.exe csharp.cs
TMGMT-011.exe
```
...
- **CheckID**: The check identifier (TMGMT-011)
- **CheckName**: The check name (Trust Password Last Set)
- **Name**: Object name
