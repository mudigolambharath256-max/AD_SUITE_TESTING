...
Write-Host "Found $($results.Count) objects for check: Trust Password Last Set" -ForegroundColor Cyan
...
$results | ForEach-Object {
    ...
    [PSCustomObject]@{
        CheckID           = 'TMGMT-011'
        CheckName         = 'Trust Password Last Set'
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "TMGMT-011_nodes.json"
