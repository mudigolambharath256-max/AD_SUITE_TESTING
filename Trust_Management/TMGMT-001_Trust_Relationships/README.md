...
## Overview
This security check performs analysis for: **Trust Relationships**
...
## Description
This check queries Active Directory to identify objects related to Trust Relationships. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-001.exe csharp.cs
TMGMT-001.exe
```
...
- **CheckID**: The check identifier (TMGMT-001)
- **CheckName**: The check name (Trust Relationships)
- **Name**: Object name
