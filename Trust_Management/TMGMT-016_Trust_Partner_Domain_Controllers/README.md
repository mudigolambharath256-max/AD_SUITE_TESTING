...
## Overview
This security check performs analysis for: **Trust Partner Domain Controllers**
...
## Description
This check queries Active Directory to identify objects related to Trust Partner Domain Controllers. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-016.exe csharp.cs
TMGMT-016.exe
```
...
- **CheckID**: The check identifier (TMGMT-016)
- **CheckName**: The check name (Trust Partner Domain Controllers)
- **Name**: Object name
