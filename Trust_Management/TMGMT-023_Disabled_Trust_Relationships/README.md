...
## Overview
This security check performs analysis for: **Disabled Trust Relationships**
...
## Description
This check queries Active Directory to identify objects related to Disabled Trust Relationships. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-023.exe csharp.cs
TMGMT-023.exe
```
...
- **CheckID**: The check identifier (TMGMT-023)
- **CheckName**: The check name (Disabled Trust Relationships)
- **Name**: Object name
