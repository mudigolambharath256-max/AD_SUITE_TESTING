...
## Overview
This security check performs analysis for: **Trust Authentication Policies**
...
## Description
This check queries Active Directory to identify objects related to Trust Authentication Policies. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-027.exe csharp.cs
TMGMT-027.exe
```
...
- **CheckID**: The check identifier (TMGMT-027)
- **CheckName**: The check name (Trust Authentication Policies)
- **Name**: Object name
