...
## Overview
This security check performs analysis for: **External Trust Relationships**
...
## Description
This check queries Active Directory to identify objects related to External Trust Relationships. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-009.exe csharp.cs
TMGMT-009.exe
```
...
- **CheckID**: The check identifier (TMGMT-009)
- **CheckName**: The check name (External Trust Relationships)
- **Name**: Object name
