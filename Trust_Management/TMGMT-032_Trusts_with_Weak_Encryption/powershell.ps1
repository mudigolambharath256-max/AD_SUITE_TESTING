...
Write-Host "Executing: Trusts with Weak Encryption" -ForegroundColor Cyan
Write-Host "Check ID: TMGMT-032" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'TMGMT-032'}}, `
    @{N='CheckName'; E={'Trusts with Weak Encryption'}}, `
    @{N='RiskScore'; E={7}}, `
    @{N='Severity'; E={'HIGH'}}, `
    @{N='MITRE'; E={'T1558.003'}}, `
