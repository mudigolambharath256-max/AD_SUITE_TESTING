...
## Overview
This security check performs analysis for: **Trust Direction Configuration**
...
## Description
This check queries Active Directory to identify objects related to Trust Direction Configuration. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-005.exe csharp.cs
TMGMT-005.exe
```
...
- **CheckID**: The check identifier (TMGMT-005)
- **CheckName**: The check name (Trust Direction Configuration)
- **Name**: Object name
