...
## Overview
This security check performs analysis for: **Trust Supported Encryption Types**
...
## Description
This check queries Active Directory to identify objects related to Trust Supported Encryption Types. The results can be used for security auditing, compliance verification, and risk assessment.
...
```cmd
csc /out:TMGMT-021.exe csharp.cs
TMGMT-021.exe
```
...
- **CheckID**: The check identifier (TMGMT-021)
- **CheckName**: The check name (Trust Supported Encryption Types)
- **Name**: Object name
