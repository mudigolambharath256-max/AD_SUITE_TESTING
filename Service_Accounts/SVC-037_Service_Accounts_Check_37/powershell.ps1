...
try {
    ...
    Write-Host "SVC-037: found $($found.Count) objects"
    ...
    Write-Warning "SVC-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-037: Query failed : $_"
}
