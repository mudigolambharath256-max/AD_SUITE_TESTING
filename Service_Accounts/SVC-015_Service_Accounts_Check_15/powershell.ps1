...
try {
    ...
    Write-Host "SVC-015: found $($found.Count) objects"
    ...
    Write-Warning "SVC-015: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-015: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-015: Query failed — $_"
}
