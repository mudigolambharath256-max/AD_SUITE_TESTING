...
try {
    ...
    Write-Host "SVC-003: found $($found.Count) objects"
    ...
    Write-Warning "SVC-003: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-003: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-003: Query failed — $_"
}
