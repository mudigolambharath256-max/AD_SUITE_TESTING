...
try {
    ...
    Write-Host "SVC-004: found $($found.Count) objects"
    ...
    Write-Warning "SVC-004: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-004: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-004: Query failed : $_"
}
