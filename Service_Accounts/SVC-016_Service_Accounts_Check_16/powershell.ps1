...
try {
    ...
    Write-Host "SVC-016: found $($found.Count) objects"
    ...
    Write-Warning "SVC-016: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-016: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-016: Query failed — $_"
}
