...
try {
    ...
    Write-Host "SVC-021: found $($found.Count) objects"
    ...
    Write-Warning "SVC-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-021: Query failed : $_"
}
