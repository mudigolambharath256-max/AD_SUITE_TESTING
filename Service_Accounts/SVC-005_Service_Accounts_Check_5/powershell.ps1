...
try {
    ...
    Write-Host "SVC-005: found $($found.Count) objects"
    ...
    Write-Warning "SVC-005: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-005: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-005: Query failed — $_"
}
