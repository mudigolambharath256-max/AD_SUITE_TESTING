...
try {
    ...
    Write-Host "SVC-027: found $($found.Count) objects"
    ...
    Write-Warning "SVC-027: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-027: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-027: Query failed — $_"
}
