...
try {
    ...
    Write-Host "SVC-031: found $($found.Count) objects"
    ...
    Write-Warning "SVC-031: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-031: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-031: Query failed — $_"
}
