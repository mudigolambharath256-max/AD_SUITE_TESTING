...
try {
    ...
    Write-Host "SVC-013: found $($found.Count) objects"
    ...
    Write-Warning "SVC-013: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-013: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-013: Query failed : $_"
}
