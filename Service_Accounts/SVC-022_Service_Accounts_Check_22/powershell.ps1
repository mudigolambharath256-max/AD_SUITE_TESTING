...
try {
    ...
    Write-Host "SVC-022: found $($found.Count) objects"
    ...
    Write-Warning "SVC-022: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-022: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-022: Query failed : $_"
}
