...
try {
    ...
    Write-Host "SVC-029: found $($found.Count) objects"
    ...
    Write-Warning "SVC-029: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-029: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-029: Query failed : $_"
}
