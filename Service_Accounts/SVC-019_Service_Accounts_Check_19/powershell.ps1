...
try {
    ...
    Write-Host "SVC-019: found $($found.Count) objects"
    ...
    Write-Warning "SVC-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-019: Query failed : $_"
}
