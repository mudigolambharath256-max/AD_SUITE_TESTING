...
try {
    ...
    Write-Host "SVC-038: found $($found.Count) objects"
    ...
    Write-Warning "SVC-038: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-038: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-038: Query failed : $_"
}
