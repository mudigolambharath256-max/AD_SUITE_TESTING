...
try {
    ...
    Write-Host "SVC-035: found $($found.Count) objects"
    ...
    Write-Warning "SVC-035: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-035: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-035: Query failed : $_"
}
