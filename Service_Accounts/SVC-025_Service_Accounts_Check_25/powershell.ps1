...
try {
    ...
    Write-Host "SVC-025: found $($found.Count) objects"
    ...
    Write-Warning "SVC-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-025: Query failed : $_"
}
