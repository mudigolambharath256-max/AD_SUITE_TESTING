...
try {
    ...
    Write-Host "SVC-030: found $($found.Count) objects"
    ...
    Write-Warning "SVC-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-030: Query failed — $_"
}
