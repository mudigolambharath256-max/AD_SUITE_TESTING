...
try {
    ...
    Write-Host "SVC-020: found $($found.Count) objects"
    ...
    Write-Warning "SVC-020: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-020: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-020: Query failed — $_"
}
