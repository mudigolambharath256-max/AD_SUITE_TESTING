...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "SVC-021_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: SPN Accounts with “Do not require Kerberos preauth” + Non-expiring password
# Category: Service Accounts
# Severity: critical
# ID: SVC-021
# Requirements: None
