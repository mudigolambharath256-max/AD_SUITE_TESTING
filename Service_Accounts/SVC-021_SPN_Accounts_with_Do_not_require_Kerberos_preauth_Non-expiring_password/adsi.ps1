# Check: SPN Accounts with â€œDo not require Kerberos preauthâ€ + Non-expiring password
...
$results | ForEach-Object {
  $p = $_.Properties
  [PSCustomObject]@{
    Label = 'SPN Accounts with â€œDo not require Kerberos preauthâ€ + Non-expiring password'
    Name = $p['name'][0]
