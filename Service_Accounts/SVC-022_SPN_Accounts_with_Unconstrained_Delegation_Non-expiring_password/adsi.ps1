...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "SVC-022_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: SPN Accounts with Unconstrained Delegation + Non-expiring password
# Category: Service Accounts
# Severity: critical
# ID: SVC-022
# Requirements: None
