...
# Check: Service Accounts with “Password Not Required”
...
Write-Host "=== Multi-Engine Execution: Service Accounts with “Password Not Required” ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    $adsiResults = @(
        ...
        $searcher.FindAll() | ForEach-Object {
          $p = $_.Properties
          [PSCustomObject]@{
            Label = 'Service Accounts with “Password Not Required”'
            Name = $p['name'][0]
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SVC-011'
                adSuiteCheckName  = 'Service_Accounts_with_Password_Not_Required'
    ...
    $bhFile = Join-Path $bhDir "SVC-011_$bhTs.json"
    @{
