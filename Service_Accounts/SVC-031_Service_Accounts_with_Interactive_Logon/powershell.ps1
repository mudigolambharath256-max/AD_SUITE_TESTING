...
Write-Host "Executing: Service Accounts with Interactive Logon" -ForegroundColor Cyan
Write-Host "Check ID: SVC-031" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'SVC-031'}}, `
    @{N='CheckName'; E={'Service Accounts with Interactive Logon'}}, `
    @{N='RiskScore'; E={6}}, `
    @{N='Severity'; E={'MEDIUM'}}, `
    @{N='MITRE'; E={'T1078.002'}}, `
