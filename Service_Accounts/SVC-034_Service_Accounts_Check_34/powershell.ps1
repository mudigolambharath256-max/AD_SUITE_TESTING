...
try {
    ...
    Write-Host "SVC-034: found $($found.Count) objects"
    ...
    Write-Warning "SVC-034: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-034: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-034: Query failed — $_"
}
