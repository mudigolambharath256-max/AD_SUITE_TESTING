...
try {
    ...
    Write-Host "SVC-028: found $($found.Count) objects"
    ...
    Write-Warning "SVC-028: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-028: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-028: Query failed — $_"
}
