...
try {
    ...
    Write-Host "SVC-002: found $($found.Count) objects"
    ...
    Write-Warning "SVC-002: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-002: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-002: Query failed — $_"
}
