...
try {
    ...
    Write-Host "SVC-010: found $($found.Count) objects"
    ...
    Write-Warning "SVC-010: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-010: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-010: Query failed : $_"
}
