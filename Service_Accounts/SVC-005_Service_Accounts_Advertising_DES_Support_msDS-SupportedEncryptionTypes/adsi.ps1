...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "SVC-005_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Service Accounts Advertising DES Support (msDS-SupportedEncryptionTypes)
# Category: Service Accounts
# Severity: critical
# ID: SVC-005
# Requirements: None
