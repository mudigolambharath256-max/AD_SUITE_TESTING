...
try {
    ...
    Write-Host "SVC-006: found $($found.Count) objects"
    ...
    Write-Warning "SVC-006: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-006: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-006: Query failed : $_"
}
