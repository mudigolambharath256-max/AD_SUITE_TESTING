...
try {
    ...
    Write-Host "SVC-008: found $($found.Count) objects"
    ...
    Write-Warning "SVC-008: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-008: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-008: Query failed — $_"
}
