...
try {
    ...
    Write-Host "SVC-039: found $($found.Count) objects"
    ...
    Write-Warning "SVC-039: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-039: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-039: Query failed : $_"
}
