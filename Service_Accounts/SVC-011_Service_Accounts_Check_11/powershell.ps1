...
try {
    ...
    Write-Host "SVC-011: found $($found.Count) objects"
    ...
    Write-Warning "SVC-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-011: Query failed — $_"
}
