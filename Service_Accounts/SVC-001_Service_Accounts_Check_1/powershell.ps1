...
try {
    ...
    Write-Host "SVC-001: found $($found.Count) objects"
    ...
    Write-Warning "SVC-001: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-001: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-001: Query failed — $_"
}
