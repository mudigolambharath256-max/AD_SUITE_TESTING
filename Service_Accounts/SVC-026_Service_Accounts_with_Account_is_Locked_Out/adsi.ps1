...
$output = $results | ForEach-Object {
  ...
  [PSCustomObject]@{
    ...
    LockoutTime = Convert-FileTime ($p['lockouttime'] | Select-Object -First 1)
  }
}
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "SVC-026_nodes.json"
    ...
    Write-Warning "[BloodHound] Export failed: # Check: Service Accounts with “Account is Locked Out”
# Category: Service Accounts
# Severity: low
# ID: SVC-026
# Requirements: None
