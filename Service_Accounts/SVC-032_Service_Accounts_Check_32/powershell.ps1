...
try {
    ...
    Write-Host "SVC-032: found $($found.Count) objects"
    ...
    Write-Warning "SVC-032: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-032: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-032: Query failed — $_"
}
