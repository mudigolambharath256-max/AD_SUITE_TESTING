...
try {
    ...
    Write-Host "SVC-033: found $($found.Count) objects"
    ...
    Write-Warning "SVC-033: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-033: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-033: Query failed : $_"
}
