...
try {
    ...
    Write-Host "SVC-036: found $($found.Count) objects"
    ...
    Write-Warning "SVC-036: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-036: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-036: Query failed : $_"
}
