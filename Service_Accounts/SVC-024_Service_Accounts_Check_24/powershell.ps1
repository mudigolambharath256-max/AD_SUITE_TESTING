...
try {
    ...
    Write-Host "SVC-024: found $($found.Count) objects"
    ...
    Write-Warning "SVC-024: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-024: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-024: Query failed — $_"
}
