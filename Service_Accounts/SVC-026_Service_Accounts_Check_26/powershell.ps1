...
try {
    ...
    Write-Host "SVC-026: found $($found.Count) objects"
    ...
    Write-Warning "SVC-026: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-026: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-026: Query failed — $_"
}
