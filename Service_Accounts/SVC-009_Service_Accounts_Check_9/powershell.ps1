...
try {
    ...
    Write-Host "SVC-009: found $($found.Count) objects"
    ...
    Write-Warning "SVC-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-009: Query failed — $_"
}
