...
try {
    ...
    Write-Host "SVC-007: found $($found.Count) objects"
    ...
    Write-Warning "SVC-007: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-007: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-007: Query failed — $_"
}
