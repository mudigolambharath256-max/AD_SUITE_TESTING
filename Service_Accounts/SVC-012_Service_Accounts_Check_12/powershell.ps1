...
try {
    ...
    Write-Host "SVC-012: found $($found.Count) objects"
    ...
    Write-Warning "SVC-012: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-012: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-012: Query failed : $_"
}
