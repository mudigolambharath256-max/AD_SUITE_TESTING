...
try {
    ...
    Write-Host "SVC-017: found $($found.Count) objects"
    ...
    Write-Warning "SVC-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-017: Query failed — $_"
}
