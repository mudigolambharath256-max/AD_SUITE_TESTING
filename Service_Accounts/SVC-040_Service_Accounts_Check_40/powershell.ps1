...
try {
    ...
    Write-Host "SVC-040: found $($found.Count) objects"
    ...
    Write-Warning "SVC-040: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-040: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-040: Query failed : $_"
}
