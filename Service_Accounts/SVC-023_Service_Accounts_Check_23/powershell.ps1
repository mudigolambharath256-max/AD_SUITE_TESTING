...
try {
    ...
    Write-Host "SVC-023: found $($found.Count) objects"
    ...
    Write-Warning "SVC-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-023: Query failed : $_"
}
