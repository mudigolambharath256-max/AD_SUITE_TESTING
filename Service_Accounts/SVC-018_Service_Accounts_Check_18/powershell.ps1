...
try {
    ...
    Write-Host "SVC-018: found $($found.Count) objects"
    ...
    Write-Warning "SVC-018: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "SVC-018: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "SVC-018: Query failed : $_"
}
