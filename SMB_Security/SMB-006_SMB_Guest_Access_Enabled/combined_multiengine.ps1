# ============================================================================
# SMB-006: SMB Guest Access Enabled - Multi-Engine
# ============================================================================
...
#   It CANNOT determine guest SMB access (requires local user account checks) via LDAP alone.
...
Write-Host "[SMB-006] SMB Guest Access Enabled" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-006'
                adSuiteCheckName  = 'SMB_Guest_Access_Enabled'
    ...
    $bhFile = Join-Path $bhDir "SMB-006_$bhTs.json"
    @{
