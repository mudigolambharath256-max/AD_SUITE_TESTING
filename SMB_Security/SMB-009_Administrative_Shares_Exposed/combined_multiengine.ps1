# ============================================================================
# SMB-009: Administrative Shares Exposed - Multi-Engine
# ============================================================================
...
#   It CANNOT determine administrative share exposure (requires WMI or net share enumeration) via LDAP alone.
...
Write-Host "[SMB-009] Administrative Shares Exposed" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-009'
                adSuiteCheckName  = 'Administrative_Shares_Exposed'
    ...
    $bhFile = Join-Path $bhDir "SMB-009_$bhTs.json"
    @{
