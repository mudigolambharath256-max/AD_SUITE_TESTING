# ============================================================================
# SMB-010: SMB Dialect Negotiation Weak - Multi-Engine
# ============================================================================
...
#   It CANNOT determine SMB dialect negotiation settings (requires Get-SmbServerConfiguration) via LDAP alone.
...
Write-Host "[SMB-010] SMB Dialect Negotiation Weak" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-010'
                adSuiteCheckName  = 'SMB_Dialect_Negotiation_Weak'
    ...
    $bhFile = Join-Path $bhDir "SMB-010_$bhTs.json"
    @{
