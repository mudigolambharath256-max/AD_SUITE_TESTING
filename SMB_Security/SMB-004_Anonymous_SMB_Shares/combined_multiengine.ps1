# ============================================================================
# SMB-004: Anonymous SMB Shares - Multi-Engine
# ============================================================================
...
#   It CANNOT determine anonymous share access (requires net share or WMI Win32_Share) via LDAP alone.
...
Write-Host "[SMB-004] Anonymous SMB Shares" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-004'
                adSuiteCheckName  = 'Anonymous_SMB_Shares'
    ...
    $bhFile = Join-Path $bhDir "SMB-004_$bhTs.json"
    @{
