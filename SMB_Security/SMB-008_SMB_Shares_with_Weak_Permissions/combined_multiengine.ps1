# ============================================================================
# SMB-008: SMB Shares with Weak Permissions - Multi-Engine
# ============================================================================
...
#   It CANNOT determine share permissions (requires WMI Win32_Share and ACL enumeration) via LDAP alone.
...
Write-Host "[SMB-008] SMB Shares with Weak Permissions" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-008'
                adSuiteCheckName  = 'SMB_Shares_with_Weak_Permissions'
    ...
    $bhFile = Join-Path $bhDir "SMB-008_$bhTs.json"
    @{
