# ============================================================================
# SMB-012: SMB Audit Logging Disabled - Multi-Engine
# ============================================================================
...
#   It CANNOT determine SMB audit logging status (requires Group Policy or registry audit settings) via LDAP alone.
...
Write-Host "[SMB-012] SMB Audit Logging Disabled" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-012'
                adSuiteCheckName  = 'SMB_Audit_Logging_Disabled'
    ...
    $bhFile = Join-Path $bhDir "SMB-012_$bhTs.json"
    @{
