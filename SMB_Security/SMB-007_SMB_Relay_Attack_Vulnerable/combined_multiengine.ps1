# ============================================================================
# SMB-007: SMB Relay Attack Vulnerable - Multi-Engine
# ============================================================================
...
#   It CANNOT determine NTLM relay exposure (requires SMB signing + LDAP signing configuration checks) via LDAP alone.
...
Write-Host "[SMB-007] SMB Relay Attack Vulnerable" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-007'
                adSuiteCheckName  = 'SMB_Relay_Attack_Vulnerable'
    ...
    $bhFile = Join-Path $bhDir "SMB-007_$bhTs.json"
    @{
