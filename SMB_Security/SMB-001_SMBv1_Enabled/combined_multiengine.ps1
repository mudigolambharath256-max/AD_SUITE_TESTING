# ============================================================================
# SMB-001: SMBv1 Enabled - Multi-Engine
# ============================================================================
...
#   It CANNOT determine whether SMBv1 is enabled (requires registry: HKLM\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters\SMB1) via LDAP alone.
...
Write-Host "[SMB-001] SMBv1 Enabled" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-001'
                adSuiteCheckName  = 'SMBv1_Enabled'
    ...
    $bhFile = Join-Path $bhDir "SMB-001_$bhTs.json"
    @{
