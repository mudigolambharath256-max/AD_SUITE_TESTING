# ============================================================================
# SMB-011: SMB Compression Vulnerabilities - Multi-Engine
# ============================================================================
...
#   It CANNOT determine SMB compression settings (requires registry or Get-SmbServerConfiguration) via LDAP alone.
...
Write-Host "[SMB-011] SMB Compression Vulnerabilities" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-011'
                adSuiteCheckName  = 'SMB_Compression_Vulnerabilities'
    ...
    $bhFile = Join-Path $bhDir "SMB-011_$bhTs.json"
    @{
