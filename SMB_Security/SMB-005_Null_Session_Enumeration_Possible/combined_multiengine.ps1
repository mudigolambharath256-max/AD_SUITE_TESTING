# ============================================================================
# SMB-005: Null Session Enumeration Possible - Multi-Engine
# ============================================================================
...
#   It CANNOT determine null session state (requires registry HKLM\System\CurrentControlSet\Control\Lsa\RestrictAnonymous) via LDAP alone.
...
Write-Host "[SMB-005] Null Session Enumeration Possible" -ForegroundColor Cyan
...
try {
    ...
    foreach ($r in $uniqueResults) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'SMB-005'
                adSuiteCheckName  = 'Null_Session_Enumeration_Possible'
    ...
    $bhFile = Join-Path $bhDir "SMB-005_$bhTs.json"
    @{
