...
## Overview
This security check performs analysis for: **Constrained Delegation Principals**
...
## Description
This check queries Active Directory to identify objects related to Constrained Delegation Principals. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-028)
- **CheckName**: The check name (Constrained Delegation Principals)
- **Name**: Object name
