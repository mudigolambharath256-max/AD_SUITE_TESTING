...
try {
    ...
    Write-Host "ACC-035: found $($found.Count) objects"
    ...
    Write-Warning "ACC-035: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-035: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-035: Query failed : $_"
}
