...
try {
    ...
    Write-Host "ACC-016: found $($found.Count) objects"
    ...
    Write-Warning "ACC-016: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-016: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-016: Query failed : $_"
}
