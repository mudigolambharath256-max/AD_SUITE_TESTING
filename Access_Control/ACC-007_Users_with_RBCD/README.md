...
## Overview
This security check performs analysis for: **Users with RBCD**
...
## Description
This check queries Active Directory to identify objects related to Users with RBCD. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-007)
- **CheckName**: The check name (Users with RBCD)
- **Name**: Object name
