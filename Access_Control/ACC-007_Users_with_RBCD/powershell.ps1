...
Write-Host "Executing security check: Users with RBCD" -ForegroundColor Yellow
Write-Host "Check ID: ACC-007" -ForegroundColor Gray
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-007_Users_with_RBCD\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-007_Users_with_RBCD\powershell.ps1_$bhTs.json"
    @{
