...
try {
    ...
    Write-Host "ACC-021: found $($found.Count) objects"
    ...
    Write-Warning "ACC-021: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-021: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-021: Query failed : $_"
}
