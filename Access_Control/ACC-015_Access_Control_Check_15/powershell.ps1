...
try {
    ...
    Write-Host "ACC-015: found $($found.Count) objects"
    ...
    Write-Warning "ACC-015: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-015: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-015: Query failed : $_"
}
