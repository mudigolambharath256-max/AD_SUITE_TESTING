...
try {
    ...
    Write-Host "ACC-003: found $($found.Count) objects"
    ...
    Write-Warning "ACC-003: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-003: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-003: Query failed : $_"
}
