...
## Overview
This security check performs analysis for: **Print Operators Group Members**
...
## Description
This check queries Active Directory to identify objects related to Print Operators Group Members. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-020)
- **CheckName**: The check name (Print Operators Group Members)
- **Name**: Object name
