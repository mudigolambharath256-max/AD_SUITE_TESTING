...
try {
    ...
    Write-Host "ACC-034: found $($found.Count) objects"
    ...
    Write-Warning "ACC-034: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-034: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-034: Query failed : $_"
}
