...
## Overview
This security check performs analysis for: **Admin SDHolder Template**
...
## Description
This check queries Active Directory to identify objects related to Admin SDHolder Template. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-029)
- **CheckName**: The check name (Admin SDHolder Template)
- **Name**: Object name
