...
try {
    ...
    Write-Host "ACC-042: found $($found.Count) objects"
    ...
    Write-Warning "ACC-042: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-042: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-042: Query failed — $_"
}
