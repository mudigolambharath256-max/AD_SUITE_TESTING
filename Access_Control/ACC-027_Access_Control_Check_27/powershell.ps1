...
try {
    ...
    Write-Host "ACC-027: found $($found.Count) objects"
    ...
    Write-Warning "ACC-027: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-027: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-027: Query failed : $_"
}
