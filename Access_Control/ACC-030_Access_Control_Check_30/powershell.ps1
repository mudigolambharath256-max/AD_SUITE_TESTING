...
try {
    ...
    Write-Host "ACC-030: found $($found.Count) objects"
    ...
    Write-Warning "ACC-030: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-030: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-030: Query failed — $_"
}
