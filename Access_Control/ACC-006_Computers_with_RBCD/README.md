...
## Overview
This security check performs analysis for: **Computers with RBCD**
...
## Description
This check queries Active Directory to identify objects related to Computers with RBCD. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-006)
- **CheckName**: The check name (Computers with RBCD)
- **Name**: Object name
