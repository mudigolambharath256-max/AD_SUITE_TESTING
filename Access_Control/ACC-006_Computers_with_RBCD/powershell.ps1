...
Write-Host "Executing security check: Computers with RBCD" -ForegroundColor Yellow
Write-Host "Check ID: ACC-006" -ForegroundColor Gray
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-006_Computers_with_RBCD\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-006_Computers_with_RBCD\powershell.ps1_$bhTs.json"
    @{
