...
try {
    ...
    Write-Host "ACC-040: found $($found.Count) objects"
    ...
    Write-Warning "ACC-040: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-040: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-040: Query failed — $_"
}
