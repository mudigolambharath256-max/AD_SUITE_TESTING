...
try {
    ...
    Write-Host "ACC-032: found $($found.Count) objects"
    ...
    Write-Warning "ACC-032: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-032: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-032: Query failed : $_"
}
