...
$ldapFilter = '(&(objectClass=user)(msDS-AllowedToActOnBehalfOfOtherIdentity=*))'
...
try {
    ...
    Write-Host "ACC-006: found $($found.Count) objects"
    ...
    Write-Warning "ACC-006: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-006: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-006: Query failed — $_"
}
