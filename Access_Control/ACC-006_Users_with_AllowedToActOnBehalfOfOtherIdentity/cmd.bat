REM Check: Users with AllowedToActOnBehalfOfOtherIdentity
...
@echo off
dsquery * -filter "(&(objectClass=user)(msDS-AllowedToActOnBehalfOfOtherIdentity=*))" -limit 0 -attr name distinguishedName samAccountName msDS-AllowedToActOnBehalfOfOtherIdentity
