...
try {
    ...
    Write-Host "ACC-014: found $($found.Count) objects"
    ...
    Write-Warning "ACC-014: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-014: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-014: Query failed — $_"
}
