...
## Overview
This security check performs analysis for: **Users with SIDHistory**
...
## Description
This check queries Active Directory to identify objects related to Users with SIDHistory. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-004)
- **CheckName**: The check name (Users with SIDHistory)
- **Name**: Object name
