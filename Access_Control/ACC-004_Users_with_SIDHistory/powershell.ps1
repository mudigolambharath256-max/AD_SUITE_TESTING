...
$ldapFilter = '(&(objectClass=user)(sIDHistory=*))'
$props      = @('name','distinguishedName','samAccountName','sIDHistory', 'objectSid')
...
try {
    ...
    Write-Host "ACC-004: found $($found.Count) objects"
    ...
    Write-Warning "ACC-004: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-004: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-004: Query failed — $_"
}
