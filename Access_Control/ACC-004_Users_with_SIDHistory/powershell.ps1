...
Write-Host "Executing security check: Users with SIDHistory" -ForegroundColor Yellow
Write-Host "Check ID: ACC-004" -ForegroundColor Gray
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-004_Users_with_SIDHistory\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-004_Users_with_SIDHistory\powershell.ps1_$bhTs.json"
    @{
