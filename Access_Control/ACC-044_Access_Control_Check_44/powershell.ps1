...
try {
    ...
    Write-Host "ACC-044: found $($found.Count) objects"
    ...
    Write-Warning "ACC-044: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-044: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-044: Query failed — $_"
}
