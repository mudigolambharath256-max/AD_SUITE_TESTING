...
try {
    ...
    Write-Host "ACC-013: found $($found.Count) objects"
    ...
    Write-Warning "ACC-013: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-013: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-013: Query failed : $_"
}
