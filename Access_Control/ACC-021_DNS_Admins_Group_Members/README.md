...
## Overview
This security check performs analysis for: **DNS Admins Group Members**
...
## Description
This check queries Active Directory to identify objects related to DNS Admins Group Members. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-021)
- **CheckName**: The check name (DNS Admins Group Members)
- **Name**: Object name
