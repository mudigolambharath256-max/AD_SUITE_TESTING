...
try {
    ...
    Write-Host "ACC-029: found $($found.Count) objects"
    ...
    Write-Warning "ACC-029: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-029: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-029: Query failed — $_"
}
