...
## Overview
This security check performs analysis for: **Enterprise Admins Group Members**
...
## Description
This check queries Active Directory to identify objects related to Enterprise Admins Group Members. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-015)
- **CheckName**: The check name (Enterprise Admins Group Members)
- **Name**: Object name
