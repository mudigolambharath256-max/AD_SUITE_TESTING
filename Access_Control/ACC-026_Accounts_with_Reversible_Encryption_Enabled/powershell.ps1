# ============================================================================
# ACC-026: Accounts with Reversible Encryption Enabled
# ============================================================================
...
$ldapFilter = '(&(objectCategory=person)(objectClass=user)(userAccountControl:1.2.840.113556.1.4.803:=128)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Accounts with Reversible Encryption Enabled" -ForegroundColor Yellow
Write-Host "Check ID: ACC-026" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-026'}}, `
    @{N='CheckName'; E={'Accounts with Reversible Encryption Enabled'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-026_Accounts_with_Reversible_Encryption_Enabled\powershell.ps1'
                adSuiteCheckName  = 'Accounts_with_Reversible_Encryption_Enabled'
                adSuiteHIGH   = 'HIGH'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-026_Accounts_with_Reversible_Encryption_Enabled\powershell.ps1_$bhTs.json"
    @{
