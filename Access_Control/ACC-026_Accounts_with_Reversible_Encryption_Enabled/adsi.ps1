...
Write-Host "Found $($results.Count) objects for check: Accounts with Reversible Encryption Enabled" -ForegroundColor Cyan
...
try {
    ...
    if ($results -and $results.Count -gt 0) {
        ...
        $bhFile = Join-Path $bhDir "ACC-026_nodes.json"
