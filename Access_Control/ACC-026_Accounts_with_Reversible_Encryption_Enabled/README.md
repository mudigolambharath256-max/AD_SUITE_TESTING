...
## Overview
This security check performs analysis for: **Accounts with Reversible Encryption Enabled**
...
## Description
This check queries Active Directory to identify objects related to Accounts with Reversible Encryption Enabled. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-026)
- **CheckName**: The check name (Accounts with Reversible Encryption Enabled)
- **Name**: Object name
