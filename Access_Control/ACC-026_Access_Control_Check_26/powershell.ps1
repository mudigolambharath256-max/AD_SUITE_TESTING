...
try {
    ...
    Write-Host "ACC-026: found $($found.Count) objects"
    ...
    Write-Warning "ACC-026: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-026: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-026: Query failed : $_"
}
