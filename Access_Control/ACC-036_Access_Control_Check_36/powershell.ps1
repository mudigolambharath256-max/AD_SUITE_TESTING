...
try {
    ...
    Write-Host "ACC-036: found $($found.Count) objects"
    ...
    Write-Warning "ACC-036: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-036: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-036: Query failed : $_"
}
