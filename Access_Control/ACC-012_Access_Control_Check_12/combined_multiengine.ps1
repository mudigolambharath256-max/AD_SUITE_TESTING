...
Write-Host "=== Access Control Check 12 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACC-012 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "ACC-012 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "ACC-012 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== ACC-012: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "ACC-012_results.csv"
$uniqueResults |
