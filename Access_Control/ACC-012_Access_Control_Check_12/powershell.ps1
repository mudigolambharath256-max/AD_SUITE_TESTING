...
try {
    ...
    Write-Host "ACC-012: found $($found.Count) objects"
    ...
    Write-Warning "ACC-012: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-012: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-012: Query failed — $_"
}
