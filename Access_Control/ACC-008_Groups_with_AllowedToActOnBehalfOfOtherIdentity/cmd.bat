REM Check: Groups with AllowedToActOnBehalfOfOtherIdentity
...
@echo off
dsquery * -filter "(&(objectClass=group)(msDS-AllowedToActOnBehalfOfOtherIdentity=*))" -limit 0 -attr name distinguishedName cn msDS-AllowedToActOnBehalfOfOtherIdentity
