# ============================================================================
# ACC-045: Privileged Access Workstation PAW Computers
# ============================================================================
...
$ldapFilter = '(&(objectCategory=person)(objectClass=user)(userAccountControl:1.2.840.113556.1.4.803:=1048576)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Privileged Access Workstation PAW Computers" -ForegroundColor Yellow
Write-Host "Check ID: ACC-030" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-045'}}, `
    @{N='CheckName'; E={'Privileged Access Workstation PAW Computers'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-045_Privileged_Access_Workstation_PAW_Computers\powershell.ps1'
                adSuiteCheckName  = 'Privileged_Access_Workstation_PAW_Computers'
                adSuiteHIGH   = 'HIGH'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-045_Privileged_Access_Workstation_PAW_Computers\powershell.ps1_$bhTs.json"
    @{
