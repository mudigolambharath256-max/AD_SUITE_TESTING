...
## Overview
This security check performs analysis for: **Privileged Access Workstation PAW Computers**
...
## Description
This check queries Active Directory to identify objects related to Privileged Access Workstation PAW Computers. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-030)
- **CheckName**: The check name (Privileged Access Workstation PAW Computers)
- **Name**: Object name
