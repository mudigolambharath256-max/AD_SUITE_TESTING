...
## Overview
This security check performs analysis for: **GPO Folder Rights Review**
...
## Description
This check queries Active Directory to identify objects related to GPO Folder Rights Review. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-013)
- **CheckName**: The check name (GPO Folder Rights Review)
- **Name**: Object name
