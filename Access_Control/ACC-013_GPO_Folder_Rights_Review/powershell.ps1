# ============================================================================
# ACC-013: GPO Folder Rights Review
# ============================================================================
...
$ldapFilter = '(&(objectClass=groupPolicyContainer)(!(flags:1.2.840.113556.1.4.803:=1)))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: GPO Folder Rights Review" -ForegroundColor Yellow
Write-Host "Check ID: ACC-013" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-013'}}, `
    @{N='CheckName'; E={'GPO Folder Rights Review'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-013_GPO_Folder_Rights_Review\powershell.ps1'
                adSuiteCheckName  = 'GPO_Folder_Rights_Review'
                adSuiteHIGH   = 'HIGH'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-013_GPO_Folder_Rights_Review\powershell.ps1_$bhTs.json"
    @{
