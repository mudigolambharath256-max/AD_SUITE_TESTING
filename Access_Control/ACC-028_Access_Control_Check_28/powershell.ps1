...
try {
    ...
    Write-Host "ACC-028: found $($found.Count) objects"
    ...
    Write-Warning "ACC-028: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-028: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-028: Query failed — $_"
}
