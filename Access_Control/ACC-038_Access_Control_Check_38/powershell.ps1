...
try {
    ...
    Write-Host "ACC-038: found $($found.Count) objects"
    ...
    Write-Warning "ACC-038: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-038: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-038: Query failed : $_"
}
