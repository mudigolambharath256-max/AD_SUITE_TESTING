...
try {
    ...
    Write-Host "ACC-045: found $($found.Count) objects"
    ...
    Write-Warning "ACC-045: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-045: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-045: Query failed — $_"
}
