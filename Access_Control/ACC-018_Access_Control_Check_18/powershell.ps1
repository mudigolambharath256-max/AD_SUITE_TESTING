...
try {
    ...
    Write-Host "ACC-018: found $($found.Count) objects"
    ...
    Write-Warning "ACC-018: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-018: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-018: Query failed — $_"
}
