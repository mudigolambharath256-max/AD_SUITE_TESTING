...
try {
    ...
    Write-Host "ACC-025: found $($found.Count) objects"
    ...
    Write-Warning "ACC-025: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-025: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-025: Query failed : $_"
}
