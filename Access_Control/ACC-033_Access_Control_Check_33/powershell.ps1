...
try {
    ...
    Write-Host "ACC-033: found $($found.Count) objects"
    ...
    Write-Warning "ACC-033: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-033: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-033: Query failed : $_"
}
