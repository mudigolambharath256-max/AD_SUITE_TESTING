...
try {
    ...
    Write-Host "ACC-011: found $($found.Count) objects"
    ...
    Write-Warning "ACC-011: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-011: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-011: Query failed — $_"
}
