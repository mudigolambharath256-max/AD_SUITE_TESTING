...
## Overview
This security check performs analysis for: **Users Can Add Computers to Domain**
...
## Description
This check queries Active Directory to identify objects related to Users Can Add Computers to Domain. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-025)
- **CheckName**: The check name (Users Can Add Computers to Domain)
- **Name**: Object name
