...
Write-Host "Executing security check: Users Can Add Computers to Domain" -ForegroundColor Yellow
Write-Host "Check ID: ACC-025" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-025'}}, `
    @{N='CheckName'; E={'Users Can Add Computers to Domain'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-025_Users_Can_Add_Computers_to_Domain\powershell.ps1'
                adSuiteCheckName  = 'Users_Can_Add_Computers_to_Domain'
                adSuiteHIGH   = 'HIGH'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-025_Users_Can_Add_Computers_to_Domain\powershell.ps1_$bhTs.json"
    @{
