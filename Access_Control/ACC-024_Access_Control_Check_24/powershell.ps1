...
try {
    ...
    Write-Host "ACC-024: found $($found.Count) objects"
    ...
    Write-Warning "ACC-024: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-024: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-024: Query failed — $_"
}
