...
Write-Host "Executing security check: Privileged Users adminCount1" -ForegroundColor Yellow
Write-Host "Check ID: ACC-001" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-001'}}, `
    @{N='CheckName'; E={'Privileged Users adminCount1'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-001_Privileged_Users_adminCount1\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-001_Privileged_Users_adminCount1\powershell.ps1_$bhTs.json"
    @{
