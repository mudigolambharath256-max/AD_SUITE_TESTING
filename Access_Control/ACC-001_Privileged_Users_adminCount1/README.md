...
## Overview
This security check performs analysis for: **Privileged Users adminCount1**
...
## Description
This check queries Active Directory to identify objects related to Privileged Users adminCount1. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-001)
- **CheckName**: The check name (Privileged Users adminCount1)
- **Name**: Object name
