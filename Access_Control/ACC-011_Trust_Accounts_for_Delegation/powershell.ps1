...
Write-Host "Executing security check: Trust Accounts for Delegation" -ForegroundColor Yellow
Write-Host "Check ID: ACC-011" -ForegroundColor Gray
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-011_Trust_Accounts_for_Delegation\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-011_Trust_Accounts_for_Delegation\powershell.ps1_$bhTs.json"
    @{
