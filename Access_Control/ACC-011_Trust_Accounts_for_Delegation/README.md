...
## Overview
This security check performs analysis for: **Trust Accounts for Delegation**
...
## Description
This check queries Active Directory to identify objects related to Trust Accounts for Delegation. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-011)
- **CheckName**: The check name (Trust Accounts for Delegation)
- **Name**: Object name
