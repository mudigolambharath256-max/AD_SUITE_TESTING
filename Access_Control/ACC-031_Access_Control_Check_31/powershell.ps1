...
try {
    ...
    Write-Host "ACC-031: found $($found.Count) objects"
    ...
    Write-Warning "ACC-031: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-031: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-031: Query failed : $_"
}
