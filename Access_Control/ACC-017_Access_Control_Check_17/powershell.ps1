...
try {
    ...
    Write-Host "ACC-017: found $($found.Count) objects"
    ...
    Write-Warning "ACC-017: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-017: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-017: Query failed — $_"
}
