...
## Overview
This security check performs analysis for: **Privileged Computers adminCount1**
...
## Description
This check queries Active Directory to identify objects related to Privileged Computers adminCount1. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-003)
- **CheckName**: The check name (Privileged Computers adminCount1)
- **Name**: Object name
