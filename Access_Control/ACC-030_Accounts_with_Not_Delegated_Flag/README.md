...
## Overview
This security check performs analysis for: **Accounts with Not Delegated Flag**
...
## Description
This check queries Active Directory to identify objects related to Accounts with Not Delegated Flag. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckName**: The check name (Accounts with Not Delegated Flag)
- **Name**: Object name
