# ============================================================================
# ACC-030: Accounts with Not Delegated Flag
# ============================================================================
...
Write-Host "Executing security check: Accounts with Not Delegated Flag" -ForegroundColor Yellow
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-030'}}, `
    @{N='CheckName'; E={'Accounts with Not Delegated Flag'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-030_Accounts_with_Not_Delegated_Flag\powershell.ps1'
                adSuiteCheckName  = 'Accounts_with_Not_Delegated_Flag'
                adSuiteHIGH   = 'HIGH'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-030_Accounts_with_Not_Delegated_Flag\powershell.ps1_$bhTs.json"
    @{
