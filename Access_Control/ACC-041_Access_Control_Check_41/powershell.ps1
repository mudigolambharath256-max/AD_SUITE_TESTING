...
try {
    ...
    Write-Host "ACC-041: found $($found.Count) objects"
    ...
    Write-Warning "ACC-041: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-041: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-041: Query failed : $_"
}
