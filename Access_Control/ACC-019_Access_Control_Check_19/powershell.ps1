...
try {
    ...
    Write-Host "ACC-019: found $($found.Count) objects"
    ...
    Write-Warning "ACC-019: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-019: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-019: Query failed : $_"
}
