...
try {
    ...
    Write-Host "ACC-022: found $($found.Count) objects"
    ...
    Write-Warning "ACC-022: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-022: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-022: Query failed : $_"
}
