REM Check: Computers with Key Credentials
...
@echo off
dsquery * -filter "(&(objectCategory=computer)(msDS-KeyCredentialLink=*))" -limit 0 -attr name distinguishedName samAccountName msDS-KeyCredentialLink
