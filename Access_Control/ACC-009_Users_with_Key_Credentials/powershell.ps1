...
$ldapFilter = '(&(objectClass=user)(msDS-KeyCredentialLink=*))'
...
try {
    ...
    Write-Host "ACC-009: found $($found.Count) objects"
    ...
    Write-Warning "ACC-009: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-009: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-009: Query failed — $_"
}
