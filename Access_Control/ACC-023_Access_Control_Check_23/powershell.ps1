...
try {
    ...
    Write-Host "ACC-023: found $($found.Count) objects"
    ...
    Write-Warning "ACC-023: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-023: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-023: Query failed : $_"
}
