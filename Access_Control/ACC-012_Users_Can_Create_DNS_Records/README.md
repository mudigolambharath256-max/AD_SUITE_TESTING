...
## Overview
This security check performs analysis for: **Users Can Create DNS Records**
...
## Description
This check queries Active Directory to identify objects related to Users Can Create DNS Records. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-012)
- **CheckName**: The check name (Users Can Create DNS Records)
- **Name**: Object name
