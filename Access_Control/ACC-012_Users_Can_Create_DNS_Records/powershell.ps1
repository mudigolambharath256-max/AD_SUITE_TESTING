...
Write-Host "Executing security check: Users Can Create DNS Records" -ForegroundColor Yellow
Write-Host "Check ID: ACC-012" -ForegroundColor Gray
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-012_Users_Can_Create_DNS_Records\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-012_Users_Can_Create_DNS_Records\powershell.ps1_$bhTs.json"
    @{
