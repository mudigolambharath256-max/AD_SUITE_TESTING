...
Write-Host "Executing security check: Privileged Groups adminCount1" -ForegroundColor Yellow
Write-Host "Check ID: ACC-002" -ForegroundColor Gray
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-002_Privileged_Groups_adminCount1\powershell.ps1'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-002_Privileged_Groups_adminCount1\powershell.ps1_$bhTs.json"
    @{
