...
## Overview
This security check performs analysis for: **Privileged Groups adminCount1**
...
## Description
This check queries Active Directory to identify objects related to Privileged Groups adminCount1. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-002)
- **CheckName**: The check name (Privileged Groups adminCount1)
- **Name**: Object name
