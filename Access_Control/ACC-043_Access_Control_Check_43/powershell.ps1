...
try {
    ...
    Write-Host "ACC-043: found $($found.Count) objects"
    ...
    Write-Warning "ACC-043: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-043: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-043: Query failed : $_"
}
