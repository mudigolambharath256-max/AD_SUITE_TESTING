...
## Overview
This security check performs analysis for: **Backup Operators Group Members**
...
## Description
This check queries Active Directory to identify objects related to Backup Operators Group Members. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-017)
- **CheckName**: The check name (Backup Operators Group Members)
- **Name**: Object name
