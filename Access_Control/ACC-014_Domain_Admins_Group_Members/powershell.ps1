# ============================================================================
# ACC-014: Domain Admins Group Members
# ============================================================================
...
$ldapFilter = '(&(objectClass=group)(samAccountName=Domain Admins))'

# Define properties to retrieve
$properties = @('name', 'distinguishedName', 'objectClass', 'whenCreated', 'whenChanged', 'objectSid')

Write-Host "Executing security check: Domain Admins Group Members" -ForegroundColor Yellow
Write-Host "Check ID: ACC-014" -ForegroundColor Gray
...
$output = $results | Select-Object `
    @{N='CheckID'; E={'ACC-014'}}, `
    @{N='CheckName'; E={'Domain Admins Group Members'}}, `
...
try {
    ...
    foreach ($r in $output) {
        ...
        $bhNodes.Add(@{
            ...
            Properties       = @{
                ...
                enabled           = $true
                adSuiteCheckId    = 'C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-014_Domain_Admins_Group_Members\powershell.ps1'
                adSuiteCheckName  = 'Domain_Admins_Group_Members'
                adSuiteHIGH   = 'HIGH'
    ...
    $bhFile = Join-Path $bhDir "C:\Users\acer\Downloads\AD_suiteXXX\Access_Control\ACC-014_Domain_Admins_Group_Members\powershell.ps1_$bhTs.json"
    @{
