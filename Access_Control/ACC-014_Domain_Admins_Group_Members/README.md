...
## Overview
This security check performs analysis for: **Domain Admins Group Members**
...
## Description
This check queries Active Directory to identify objects related to Domain Admins Group Members. The results can be used for security auditing, compliance verification, and risk assessment.
...
- **CheckID**: The check identifier (ACC-014)
- **CheckName**: The check name (Domain Admins Group Members)
- **Name**: Object name
