...
try {
    ...
    Write-Host "ACC-037: found $($found.Count) objects"
    ...
    Write-Warning "ACC-037: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-037: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-037: Query failed : $_"
}
