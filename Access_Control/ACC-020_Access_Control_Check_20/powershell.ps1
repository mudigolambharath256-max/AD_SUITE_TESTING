...
try {
    ...
    Write-Host "ACC-020: found $($found.Count) objects"
    ...
    Write-Warning "ACC-020: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "ACC-020: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "ACC-020: Query failed : $_"
}
