...
try {
    ...
    Write-Host "MISC-667: found $($found.Count) objects"
    ...
    Write-Warning "MISC-667: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-667: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-667: Query failed — $_"
}
