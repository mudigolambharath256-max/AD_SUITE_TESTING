...
try {
    ...
    Write-Host "MISC-654: found $($found.Count) objects"
    ...
    Write-Warning "MISC-654: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-654: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-654: Query failed : $_"
}
