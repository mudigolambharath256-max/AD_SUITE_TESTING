...
try {
    ...
    Write-Host "MISC-655: found $($found.Count) objects"
    ...
    Write-Warning "MISC-655: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-655: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-655: Query failed — $_"
}
