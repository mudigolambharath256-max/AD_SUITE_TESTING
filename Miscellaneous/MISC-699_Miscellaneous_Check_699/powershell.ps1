...
try {
    ...
    Write-Host "MISC-699: found $($found.Count) objects"
    ...
    Write-Warning "MISC-699: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-699: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-699: Query failed — $_"
}
