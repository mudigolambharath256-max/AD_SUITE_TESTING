...
try {
    ...
    Write-Host "MISC-746: found $($found.Count) objects"
    ...
    Write-Warning "MISC-746: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-746: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-746: Query failed — $_"
}
