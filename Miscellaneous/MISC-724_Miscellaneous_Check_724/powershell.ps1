...
try {
    ...
    Write-Host "MISC-724: found $($found.Count) objects"
    ...
    Write-Warning "MISC-724: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-724: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-724: Query failed — $_"
}
