...
try {
    ...
    Write-Host "MISC-723: found $($found.Count) objects"
    ...
    Write-Warning "MISC-723: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-723: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-723: Query failed : $_"
}
