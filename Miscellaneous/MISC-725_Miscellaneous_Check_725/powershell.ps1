...
try {
    ...
    Write-Host "MISC-725: found $($found.Count) objects"
    ...
    Write-Warning "MISC-725: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-725: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-725: Query failed : $_"
}
