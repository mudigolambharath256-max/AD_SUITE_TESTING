...
try {
    ...
    Write-Host "MISC-656: found $($found.Count) objects"
    ...
    Write-Warning "MISC-656: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-656: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-656: Query failed — $_"
}
