...
try {
    ...
    Write-Host "MISC-764: found $($found.Count) objects"
    ...
    Write-Warning "MISC-764: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-764: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-764: Query failed — $_"
}
