...
try {
    ...
    Write-Host "MISC-715: found $($found.Count) objects"
    ...
    Write-Warning "MISC-715: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-715: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-715: Query failed — $_"
}
