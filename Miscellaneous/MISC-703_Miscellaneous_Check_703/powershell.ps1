...
try {
    ...
    Write-Host "MISC-703: found $($found.Count) objects"
    ...
    Write-Warning "MISC-703: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-703: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-703: Query failed — $_"
}
