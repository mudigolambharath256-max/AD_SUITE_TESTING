...
try {
    ...
    Write-Host "MISC-691: found $($found.Count) objects"
    ...
    Write-Warning "MISC-691: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-691: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-691: Query failed : $_"
}
