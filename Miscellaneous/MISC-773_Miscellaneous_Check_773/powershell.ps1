...
try {
    ...
    Write-Host "MISC-773: found $($found.Count) objects"
    ...
    Write-Warning "MISC-773: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-773: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-773: Query failed — $_"
}
