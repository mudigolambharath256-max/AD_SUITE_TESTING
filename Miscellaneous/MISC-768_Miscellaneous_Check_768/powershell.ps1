...
try {
    ...
    Write-Host "MISC-768: found $($found.Count) objects"
    ...
    Write-Warning "MISC-768: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-768: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-768: Query failed : $_"
}
