...
try {
    ...
    Write-Host "MISC-756: found $($found.Count) objects"
    ...
    Write-Warning "MISC-756: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-756: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-756: Query failed : $_"
}
