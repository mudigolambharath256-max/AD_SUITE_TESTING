...
try {
    ...
    Write-Host "MISC-711: found $($found.Count) objects"
    ...
    Write-Warning "MISC-711: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-711: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-711: Query failed : $_"
}
