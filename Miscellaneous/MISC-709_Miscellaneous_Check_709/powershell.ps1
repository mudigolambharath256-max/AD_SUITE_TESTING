...
try {
    ...
    Write-Host "MISC-709: found $($found.Count) objects"
    ...
    Write-Warning "MISC-709: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-709: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-709: Query failed : $_"
}
