...
try {
    ...
    Write-Host "MISC-669: found $($found.Count) objects"
    ...
    Write-Warning "MISC-669: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-669: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-669: Query failed : $_"
}
