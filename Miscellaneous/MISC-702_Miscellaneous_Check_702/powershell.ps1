...
try {
    ...
    Write-Host "MISC-702: found $($found.Count) objects"
    ...
    Write-Warning "MISC-702: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-702: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-702: Query failed : $_"
}
