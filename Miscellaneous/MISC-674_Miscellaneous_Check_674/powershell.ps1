...
try {
    ...
    Write-Host "MISC-674: found $($found.Count) objects"
    ...
    Write-Warning "MISC-674: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-674: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-674: Query failed — $_"
}
