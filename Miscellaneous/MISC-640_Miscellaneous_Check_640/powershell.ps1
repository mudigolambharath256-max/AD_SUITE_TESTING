...
try {
    ...
    Write-Host "MISC-640: found $($found.Count) objects"
    ...
    Write-Warning "MISC-640: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-640: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-640: Query failed : $_"
}
