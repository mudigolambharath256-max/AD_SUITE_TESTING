...
try {
    ...
    Write-Host "MISC-763: found $($found.Count) objects"
    ...
    Write-Warning "MISC-763: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-763: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-763: Query failed : $_"
}
