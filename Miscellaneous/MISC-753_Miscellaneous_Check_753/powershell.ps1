...
try {
    ...
    Write-Host "MISC-753: found $($found.Count) objects"
    ...
    Write-Warning "MISC-753: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-753: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-753: Query failed : $_"
}
