...
try {
    ...
    Write-Host "MISC-647: found $($found.Count) objects"
    ...
    Write-Warning "MISC-647: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-647: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-647: Query failed : $_"
}
