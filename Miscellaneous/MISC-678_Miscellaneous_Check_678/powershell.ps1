...
try {
    ...
    Write-Host "MISC-678: found $($found.Count) objects"
    ...
    Write-Warning "MISC-678: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-678: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-678: Query failed : $_"
}
