...
try {
    ...
    Write-Host "MISC-710: found $($found.Count) objects"
    ...
    Write-Warning "MISC-710: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-710: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-710: Query failed : $_"
}
