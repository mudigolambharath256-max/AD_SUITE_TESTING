...
try {
    ...
    Write-Host "MISC-683: found $($found.Count) objects"
    ...
    Write-Warning "MISC-683: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-683: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-683: Query failed : $_"
}
