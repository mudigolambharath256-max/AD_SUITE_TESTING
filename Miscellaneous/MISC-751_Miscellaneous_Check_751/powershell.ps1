...
try {
    ...
    Write-Host "MISC-751: found $($found.Count) objects"
    ...
    Write-Warning "MISC-751: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-751: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-751: Query failed : $_"
}
