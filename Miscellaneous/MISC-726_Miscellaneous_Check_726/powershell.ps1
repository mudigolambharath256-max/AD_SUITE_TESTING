...
try {
    ...
    Write-Host "MISC-726: found $($found.Count) objects"
    ...
    Write-Warning "MISC-726: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-726: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-726: Query failed — $_"
}
