...
try {
    ...
    Write-Host "MISC-642: found $($found.Count) objects"
    ...
    Write-Warning "MISC-642: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-642: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-642: Query failed : $_"
}
