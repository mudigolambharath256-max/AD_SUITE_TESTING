...
try {
    ...
    Write-Host "MISC-740: found $($found.Count) objects"
    ...
    Write-Warning "MISC-740: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-740: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-740: Query failed : $_"
}
