...
try {
    ...
    Write-Host "MISC-687: found $($found.Count) objects"
    ...
    Write-Warning "MISC-687: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-687: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-687: Query failed : $_"
}
