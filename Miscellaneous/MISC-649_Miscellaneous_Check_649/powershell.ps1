...
try {
    ...
    Write-Host "MISC-649: found $($found.Count) objects"
    ...
    Write-Warning "MISC-649: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-649: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-649: Query failed — $_"
}
