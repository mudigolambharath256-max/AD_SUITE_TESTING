...
try {
    ...
    Write-Host "MISC-759: found $($found.Count) objects"
    ...
    Write-Warning "MISC-759: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-759: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-759: Query failed — $_"
}
