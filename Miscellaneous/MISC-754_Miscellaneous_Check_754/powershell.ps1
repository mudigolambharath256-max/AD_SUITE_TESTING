...
try {
    ...
    Write-Host "MISC-754: found $($found.Count) objects"
    ...
    Write-Warning "MISC-754: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-754: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-754: Query failed — $_"
}
