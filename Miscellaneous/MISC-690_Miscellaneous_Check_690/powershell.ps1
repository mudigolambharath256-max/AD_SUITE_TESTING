...
try {
    ...
    Write-Host "MISC-690: found $($found.Count) objects"
    ...
    Write-Warning "MISC-690: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-690: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-690: Query failed : $_"
}
