...
try {
    ...
    Write-Host "MISC-653: found $($found.Count) objects"
    ...
    Write-Warning "MISC-653: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-653: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-653: Query failed — $_"
}
