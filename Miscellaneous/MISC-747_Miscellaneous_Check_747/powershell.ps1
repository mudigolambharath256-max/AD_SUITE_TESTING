...
try {
    ...
    Write-Host "MISC-747: found $($found.Count) objects"
    ...
    Write-Warning "MISC-747: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-747: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-747: Query failed — $_"
}
