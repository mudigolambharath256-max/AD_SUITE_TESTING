...
try {
    ...
    Write-Host "MISC-672: found $($found.Count) objects"
    ...
    Write-Warning "MISC-672: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-672: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-672: Query failed — $_"
}
