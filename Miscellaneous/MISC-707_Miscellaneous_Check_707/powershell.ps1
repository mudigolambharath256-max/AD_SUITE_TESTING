...
try {
    ...
    Write-Host "MISC-707: found $($found.Count) objects"
    ...
    Write-Warning "MISC-707: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-707: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-707: Query failed — $_"
}
