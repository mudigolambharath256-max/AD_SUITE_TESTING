...
try {
    ...
    Write-Host "MISC-734: found $($found.Count) objects"
    ...
    Write-Warning "MISC-734: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-734: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-734: Query failed — $_"
}
