...
try {
    ...
    Write-Host "MISC-698: found $($found.Count) objects"
    ...
    Write-Warning "MISC-698: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-698: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-698: Query failed — $_"
}
