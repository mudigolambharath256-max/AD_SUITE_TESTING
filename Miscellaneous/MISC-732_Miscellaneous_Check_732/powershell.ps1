...
try {
    ...
    Write-Host "MISC-732: found $($found.Count) objects"
    ...
    Write-Warning "MISC-732: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-732: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-732: Query failed : $_"
}
