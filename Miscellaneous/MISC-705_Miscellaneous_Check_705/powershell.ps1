...
try {
    ...
    Write-Host "MISC-705: found $($found.Count) objects"
    ...
    Write-Warning "MISC-705: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-705: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-705: Query failed — $_"
}
