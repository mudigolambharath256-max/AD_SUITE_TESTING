...
try {
    ...
    Write-Host "MISC-717: found $($found.Count) objects"
    ...
    Write-Warning "MISC-717: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-717: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-717: Query failed — $_"
}
