...
try {
    ...
    Write-Host "MISC-735: found $($found.Count) objects"
    ...
    Write-Warning "MISC-735: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-735: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-735: Query failed — $_"
}
