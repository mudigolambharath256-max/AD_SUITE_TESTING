...
try {
    ...
    Write-Host "MISC-670: found $($found.Count) objects"
    ...
    Write-Warning "MISC-670: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-670: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-670: Query failed : $_"
}
