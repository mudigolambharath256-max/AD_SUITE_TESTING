...
try {
    ...
    Write-Host "MISC-700: found $($found.Count) objects"
    ...
    Write-Warning "MISC-700: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-700: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-700: Query failed : $_"
}
