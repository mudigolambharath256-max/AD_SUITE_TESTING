...
try {
    ...
    Write-Host "MISC-694: found $($found.Count) objects"
    ...
    Write-Warning "MISC-694: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-694: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-694: Query failed : $_"
}
