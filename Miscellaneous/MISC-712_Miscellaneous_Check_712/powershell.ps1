...
try {
    ...
    Write-Host "MISC-712: found $($found.Count) objects"
    ...
    Write-Warning "MISC-712: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-712: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-712: Query failed : $_"
}
