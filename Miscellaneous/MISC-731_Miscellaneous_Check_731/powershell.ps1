...
try {
    ...
    Write-Host "MISC-731: found $($found.Count) objects"
    ...
    Write-Warning "MISC-731: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-731: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-731: Query failed : $_"
}
