...
try {
    ...
    Write-Host "MISC-673: found $($found.Count) objects"
    ...
    Write-Warning "MISC-673: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-673: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-673: Query failed : $_"
}
