...
try {
    ...
    Write-Host "MISC-765: found $($found.Count) objects"
    ...
    Write-Warning "MISC-765: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-765: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-765: Query failed : $_"
}
