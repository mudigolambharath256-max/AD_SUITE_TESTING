...
try {
    ...
    Write-Host "MISC-644: found $($found.Count) objects"
    ...
    Write-Warning "MISC-644: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-644: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-644: Query failed — $_"
}
