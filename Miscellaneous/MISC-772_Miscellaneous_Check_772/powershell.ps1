...
try {
    ...
    Write-Host "MISC-772: found $($found.Count) objects"
    ...
    Write-Warning "MISC-772: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-772: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-772: Query failed — $_"
}
