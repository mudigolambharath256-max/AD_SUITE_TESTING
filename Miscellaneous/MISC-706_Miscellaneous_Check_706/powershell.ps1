...
try {
    ...
    Write-Host "MISC-706: found $($found.Count) objects"
    ...
    Write-Warning "MISC-706: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-706: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-706: Query failed : $_"
}
