...
try {
    ...
    Write-Host "MISC-650: found $($found.Count) objects"
    ...
    Write-Warning "MISC-650: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-650: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-650: Query failed : $_"
}
