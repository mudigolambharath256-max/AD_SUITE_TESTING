...
try {
    ...
    Write-Host "MISC-660: found $($found.Count) objects"
    ...
    Write-Warning "MISC-660: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-660: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-660: Query failed — $_"
}
