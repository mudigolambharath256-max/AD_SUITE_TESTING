...
try {
    ...
    Write-Host "MISC-688: found $($found.Count) objects"
    ...
    Write-Warning "MISC-688: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-688: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-688: Query failed : $_"
}
