...
try {
    ...
    Write-Host "MISC-757: found $($found.Count) objects"
    ...
    Write-Warning "MISC-757: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-757: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-757: Query failed : $_"
}
