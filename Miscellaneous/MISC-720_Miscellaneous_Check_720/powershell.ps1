...
try {
    ...
    Write-Host "MISC-720: found $($found.Count) objects"
    ...
    Write-Warning "MISC-720: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-720: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-720: Query failed — $_"
}
