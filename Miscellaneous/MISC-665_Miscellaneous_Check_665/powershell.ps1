...
try {
    ...
    Write-Host "MISC-665: found $($found.Count) objects"
    ...
    Write-Warning "MISC-665: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-665: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-665: Query failed — $_"
}
