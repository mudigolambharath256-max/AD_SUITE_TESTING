...
try {
    ...
    Write-Host "MISC-701: found $($found.Count) objects"
    ...
    Write-Warning "MISC-701: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-701: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-701: Query failed — $_"
}
