...
try {
    ...
    Write-Host "MISC-666: found $($found.Count) objects"
    ...
    Write-Warning "MISC-666: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-666: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-666: Query failed : $_"
}
