...
try {
    ...
    Write-Host "MISC-728: found $($found.Count) objects"
    ...
    Write-Warning "MISC-728: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-728: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-728: Query failed — $_"
}
