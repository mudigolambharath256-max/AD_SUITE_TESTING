...
try {
    ...
    Write-Host "MISC-663: found $($found.Count) objects"
    ...
    Write-Warning "MISC-663: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-663: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-663: Query failed — $_"
}
