...
try {
    ...
    Write-Host "MISC-742: found $($found.Count) objects"
    ...
    Write-Warning "MISC-742: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-742: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-742: Query failed : $_"
}
