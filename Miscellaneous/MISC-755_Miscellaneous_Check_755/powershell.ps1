...
try {
    ...
    Write-Host "MISC-755: found $($found.Count) objects"
    ...
    Write-Warning "MISC-755: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-755: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-755: Query failed — $_"
}
