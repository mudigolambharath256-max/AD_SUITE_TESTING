...
try {
    ...
    Write-Host "MISC-662: found $($found.Count) objects"
    ...
    Write-Warning "MISC-662: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-662: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-662: Query failed : $_"
}
