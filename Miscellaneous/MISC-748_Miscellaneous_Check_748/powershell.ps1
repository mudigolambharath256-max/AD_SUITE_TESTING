...
try {
    ...
    Write-Host "MISC-748: found $($found.Count) objects"
    ...
    Write-Warning "MISC-748: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-748: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-748: Query failed : $_"
}
