...
try {
    ...
    Write-Host "MISC-729: found $($found.Count) objects"
    ...
    Write-Warning "MISC-729: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-729: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-729: Query failed : $_"
}
