...
try {
    ...
    Write-Host "MISC-745: found $($found.Count) objects"
    ...
    Write-Warning "MISC-745: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-745: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-745: Query failed : $_"
}
