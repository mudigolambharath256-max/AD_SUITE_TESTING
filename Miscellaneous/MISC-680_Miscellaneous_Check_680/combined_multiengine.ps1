...
Write-Host "=== Miscellaneous Check 680 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "MISC-680 PowerShell engine: $_"   # Fix R10: no silent catch
}
...
try {
    ...
    Write-Warning "MISC-680 ADSI engine: $_"          # Fix R10
}
...
try {
    ...
    Write-Warning "MISC-680 C# engine: $_"             # Fix R10
}
...
Write-Host ""
Write-Host "=== MISC-680: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

# Fix R14: Fixed 5-field schema enforced before CSV export
$csvPath = Join-Path $env:TEMP "MISC-680_results.csv"
$uniqueResults |
