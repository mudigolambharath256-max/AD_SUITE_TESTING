...
try {
    ...
    Write-Host "MISC-680: found $($found.Count) objects"
    ...
    Write-Warning "MISC-680: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-680: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-680: Query failed : $_"
}
