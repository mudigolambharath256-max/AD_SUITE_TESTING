...
try {
    ...
    Write-Host "MISC-676: found $($found.Count) objects"
    ...
    Write-Warning "MISC-676: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-676: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-676: Query failed — $_"
}
