...
try {
    ...
    Write-Host "MISC-769: found $($found.Count) objects"
    ...
    Write-Warning "MISC-769: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-769: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-769: Query failed : $_"
}
