...
try {
    ...
    Write-Host "MISC-722: found $($found.Count) objects"
    ...
    Write-Warning "MISC-722: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-722: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-722: Query failed : $_"
}
