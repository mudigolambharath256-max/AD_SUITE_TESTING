...
try {
    ...
    Write-Host "MISC-684: found $($found.Count) objects"
    ...
    Write-Warning "MISC-684: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-684: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-684: Query failed : $_"
}
