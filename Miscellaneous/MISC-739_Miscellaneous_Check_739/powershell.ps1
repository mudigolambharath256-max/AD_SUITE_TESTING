...
try {
    ...
    Write-Host "MISC-739: found $($found.Count) objects"
    ...
    Write-Warning "MISC-739: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-739: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-739: Query failed — $_"
}
