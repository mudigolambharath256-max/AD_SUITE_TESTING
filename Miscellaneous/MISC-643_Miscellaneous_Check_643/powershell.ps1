...
try {
    ...
    Write-Host "MISC-643: found $($found.Count) objects"
    ...
    Write-Warning "MISC-643: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-643: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-643: Query failed : $_"
}
