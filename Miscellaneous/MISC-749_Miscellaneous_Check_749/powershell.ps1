...
try {
    ...
    Write-Host "MISC-749: found $($found.Count) objects"
    ...
    Write-Warning "MISC-749: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-749: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-749: Query failed — $_"
}
