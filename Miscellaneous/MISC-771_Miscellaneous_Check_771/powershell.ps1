...
try {
    ...
    Write-Host "MISC-771: found $($found.Count) objects"
    ...
    Write-Warning "MISC-771: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-771: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-771: Query failed — $_"
}
