...
try {
    ...
    Write-Host "MISC-704: found $($found.Count) objects"
    ...
    Write-Warning "MISC-704: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-704: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-704: Query failed — $_"
}
