...
try {
    ...
    Write-Host "MISC-727: found $($found.Count) objects"
    ...
    Write-Warning "MISC-727: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-727: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-727: Query failed — $_"
}
