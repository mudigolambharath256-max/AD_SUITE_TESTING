...
try {
    ...
    Write-Host "MISC-657: found $($found.Count) objects"
    ...
    Write-Warning "MISC-657: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-657: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-657: Query failed : $_"
}
