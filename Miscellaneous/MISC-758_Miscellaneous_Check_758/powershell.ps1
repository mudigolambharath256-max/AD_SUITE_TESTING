...
try {
    ...
    Write-Host "MISC-758: found $($found.Count) objects"
    ...
    Write-Warning "MISC-758: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-758: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-758: Query failed : $_"
}
