...
try {
    ...
    Write-Host "MISC-750: found $($found.Count) objects"
    ...
    Write-Warning "MISC-750: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-750: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-750: Query failed : $_"
}
