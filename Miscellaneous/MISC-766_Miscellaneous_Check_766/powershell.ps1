...
try {
    ...
    Write-Host "MISC-766: found $($found.Count) objects"
    ...
    Write-Warning "MISC-766: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-766: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-766: Query failed : $_"
}
