...
try {
    ...
    Write-Host "MISC-648: found $($found.Count) objects"
    ...
    Write-Warning "MISC-648: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-648: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-648: Query failed : $_"
}
