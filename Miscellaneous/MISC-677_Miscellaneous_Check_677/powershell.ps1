...
try {
    ...
    Write-Host "MISC-677: found $($found.Count) objects"
    ...
    Write-Warning "MISC-677: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-677: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-677: Query failed — $_"
}
