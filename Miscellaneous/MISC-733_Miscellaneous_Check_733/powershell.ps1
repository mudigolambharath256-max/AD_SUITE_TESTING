...
try {
    ...
    Write-Host "MISC-733: found $($found.Count) objects"
    ...
    Write-Warning "MISC-733: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-733: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-733: Query failed : $_"
}
