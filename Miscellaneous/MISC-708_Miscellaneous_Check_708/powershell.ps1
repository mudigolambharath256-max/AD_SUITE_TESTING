...
try {
    ...
    Write-Host "MISC-708: found $($found.Count) objects"
    ...
    Write-Warning "MISC-708: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-708: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-708: Query failed : $_"
}
