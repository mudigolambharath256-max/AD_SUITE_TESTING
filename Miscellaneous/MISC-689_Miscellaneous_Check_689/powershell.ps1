...
try {
    ...
    Write-Host "MISC-689: found $($found.Count) objects"
    ...
    Write-Warning "MISC-689: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-689: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-689: Query failed : $_"
}
