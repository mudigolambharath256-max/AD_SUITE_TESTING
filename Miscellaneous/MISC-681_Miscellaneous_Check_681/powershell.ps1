...
try {
    ...
    Write-Host "MISC-681: found $($found.Count) objects"
    ...
    Write-Warning "MISC-681: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-681: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-681: Query failed : $_"
}
