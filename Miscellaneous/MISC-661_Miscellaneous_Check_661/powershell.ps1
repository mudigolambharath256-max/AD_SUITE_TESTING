...
try {
    ...
    Write-Host "MISC-661: found $($found.Count) objects"
    ...
    Write-Warning "MISC-661: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-661: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-661: Query failed : $_"
}
