...
try {
    ...
    Write-Host "MISC-696: found $($found.Count) objects"
    ...
    Write-Warning "MISC-696: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-696: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-696: Query failed : $_"
}
