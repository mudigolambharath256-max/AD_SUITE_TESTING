...
try {
    ...
    Write-Host "MISC-770: found $($found.Count) objects"
    ...
    Write-Warning "MISC-770: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-770: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-770: Query failed — $_"
}
