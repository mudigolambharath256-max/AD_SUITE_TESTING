...
try {
    ...
    Write-Host "MISC-761: found $($found.Count) objects"
    ...
    Write-Warning "MISC-761: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-761: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-761: Query failed — $_"
}
