...
try {
    ...
    Write-Host "MISC-671: found $($found.Count) objects"
    ...
    Write-Warning "MISC-671: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-671: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-671: Query failed — $_"
}
