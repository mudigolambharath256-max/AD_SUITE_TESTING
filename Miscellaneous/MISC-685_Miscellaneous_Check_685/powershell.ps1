...
try {
    ...
    Write-Host "MISC-685: found $($found.Count) objects"
    ...
    Write-Warning "MISC-685: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-685: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-685: Query failed : $_"
}
