...
try {
    ...
    Write-Host "MISC-719: found $($found.Count) objects"
    ...
    Write-Warning "MISC-719: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-719: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-719: Query failed — $_"
}
