...
try {
    ...
    Write-Host "MISC-679: found $($found.Count) objects"
    ...
    Write-Warning "MISC-679: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-679: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-679: Query failed : $_"
}
