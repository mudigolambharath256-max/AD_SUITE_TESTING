...
try {
    ...
    Write-Host "MISC-767: found $($found.Count) objects"
    ...
    Write-Warning "MISC-767: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-767: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-767: Query failed — $_"
}
