...
try {
    ...
    Write-Host "MISC-637: found $($found.Count) objects"
    ...
    Write-Warning "MISC-637: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-637: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-637: Query failed — $_"
}
