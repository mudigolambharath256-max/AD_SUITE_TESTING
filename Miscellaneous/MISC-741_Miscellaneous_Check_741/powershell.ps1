...
try {
    ...
    Write-Host "MISC-741: found $($found.Count) objects"
    ...
    Write-Warning "MISC-741: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-741: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-741: Query failed — $_"
}
