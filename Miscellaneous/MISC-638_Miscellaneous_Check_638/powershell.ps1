...
try {
    ...
    Write-Host "MISC-638: found $($found.Count) objects"
    ...
    Write-Warning "MISC-638: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-638: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-638: Query failed — $_"
}
