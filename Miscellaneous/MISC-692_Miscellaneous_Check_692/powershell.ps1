...
try {
    ...
    Write-Host "MISC-692: found $($found.Count) objects"
    ...
    Write-Warning "MISC-692: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-692: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-692: Query failed : $_"
}
