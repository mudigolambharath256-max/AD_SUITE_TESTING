...
try {
    ...
    Write-Host "MISC-762: found $($found.Count) objects"
    ...
    Write-Warning "MISC-762: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-762: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-762: Query failed : $_"
}
