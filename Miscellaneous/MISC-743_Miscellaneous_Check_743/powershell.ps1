...
try {
    ...
    Write-Host "MISC-743: found $($found.Count) objects"
    ...
    Write-Warning "MISC-743: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-743: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-743: Query failed : $_"
}
