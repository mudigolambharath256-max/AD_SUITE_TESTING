...
try {
    ...
    Write-Host "MISC-651: found $($found.Count) objects"
    ...
    Write-Warning "MISC-651: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-651: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-651: Query failed — $_"
}
