...
try {
    ...
    Write-Host "MISC-652: found $($found.Count) objects"
    ...
    Write-Warning "MISC-652: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-652: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-652: Query failed : $_"
}
