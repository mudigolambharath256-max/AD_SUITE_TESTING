...
try {
    ...
    Write-Host "MISC-736: found $($found.Count) objects"
    ...
    Write-Warning "MISC-736: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-736: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-736: Query failed — $_"
}
