...
try {
    ...
    Write-Host "MISC-730: found $($found.Count) objects"
    ...
    Write-Warning "MISC-730: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-730: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-730: Query failed : $_"
}
