...
try {
    ...
    Write-Host "MISC-693: found $($found.Count) objects"
    ...
    Write-Warning "MISC-693: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-693: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-693: Query failed : $_"
}
