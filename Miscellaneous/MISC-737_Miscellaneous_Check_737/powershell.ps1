...
try {
    ...
    Write-Host "MISC-737: found $($found.Count) objects"
    ...
    Write-Warning "MISC-737: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-737: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-737: Query failed : $_"
}
