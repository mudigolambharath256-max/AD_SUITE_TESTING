...
try {
    ...
    Write-Host "MISC-664: found $($found.Count) objects"
    ...
    Write-Warning "MISC-664: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-664: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-664: Query failed — $_"
}
