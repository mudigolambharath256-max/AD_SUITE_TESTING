...
try {
    ...
    Write-Host "MISC-645: found $($found.Count) objects"
    ...
    Write-Warning "MISC-645: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-645: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-645: Query failed — $_"
}
