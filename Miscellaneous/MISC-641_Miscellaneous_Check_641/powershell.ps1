...
try {
    ...
    Write-Host "MISC-641: found $($found.Count) objects"
    ...
    Write-Warning "MISC-641: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-641: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-641: Query failed : $_"
}
