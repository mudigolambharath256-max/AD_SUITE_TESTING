...
try {
    ...
    Write-Host "MISC-713: found $($found.Count) objects"
    ...
    Write-Warning "MISC-713: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-713: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-713: Query failed : $_"
}
