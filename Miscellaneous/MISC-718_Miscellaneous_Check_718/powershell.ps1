...
try {
    ...
    Write-Host "MISC-718: found $($found.Count) objects"
    ...
    Write-Warning "MISC-718: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-718: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-718: Query failed — $_"
}
