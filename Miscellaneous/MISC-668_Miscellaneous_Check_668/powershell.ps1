...
try {
    ...
    Write-Host "MISC-668: found $($found.Count) objects"
    ...
    Write-Warning "MISC-668: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-668: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-668: Query failed : $_"
}
