...
try {
    ...
    Write-Host "MISC-744: found $($found.Count) objects"
    ...
    Write-Warning "MISC-744: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-744: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-744: Query failed : $_"
}
