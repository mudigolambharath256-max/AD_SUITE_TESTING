...
try {
    ...
    Write-Host "MISC-646: found $($found.Count) objects"
    ...
    Write-Warning "MISC-646: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-646: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-646: Query failed — $_"
}
