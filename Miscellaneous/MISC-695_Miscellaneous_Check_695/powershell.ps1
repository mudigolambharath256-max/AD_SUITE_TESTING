...
try {
    ...
    Write-Host "MISC-695: found $($found.Count) objects"
    ...
    Write-Warning "MISC-695: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-695: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-695: Query failed : $_"
}
