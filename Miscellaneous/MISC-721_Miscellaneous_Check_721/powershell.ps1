...
try {
    ...
    Write-Host "MISC-721: found $($found.Count) objects"
    ...
    Write-Warning "MISC-721: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-721: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-721: Query failed — $_"
}
