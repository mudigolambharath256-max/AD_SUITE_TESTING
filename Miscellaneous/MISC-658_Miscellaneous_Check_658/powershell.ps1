...
try {
    ...
    Write-Host "MISC-658: found $($found.Count) objects"
    ...
    Write-Warning "MISC-658: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-658: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-658: Query failed : $_"
}
