...
try {
    ...
    Write-Host "MISC-682: found $($found.Count) objects"
    ...
    Write-Warning "MISC-682: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-682: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-682: Query failed — $_"
}
