...
try {
    ...
    Write-Host "MISC-716: found $($found.Count) objects"
    ...
    Write-Warning "MISC-716: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-716: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-716: Query failed : $_"
}
