...
try {
    ...
    Write-Host "MISC-714: found $($found.Count) objects"
    ...
    Write-Warning "MISC-714: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-714: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-714: Query failed : $_"
}
