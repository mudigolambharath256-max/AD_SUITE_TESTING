...
try {
    ...
    Write-Host "MISC-639: found $($found.Count) objects"
    ...
    Write-Warning "MISC-639: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-639: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-639: Query failed : $_"
}
