...
try {
    ...
    Write-Host "MISC-697: found $($found.Count) objects"
    ...
    Write-Warning "MISC-697: Object not found — $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-697: AD server unreachable — $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-697: Query failed — $_"
}
