...
try {
    ...
    Write-Host "MISC-752: found $($found.Count) objects"
    ...
    Write-Warning "MISC-752: Object not found : $_"
} catch [Microsoft.ActiveDirectory.Management.ADServerDownException] {
    Write-Warning "MISC-752: AD server unreachable : $_"
} catch {
    # Fix R10: no silent catch
    Write-Warning "MISC-752: Query failed : $_"
}
