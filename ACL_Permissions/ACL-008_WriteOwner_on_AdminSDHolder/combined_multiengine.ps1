...
Write-Host "=== WriteOwner on AdminSDHolder ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-008 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-008 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-008: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
