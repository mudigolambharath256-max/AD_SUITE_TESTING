...
Write-Host "=== GenericWrite on Privileged Users ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-016 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-016 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-016: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
