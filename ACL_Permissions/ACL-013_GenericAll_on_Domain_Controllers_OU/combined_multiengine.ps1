...
Write-Host "=== GenericAll on Domain Controllers OU ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-013 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-013 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-013: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
