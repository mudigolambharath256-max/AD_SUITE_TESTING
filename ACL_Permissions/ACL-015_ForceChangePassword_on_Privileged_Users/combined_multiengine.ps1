...
Write-Host "=== ForceChangePassword on Privileged Users ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-015 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-015 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-015: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
