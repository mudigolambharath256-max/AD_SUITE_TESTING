...
Write-Host "=== GenericAll on Enterprise Admins ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-012 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-012 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-012: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
