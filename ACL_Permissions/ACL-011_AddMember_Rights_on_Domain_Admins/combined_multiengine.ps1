...
Write-Host "=== AddMember Rights on Domain Admins ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-011 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-011 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-011: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
