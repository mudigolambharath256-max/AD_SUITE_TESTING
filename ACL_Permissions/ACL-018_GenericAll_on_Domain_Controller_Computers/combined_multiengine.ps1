...
Write-Host "=== GenericAll on Domain Controller Computers ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-018 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-018 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-018: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
