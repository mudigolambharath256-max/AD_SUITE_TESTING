...
Write-Host "=== GenericAll or WriteDACL on GPO Objects ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-020 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-020 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-020: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
