...
Write-Host "=== WriteDACL on Domain Admins ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-010 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-010 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-010: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
