...
Write-Host "=== GenericAll on Domain Admins ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-009 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-009 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-009: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
