...
Write-Host "=== AllExtendedRights on Privileged Users ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-017 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-017 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-017: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
