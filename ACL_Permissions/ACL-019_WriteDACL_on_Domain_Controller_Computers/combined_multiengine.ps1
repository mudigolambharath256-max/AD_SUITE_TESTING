...
Write-Host "=== WriteDACL on Domain Controller Computers ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-019 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-019 ADSI engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-019: Use adsi.ps1 for full implementation ===" -ForegroundColor Cyan
