...
Write-Host "=== GenericAll on Domain Object ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Warning "ACL-001 PowerShell engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-001 ADSI engine: $_"
}
...
try {
    ...
    Write-Warning "ACL-001 C# engine: $_"
}
...
Write-Host ""
Write-Host "=== ACL-001: $($uniqueResults.Count) unique findings ===" -ForegroundColor Cyan
$uniqueResults | Format-List

$csvPath = Join-Path $env:TEMP "ACL-001_results.csv"
$uniqueResults |
